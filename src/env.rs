...
impl Env {
    pub fn new() -> Self {
        ...
        env.define_builtin("dft", Value::BuiltinFn("dft".into()));
        env.define_builtin("power_spectrum", Value::BuiltinFn("power_spectrum".into()));
        env.define_builtin("z_score", Value::BuiltinFn("z_score".into()));
        env.define_builtin("detect_anomalies", Value::BuiltinFn("detect_anomalies".into()));
        env.define_builtin("ensemble_avg", Value::BuiltinFn("ensemble_avg".into()));
        env.define_builtin("ensemble_vote", Value::BuiltinFn("ensemble_vote".into()));
        env.define_builtin("reservoir_step", Value::BuiltinFn("reservoir_step".into()));
        env.define_builtin("message_pass", Value::BuiltinFn("message_pass".into()));
        env.define_builtin("graph_attention", Value::BuiltinFn("graph_attention".into()));
        env.define_builtin("policy_gradient", Value::BuiltinFn("policy_gradient".into()));
        env.define_builtin("discount_rewards", Value::BuiltinFn("discount_rewards".into()));
        env.define_builtin("memory_write", Value::BuiltinFn("memory_write".into()));
        env.define_builtin("memory_read", Value::BuiltinFn("memory_read".into()));
        env.define_builtin("reparameterize", Value::BuiltinFn("reparameterize".into()));
        env.define_builtin("kl_loss_vae", Value::BuiltinFn("kl_loss_vae".into()));
        env.define_builtin("cross_attention", Value::BuiltinFn("cross_attention".into()));
        env.define_builtin("noise_schedule_linear", Value::BuiltinFn("noise_schedule_linear".into()));
        env.define_builtin("add_noise", Value::BuiltinFn("add_noise".into()));
        env.define_builtin("ga_crossover", Value::BuiltinFn("ga_crossover".into()));
        env.define_builtin("ga_mutate", Value::BuiltinFn("ga_mutate".into()));
        env.define_builtin("ga_select", Value::BuiltinFn("ga_select".into()));
        env.define_builtin("ca_step_1d", Value::BuiltinFn("ca_step_1d".into()));
        env.define_builtin("pso_step", Value::BuiltinFn("pso_step".into()));
        env.define_builtin("sa_step", Value::BuiltinFn("sa_step".into()));
        env.define_builtin("distillation_loss", Value::BuiltinFn("distillation_loss".into()));
        env.define_builtin("curriculum_weight", Value::BuiltinFn("curriculum_weight".into()));
        env.define_builtin("grad_norm_per_layer", Value::BuiltinFn("grad_norm_per_layer".into()));
        env.define_builtin("diagnose_gradients", Value::BuiltinFn("diagnose_gradients".into()));
        env.define_builtin("compare_models", Value::BuiltinFn("compare_models".into()));
        env.define_builtin("sparse_matvec", Value::BuiltinFn("sparse_matvec".into()));
        env.define_builtin("to_csr", Value::BuiltinFn("to_csr".into()));
        env.define_builtin("lsh_sim", Value::BuiltinFn("lsh_sim".into()));
        env.define_builtin("random_projection", Value::BuiltinFn("random_projection".into()));
        env.define_builtin("sign_sgd", Value::BuiltinFn("sign_sgd".into()));
        env.define_builtin("phi_fast", Value::BuiltinFn("phi_fast".into()));
        env.define_builtin("binary_matmul", Value::BuiltinFn("binary_matmul".into()));
        env.define_builtin("predictive_skip", Value::BuiltinFn("predictive_skip".into()));
        env.define_builtin("incremental_phi", Value::BuiltinFn("incremental_phi".into()));
        env.define_builtin("sketch_matmul", Value::BuiltinFn("sketch_matmul".into()));
        env.define_builtin("consciousness_step_o1", Value::BuiltinFn("consciousness_step_o1".into()));
        env.define_builtin("consciousness_step_block", Value::BuiltinFn("consciousness_step_block".into()));
        env.define_builtin("tape_new", Value::BuiltinFn("tape_new".into()));
        env.define_builtin("tape_var", Value::BuiltinFn("tape_var".into()));
        env.define_builtin("tape_op", Value::BuiltinFn("tape_op".into()));
        env.define_builtin("backward", Value::BuiltinFn("backward".into()));
        env.define_builtin("get_grad", Value::BuiltinFn("get_grad".into()));
        env.define_builtin("get_tensor", Value::BuiltinFn("get_tensor".into()));
        env.define_builtin("block_checksums", Value::BuiltinFn("block_checksums".into()));
        env.define_builtin("consciousness_step_ultra", Value::BuiltinFn("consciousness_step_ultra".into()));
        env.define_builtin("consciousness_step_cached", Value::BuiltinFn("consciousness_step_cached".into()));
