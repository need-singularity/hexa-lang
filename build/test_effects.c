...
long hexa_user_log(const char* msg);
const char* question(const char* prompt);
long next();
long add(long a, long b);
long hexa_user_double(long x);
long get_outer();
long get_inner();
long compute(long a, long b);
long hexa_user_write(const char* msg);
const char* use_ask();
long pick();
...
static long x;
static long y;
static long fn_answer;
static long picked;

long hexa_user_log(const char* msg) {
    0;
    /* unsupported stmt */
    long collected = handle;
    0;
    /* unsupported method .log */ 0;
    return 42;
}
...
int main(int argc, char** argv) {
    ...
    0;
    0;
    if (!((collected == 42))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    effect;
    Ask;
    0;
    answer = handle;
    0;
    /* unsupported method .question */ 0;
    0;
    with;
    0;
    /* unsupported method .question */ 0;
    ...
    0;
    0;
    if (!((answer == "Alice"))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    effect;
    Counter;
    0;
    sum = handle;
    0;
    a = /* unsupported method .next */ 0;
    b = /* unsupported method .next */ 0;
    (a + b);
    0;
    with;
    0;
    /* unsupported method .next */ 0;
    0;
    0;
    resume(10);
    0;
    0;
    if (!((sum == 20))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    result = add(3, 4);
    if (!((result == 7))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    if (!((hexa_user_double(21) == 42))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    effect;
    Outer;
    0;
    effect;
    ...
    nested = handle;
    0;
    o = /* unsupported method .get_outer */ 0;
    i = handle;
    0;
    /* unsupported method .get_inner */ 0;
    0;
    with;
    0;
    /* unsupported method .get_inner */ 0;
    ...
    with;
    0;
    /* unsupported method .get_outer */ 0;
    0;
    0;
    resume(100);
    0;
    0;
    if (!((nested == 300))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    effect;
    Math;
    0;
    computed = handle;
    0;
    /* unsupported method .compute */ 0;
    0;
    with;
    0;
    /* unsupported method .compute */ 0;
    ...
    0;
    0;
    if (!((computed == 30))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    effect;
    Logger;
    0;
    count = handle;
    0;
    x = /* unsupported method .write */ 0;
    y = /* unsupported method .write */ 0;
    (x + y);
    0;
    with;
    0;
    ...
    0;
    0;
    if (!((count == 2))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    fn_answer = handle;
    0;
    use_ask();
    0;
    ...
    0;
    0;
    if (!((fn_answer == "Bob"))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    effect;
    Choice;
    0;
    picked = handle;
    0;
    /* unsupported method .pick */ 0;
    0;
    with;
    0;
    /* unsupported method .pick */ 0;
    ...
    0;
    0;
    if (!((picked == 99))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    printf("%s\n", "All 10 effect tests passed!");
    return 0;
}
