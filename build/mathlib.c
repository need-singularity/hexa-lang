...
int main(int argc, char** argv) {
    ...
    printf("%s %g\n", "sqrt(2) =", (double)(hexa_sqrt((double)(2.0))));
    printf("%s %g\n", "sqrt(16) =", (double)(hexa_sqrt((double)(16.0))));
    printf("%s %g\n", "pow(2, 10) =", (double)(hexa_pow((double)(2.0), (double)(10.0))));
    printf("%s %g\n", "pow(e, 1) =", (double)(hexa_exp((double)(1.0))));
    printf("%s %g\n", "log(e) =", (double)(hexa_log((double)(hexa_exp((double)(1.0))))));
    printf("%s %g\n", "log10(1000) =", (double)(hexa_log10((double)(1000.0))));
    printf("%s %g\n", "sin(0) =", (double)(hexa_sin((double)(0.0))));
    printf("%s %g\n", "cos(0) =", (double)(hexa_cos((double)(0.0))));
    printf("%s %g\n", "floor(3.7) =", (double)(hexa_floor((double)(3.7))));
    printf("%s %g\n", "ceil(3.2) =", (double)(hexa_ceil((double)(3.2))));
    printf("%s %g\n", "round(3.5) =", (double)(hexa_round((double)(3.5))));
    printf("%s %ld\n", "abs(-5) =", (long)(hexa_abs_i((long)((0 - 5)))));
    printf("%s %g\n", "abs(-3.14) =", (double)(hexa_abs_f((0.0 - 3.14))));
    printf("%s %ld\n", "min(3, 7) =", (long)(((3) < (7) ? (3) : (7))));
    printf("%s %ld\n", "max(3, 7) =", (long)(((3) > (7) ? (3) : (7))));
    printf("%s %g\n", "min(3.5, 2.1) =", (double)(((3.5) < (2.1) ? (3.5) : (2.1))));
    printf("%s\n", "done");
    return 0;
}
