...
long qs(long lo, long hi);
long print_arr(const char* label);

static hexa_arr arr;
static long N = 16;
static long _r;
static long sorted = 1;
static long i = 1;
...
int main(int argc, char** argv) {
    ...
    arr = hexa_arr_lit((long[]){(long)(5), (long)(2), (long)(8), (long)(1), (long)(9), (long)(3), (long)(7), (long)(4), (long)(6), (long)(0), (long)(15), (long)(11), (long)(13), (long)(10), (long)(12), (long)(14)}, 16);
    print_arr("before");
    _r = qs(0, (N - 1));
    print_arr("after ");
    while ((i < N)) {
