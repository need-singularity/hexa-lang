...
static const char* s = "hello world from hexa";


int main(int argc, char** argv) {
    hexa_main_argc = argc; hexa_main_argv = argv;
    printf("%s %ld\n", "contains 'world' =", (long)(hexa_contains(s, "world")));
    printf("%s %ld\n", "contains 'xyz'   =", (long)(hexa_contains(s, "xyz")));
    printf("%s %ld\n", "index_of 'hexa'  =", (long)(hexa_index_of(s, "hexa")));
    printf("%s %ld\n", "index_of 'xyz'   =", (long)(hexa_index_of(s, "xyz")));
    printf("%s %ld\n", "starts 'hello'   =", (long)(hexa_starts_with(s, "hello")));
    printf("%s %ld\n", "starts 'world'   =", (long)(hexa_starts_with(s, "world")));
    printf("%s %ld\n", "ends 'hexa'      =", (long)(hexa_ends_with(s, "hexa")));
    printf("%s %ld\n", "ends 'world'     =", (long)(hexa_ends_with(s, "world")));
    printf("%s\n", "done");
    return 0;
}
