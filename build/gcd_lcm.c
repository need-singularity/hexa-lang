...
long reduce_frac(long num, long den);
...
long reduce_frac(long num, long den) {
    long g = gcd(num, den);
    return printf("%ld %s %ld %s %ld %s %ld\n", (long)(num), "/", (long)(den), "→", (long)((num / g)), "/", (long)((den / g)));
}
...
int main(int argc, char** argv) {
    ...
    printf("%s\n", "=== GCD/LCM ===");
    printf("%s %ld %s\n", "gcd(48, 18)  =", (long)(gcd(48, 18)), "(expected 6)");
    printf("%s %ld %s\n", "gcd(100, 75) =", (long)(gcd(100, 75)), "(expected 25)");
    printf("%s %ld %s\n", "gcd(17, 13)  =", (long)(gcd(17, 13)), "(expected 1)");
    printf("%s %ld %s\n", "gcd(0, 5)    =", (long)(gcd(0, 5)), "(expected 5)");
    printf("%s %ld %s\n", "lcm(4, 6)    =", (long)(lcm(4, 6)), "(expected 12)");
    printf("%s %ld %s\n", "lcm(12, 18)  =", (long)(lcm(12, 18)), "(expected 36)");
    printf("%s %ld %s\n", "lcm(7, 11)   =", (long)(lcm(7, 11)), "(expected 77)");
    printf("%s\n", "");
    printf("%s\n", "=== 분수 기약화 ===");
    reduce_frac(48, 64);
    reduce_frac(14, 21);
    ...
    _r = ext_gcd(240, 46);
    printf("%s %ld %s %ld %s %ld %s\n", "240 * (", (long)(ext_x), ") + 46 * (", (long)(ext_y), ") =", (long)(ext_g), "(expected 2)");
    check = ((240 * ext_x) + (46 * ext_y));
    printf("%s %ld %s %ld %s %ld %s\n", "check: 240 *", (long)(ext_x), "+ 46 *", (long)(ext_y), "=", (long)(check), (((check == ext_g)) ? ("✓") : ("✗")));
    printf("%s\n", "done");
    return 0;
}
