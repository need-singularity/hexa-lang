...
int main(int argc, char** argv) {
    ...
    printf("%s %ld\n", "classify(-5)=", (long)(classify((-5))));
    printf("%s %ld\n", "classify(0) =", (long)(classify(0)));
    printf("%s %ld\n", "classify(7) =", (long)(classify(7)));
    printf("%s %ld\n", "classify(50)=", (long)(classify(50)));
    printf("%s %ld\n", "classify(500)=", (long)(classify(500)));
    return 0;
}
