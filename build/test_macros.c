...
int main(int argc, char** argv) {
    ...
    0;
    0;
    hexa_concat("hello ", hexa_int_to_str((long)(name)));
    0;
    0;
    derive(Display);
    long __fi_Point_3 = 0;
    while ((__fi_Point_3 < hexa_str_len(0))) {
        long Point = 0[__fi_Point_3];
        derive(Debug);
        long __fi_Color_2 = 0;
        while ((__fi_Color_2 < hexa_str_len(0))) {
            long Color = 0[__fi_Color_2];
            derive(Eq);
            long __fi_Vec2_1 = 0;
            while ((__fi_Vec2_1 < hexa_str_len(0))) {
                long Vec2 = 0[__fi_Vec2_1];
                __fi_Vec2_1 = (__fi_Vec2_1 + 1);
            }
            __fi_Color_2 = (__fi_Color_2 + 1);
        }
        __fi_Point_3 = (__fi_Point_3 + 1);
    }
    return 0;
}
