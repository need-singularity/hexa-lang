...
int main(int argc, char** argv) {
    ...
    a = hexa_arr_lit((long[]){(long)(1), (long)(2), (long)(3)}, 3);
    b = hexa_arr_lit((long[]){(long)(4), (long)(5), (long)(6)}, 3);
    c = hexa_arr_concat(a, b);
    printf("%s %ld\n", "a+b len =", (long)(c.n));
    while ((i < c.n)) {
        printf("%ld %s %ld\n", (long)(i), "=", (long)(c.d[i]));
        i = (i + 1);
    }
    x = hexa_arr_lit((long[]){(long)("foo"), (long)("bar")}, 2);
    y = hexa_arr_lit((long[]){(long)("baz"), (long)("qux")}, 2);
    z = hexa_arr_concat(x, y);
    printf("%s %ld\n", "str len =", (long)(z.n));
    long __fi_s_1 = 0;
    while ((__fi_s_1 < z.n)) {
        const char* s = ((const char*)z.d[__fi_s_1]);
        printf("%s\n", s);
        __fi_s_1 = (__fi_s_1 + 1);
    }
    acc = hexa_arr_new();
    acc = hexa_arr_concat(acc, hexa_arr_lit((long[]){(long)(10)}, 1));
    acc = hexa_arr_concat(acc, hexa_arr_lit((long[]){(long)(20)}, 1));
    acc = hexa_arr_concat(acc, hexa_arr_lit((long[]){(long)(30)}, 1));
    printf("%s %ld %ld %ld %ld\n", "acc:", (long)(acc.n), (long)(acc.d[0]), (long)(acc.d[1]), (long)(acc.d[2]));
    printf("%s\n", "done");
    return 0;
}
