...
int main(int argc, char** argv) {
    ...
    xs = hexa_arr_lit((long[]){(long)(10), (long)(20), (long)(30), (long)(40), (long)(50)}, 5);
    long __fi_v_1 = 0;
    while ((__fi_v_1 < xs.n)) {
        long v = xs.d[__fi_v_1];
        total = (total + v);
        __fi_v_1 = (__fi_v_1 + 1);
    }
    printf("%s %ld\n", "sum =", (long)(total));
    words = hexa_arr_lit((long[]){(long)("hello"), (long)("world"), (long)("from"), (long)("hexa")}, 4);
    long __fi_w_2 = 0;
    while ((__fi_w_2 < words.n)) {
        const char* w = ((const char*)words.d[__fi_w_2]);
        printf("%s %s\n", "word:", w);
        __fi_w_2 = (__fi_w_2 + 1);
    }
    printf("%s\n", "done");
