...
long hexa_user_bsearch(long target);
long test(long target, long expected);

static hexa_arr sorted;
static long N = 20;
static long hits = 0;
static long t = 0;
...
long test(long target, long expected) {
    long idx = hexa_user_bsearch(target);
    const char* ok = (((idx == expected)) ? ("✓") : ("✗"));
    return printf("%s %ld %s %ld %s %ld %s\n", "search(", (long)(target), "): idx =", (long)(idx), " expected", (long)(expected), ok);
}


int main(int argc, char** argv) {
    hexa_main_argc = argc; hexa_main_argv = argv;
    sorted = hexa_arr_lit((long[]){(long)(1), (long)(3), (long)(5), (long)(7), (long)(9), (long)(11), (long)(13), (long)(17), (long)(19), (long)(23), (long)(29), (long)(31), (long)(37), (long)(41), (long)(43), (long)(47), (long)(53), (long)(59), (long)(61), (long)(67)}, 20);
    printf("%s\n", "=== binary search ===");
    printf("%s\n", "array: 20 primes (sorted)");
    test(1, 0);
    test(67, 19);
    test(29, 10);
    test(43, 14);
    ...
    while ((t < 100)) {
        long v = sorted.d[(t % N)];
        long r = hexa_user_bsearch(v);
        if ((r >= 0)) {
            hits = (hits + 1);
        }
        t = (t + 1);
    }
    printf("%s %ld\n", "100 searches: hits =", (long)(hits));
    printf("%s\n", "done");
    return 0;
}
