...
long rank_from_n6_quality(double q);
long rank_from_lens_consensus(long count);
long rank_from_mk2_confidence(double conf);
long rank_from_grade(const char* grade);
long combine_signals_v2(long r_n6, long r_lens, long r_grade, long r_mk2);
...
long rank_from_grade(const char* grade) {
    if ((strcmp(grade, "none") == 0)) {
        return (-1);
    } else if ((strcmp(grade, "white") == 0)) {
        return 0;
    } else if ((strcmp(grade, "circle") == 0)) {
        return 1;
    } else if ((strcmp(grade, "red") == 0)) {
        return 2;
    } else if ((strcmp(grade, "blue") == 0)) {
        return 5;
    } else if ((strcmp(grade, "orange") == 0)) {
        return 6;
    } else if ((strcmp(grade, "green") == 0)) {
        return 9;
    } else {
        return (-1);
    }
...
long combine_signals_v2(long r_n6, long r_lens, long r_grade, long r_mk2) {
    long m1 = (((r_n6 > r_lens)) ? (r_n6) : (r_lens));
    long m2 = (((r_grade > r_mk2)) ? (r_grade) : (r_mk2));
    if ((m1 > m2)) {
        return m1;
    } else {
        return m2;
...
int main(int argc, char** argv) {
    ...
    if (!((rank_from_n6_quality(1.0) == 9))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    if (!((rank_from_n6_quality(0.8) == 7))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    if (!((rank_from_n6_quality(0.0) == 0))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    if (!((rank_from_mk2_confidence(0.9) == 10))) { fprintf(stderr, "assertion failed\n"); exit(1); }
    printf("%s\n", "=== grading verified ===");
    printf("%s %ld\n", "q=1.0 -> r=", (long)(rank_from_n6_quality(1.0)));
    printf("%s %ld\n", "mk2=0.9 -> r=", (long)(rank_from_mk2_confidence(0.9)));
    return 0;
}
