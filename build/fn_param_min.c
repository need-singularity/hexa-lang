...
long sum_arr(hexa_arr xs);
long first_word(const char* s);

static hexa_arr nums;
static const char* msg = "hello world";
static long w;
static const char* first;
static hexa_arr built;
static long j = 10;
...
int main(int argc, char** argv) {
    ...
    nums = hexa_arr_lit((long[]){(long)(1), (long)(2), (long)(3), (long)(4), (long)(5), (long)(100)}, 6);
    printf("%s %ld\n", "sum_arr =", (long)(sum_arr(nums)));
    w = first_word(msg);
    printf("%s %ld\n", "first word len =", (long)(w));
    first = hexa_substr(msg, 0, w);
    printf("%s %s\n", "first word =", first);
    built = hexa_arr_new();
    while ((j <= 50)) {
        built = hexa_arr_push(built, j);
        j = (j + 10);
    }
    printf("%s %ld\n", "built sum =", (long)(sum_arr(built)));
    printf("%s\n", "done");
    return 0;
}
