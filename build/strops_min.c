...
int main(int argc, char** argv) {
    ...
    printf("%s %s %s\n", "orig     =[", s, "]");
    printf("%s %s %s\n", "trim     =[", hexa_trim(s), "]");
    printf("%s %s %s\n", "upper    =[", hexa_to_upper(s), "]");
    printf("%s %s %s\n", "lower    =[", hexa_to_lower(s), "]");
    printf("%s %s %s\n", "trim+up  =[", hexa_to_upper(hexa_trim(s)), "]");
    printf("%s %ld\n", "parse_int('42')     =", (long)(hexa_parse_int("42")));
    printf("%s %ld\n", "parse_int('-17')    =", (long)(hexa_parse_int("-17")));
    printf("%s %ld\n", "parse_int('  99  ') =", (long)(hexa_parse_int("  99  ")));
    printf("%s %ld\n", "parse_int('abc')    =", (long)(hexa_parse_int("abc")));
    printf("%s\n", "done");
    return 0;
}
