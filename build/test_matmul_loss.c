...
long old_similarity(long a, long b);
...
static long loss;
static long loss2;
static hexa_arr probs;
static long best;
static hexa_arr W;
static hexa_arr input;
static long logits_out;
static long prediction;
static long train_loss;
static long sim;
...
int main(int argc, char** argv) {
    ...
    A = hexa_arr_lit((long[]){(long)(1.0), (long)(2.0), (long)(3.0), (long)(4.0), (long)(5.0), (long)(6.0)}, 6);
    B = hexa_arr_lit((long[]){(long)(7.0), (long)(8.0), (long)(9.0), (long)(10.0), (long)(11.0), (long)(12.0)}, 6);
    C = matmul(A, B, 2, 3, 2);
    printf("%s %ld\n", "[1] matmul(2×3, 3×2) =", (long)(C));
    At = transpose(A, 2, 3);
    printf("%s %ld\n", "[2] transpose(2×3) =", (long)(At));
    Q = hexa_arr_lit((long[]){(long)(0.1), (long)(0.2), (long)(0.3), (long)(0.4), (long)(0.5), (long)(0.6), (long)(0.7), (long)(0.8)}, 8);
    K = hexa_arr_lit((long[]){(long)(0.2), (long)(0.1), (long)(0.4), (long)(0.3), (long)(0.6), (long)(0.5), (long)(0.8), (long)(0.7)}, 8);
    V = hexa_arr_lit((long[]){(long)(1.0), (long)(0.0), (long)(0.0), (long)(1.0), (long)(0.0), (long)(1.0), (long)(1.0), (long)(0.0)}, 8);
    Kt = transpose(K, 2, 4);
    scores = matmul(Q, Kt, 2, 4, 2);
    attn_weights = softmax(scores);
    printf("%s %ld\n", "[3] Attention scores:", (long)(scores));
    printf("%s %ld\n", "    Attention weights:", (long)(attn_weights));
    v = hexa_arr_lit((long[]){(long)(3.0), (long)(4.0)}, 2);
    vn = normalize(v);
    printf("%s %ld\n", "[4] normalize([3,4]) =", (long)(vn));
    logits = hexa_arr_lit((long[]){(long)(2.0), (long)(1.0), (long)(0.1)}, 3);
    loss = cross_entropy(logits, target);
    printf("%s %g\n", "[5] cross_entropy([2,1,0.1], target=0) =", (double)((hexa_round((double)((loss * 10000))) / 10000)));
    loss2 = cross_entropy(logits, 2);
    printf("%s %g\n", "    cross_entropy(target=2) =", (double)((hexa_round((double)((loss2 * 10000))) / 10000)));
    probs = hexa_arr_lit((long[]){(long)(0.1), (long)(0.7), (long)(0.15), (long)(0.05)}, 4);
    best = argmax(probs);
    printf("%s %ld\n", "[6] argmax([0.1,0.7,0.15,0.05]) =", (long)(best));
    W = hexa_arr_lit((long[]){(long)(0.5), (long)((-0.3)), (long)(0.1), (long)(0.2), (long)((-0.2)), (long)(0.6), (long)((-0.1)), (long)(0.3), (long)(0.4)}, 9);
    input = hexa_arr_lit((long[]){(long)(1.0), (long)(0.5), (long)((-0.2))}, 3);
    logits_out = matvec(W, input, 3, 3);
    prediction = argmax(logits_out);
    train_loss = cross_entropy(logits_out, 1);
    printf("%s\n", "[7] Training step:");
    printf("%s %ld\n", "    logits:", (long)(logits_out));
    printf("%s %ld %s %g\n", "    prediction:", (long)(prediction), "loss:", (double)((hexa_round((double)((train_loss * 10000))) / 10000)));
    sim = old_similarity(hexa_arr_lit((long[]){(long)(1.0), (long)(2.0)}, 2), hexa_arr_lit((long[]){(long)(3.0), (long)(4.0)}, 2));
    printf("%s %ld\n", "[8] deprecated fn still works:", (long)(sim));
    printf("%s\n", "--- matmul+loss+deprecated PASS ---");
    return 0;
}
