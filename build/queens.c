...
static long N = 8;
static hexa_arr board;
static long solutions = 0;
static hexa_arr first_solution;
static long _r;
...
long safe(long row, long col) {
    ...
    while ((i < row)) {
        ...
        if ((abs_i((board.d[i] - col)) == abs_i((i - row)))) {
            return 0;
        }
        i = (i + 1);
    }
...
int main(int argc, char** argv) {
    ...
    board = hexa_arr_lit((long[]){(long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0)}, 12);
    first_solution = hexa_arr_lit((long[]){(long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0)}, 12);
    if ((hexa_argc() >= 2)) {
        N = hexa_parse_int(hexa_arg(1));
        if ((N > 12)) {
            printf("%s\n", "N > 12 not supported");
            exit(1);
        }
