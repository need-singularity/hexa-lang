...
long area(long s);
long dot_product(long ax, long ay, long bx, long by);
long fib(long n);

static long Circle = 0;
static long Square = 1;
static long Red = 0;
static long Green = 1;
static long Blue = 2;
...
int main(int argc, char** argv) {
    ...
    p = hexa_struct_alloc((long[]){(long)(10), (long)(20)}, 2);
    sum = (p[0] + p[1]);
    printf("%ld\n", (long)(sum));
    v = hexa_struct_alloc((long[]){(long)(1), (long)(2), (long)(3)}, 3);
    printf("%ld\n", (long)(((v[0] + v[1]) + v[2])));
    impl;
    hexa_struct_alloc((long[]){(long)(magnitude_sq(self)), (long)(0), (long)(((/* unknown field x */ 0 * /* unknown field x */ 0) + (/* unknown field y */ 0 * /* unknown field y */ 0)))}, 3);
    0;
    p2 = hexa_struct_alloc((long[]){(long)(3), (long)(4)}, 2);
    printf("%ld\n", (long)(/* unsupported method .magnitude_sq */ 0));
    arr = hexa_arr_lit((long[]){(long)(100), (long)(200), (long)(300), (long)(400), (long)(500)}, 5);
    printf("%ld\n", (long)(arr.d[0]));
    printf("%ld\n", (long)(arr.d[2]));
    printf("%ld\n", (long)(arr.d[4]));
    nums = hexa_arr_lit((long[]){(long)(1), (long)(2), (long)(3), (long)(4), (long)(5), (long)(6), (long)(7), (long)(8), (long)(9), (long)(10)}, 10);
    while ((i < 10)) {
        total = (total + nums.d[i]);
        i = (i + 1);
    }
    printf("%ld\n", (long)(total));
    c = 0;
    ...
    a = hexa_struct_alloc((long[]){(long)(2), (long)(3)}, 2);
    b = hexa_struct_alloc((long[]){(long)(4), (long)(5)}, 2);
    printf("%ld\n", (long)(dot_product(a[0], a[1], b[0], b[1])));
    printf("%ld\n", (long)(fib(20)));
    return 0;
}
