...
double respond(double input);
double respond(double input);
double respond(double input);
double sigmoid(double x);
double vsigmoid(double x);
double vec_norm(long v);
...
double sigmoid(double x) {
    return (1.0 / (1.0 + hexa_exp((double)((-x)))));
}
...
double vec_norm(long v) {
    return hexa_sqrt((double)(dot(v, v)));
}
...
int main(int argc, char** argv) {
    ...
    r0 = respond(5.0);
    g0 = evolve_gen("respond");
    printf("%s %g %s %ld\n", "[1] Gen 0: respond(5.0) =", (double)(r0), "gen:", (long)(g0));
    r1 = respond(5.0);
    g1 = evolve_gen("respond");
    printf("%s %g %s %ld\n", "[1] Gen 1: respond(5.0) =", (double)(r1), "gen:", (long)(g1));
    r2 = respond(5.0);
    g2 = evolve_gen("respond");
    printf("%s %g %s %ld\n", "[1] Gen 2: respond(5.0) =", (double)(r2), "gen:", (long)(g2));
    a = hexa_arr_lit((long[]){(long)(1.0), (long)(2.0), (long)(3.0), (long)(4.0)}, 4);
    b = hexa_arr_lit((long[]){(long)(0.5), (long)(0.5), (long)(0.5), (long)(0.5)}, 4);
    d = dot(a, b);
    printf("%s %ld\n", "[2] dot([1,2,3,4], [0.5,0.5,0.5,0.5]) =", (long)(d));
    W = hexa_arr_lit((long[]){(long)(1.0), (long)(0.0), (long)(2.0), (long)(0.0), (long)(1.0), (long)((-1.0))}, 6);
    x = hexa_arr_lit((long[]){(long)(1.0), (long)(2.0), (long)(3.0)}, 3);
    result = matvec(W, x, 2, 3);
    printf("%s %ld\n", "[3] matvec([[1,0,2],[0,1,-1]], [1,2,3]) =", (long)(result));
    v1 = hexa_arr_lit((long[]){(long)(1.0), (long)(2.0), (long)(3.0)}, 3);
    v2 = hexa_arr_lit((long[]){(long)(0.1), (long)(0.2), (long)(0.3)}, 3);
    added = mat_add(v1, v2);
    printf("%s %ld\n", "[4] mat_add([1,2,3], [0.1,0.2,0.3]) =", (long)(added));
    scaled = mat_scale(v1, 0.5);
    printf("%s %ld\n", "[5] mat_scale([1,2,3], 0.5) =", (long)(scaled));
    ...
    z_raw = matvec(W_z, combined, 4, 4);
    printf("%s %ld\n", "[6] GRU z_raw = matvec(W_z, combined) =", (long)(z_raw));
    z = vsigmoid(z_raw);
    printf("%s %g\n", "[6] GRU z (sigmoid) =", (double)(z));
    ...
    sim = ((dot(cell0, cell1) / (vec_norm(cell0) + 0.0001)) / (vec_norm(cell1) + 0.0001));
    printf("%s %g\n", "[7] Hebbian cosine_sim(cell0, cell1) =", (double)((hexa_round((double)((sim * 10000))) / 10000)));
    printf("%s\n", "--- @evolve+matrix PASS ---");
    return 0;
}
