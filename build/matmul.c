...
long get_a(long r, long c);
long get_b(long r, long c);
long matmul();
long print_mat(const char* label);
...
long print_mat(const char* label) {
    ...
    while ((r < N)) {
        ...
        while ((c < N)) {
            long v = C.d[idx(r, c)];
            if ((v < 10)) {
                line = hexa_concat(line, " ");
            }
            line = hexa_concat(hexa_concat(line, hexa_int_to_str((long)(v))), " ");
            c = (c + 1);
        }
        printf("%s\n", hexa_concat("  ", line));
        r = (r + 1);
...
int main(int argc, char** argv) {
    ...
    A = hexa_arr_lit((long[]){(long)(1), (long)(2), (long)(3), (long)(4), (long)(5), (long)(6), (long)(7), (long)(8), (long)(9), (long)(10), (long)(11), (long)(12), (long)(13), (long)(14), (long)(15), (long)(16)}, 16);
    B = hexa_arr_lit((long[]){(long)(1), (long)(0), (long)(0), (long)(0), (long)(0), (long)(1), (long)(0), (long)(0), (long)(0), (long)(0), (long)(1), (long)(0), (long)(0), (long)(0), (long)(0), (long)(1)}, 16);
    C = hexa_arr_fill((long)(16), (long)(0));
    printf("%s\n", "=== matmul 4x4 ===");
    _r = matmul();
    print_mat("A × I =");
    printf("%s\n", "");
    printf("%s\n", "A × I should equal A (identity test)");
    while ((i < 16)) {
        if ((C.d[i] != A.d[i])) {
            ok = 0;
        }
