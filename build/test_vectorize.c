...
double hexa_user_double(double x);
double hebb_delta(double pre, double post, double lr);
double compute_reward(double delta_phi, double curiosity, double quality);

static double r1;
static double r2;
static hexa_arr pre;
static hexa_arr post;
...
double compute_reward(double delta_phi, double curiosity, double quality) {
    return ((delta_phi + (0.3 * curiosity)) + (0.5 * quality));
}


int main(int argc, char** argv) {
    hexa_main_argc = argc; hexa_main_argv = argv;
    r1 = hexa_user_double(hexa_arr_lit((long[]){(long)(1.0), (long)(2.0), (long)(3.0), (long)(4.0)}, 4));
    printf("%s %g\n", "[1] double([1,2,3,4]) =", (double)(r1));
    r2 = hexa_user_double(5.0);
    printf("%s %g\n", "[2] double(5.0) =", (double)(r2));
    pre = hexa_arr_lit((long[]){(long)(0.1), (long)(0.2), (long)(0.3), (long)(0.4), (long)(0.5)}, 5);
    post = hexa_arr_lit((long[]){(long)(0.5), (long)(0.4), (long)(0.3), (long)(0.2), (long)(0.1)}, 5);
    deltas = hebb_delta(pre, post, 0.01);
    printf("%s %g\n", "[3] hebb_delta(pre, post, 0.01) =", (double)(deltas));
    rewards = compute_reward(hexa_arr_lit((long[]){(long)(0.1), (long)(0.2), (long)((-0.1))}, 3), hexa_arr_lit((long[]){(long)(0.8), (long)(0.5), (long)(0.3)}, 3), hexa_arr_lit((long[]){(long)(0.9), (long)(0.7), (long)(0.4)}, 3));
    printf("%s %g\n", "[4] rewards =", (double)(rewards));
    big = hexa_arr_new();
    while ((i < 10000)) {
        big = hexa_arr_concat(big, hexa_arr_lit((long[]){(long)((i * 1.0))}, 1));
        i = (i + 1);
    }
    doubled = hexa_user_double(big);
    printf("%s %ld %ld %ld\n", "[5] double(10K array), first 3:", (long)(doubled[0]), (long)(doubled[1]), (long)(doubled[2]));
    printf("%s %ld\n", "    last:", (long)(doubled[9999]));
    printf("%s\n", "--- @vectorize 5/5 PASS ---");
    return 0;
}
