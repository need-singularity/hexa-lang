...
long djb2(const char* s);
long is_word_char_code(long c);
long to_lower_code(long c);

static const char* text = "The quick brown fox jumps over the lazy dog. The dog was not amused. The fox ran fast. The lazy dog slept. Fast fox.";
static hexa_arr buckets;
static hexa_arr cs;
static long n;
static long i = 0;
...
int main(int argc, char** argv) {
    ...
    printf("%s %s\n", "text:", text);
    printf("%s %ld\n", "length:", (long)(hexa_str_len(text)));
    buckets = hexa_arr_lit((long[]){(long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0), (long)(0)}, 64);
    cs = hexa_chars(text);
    n = cs.n;
    while ((i < n)) {
        long c = cs.d[i];
        if ((is_word_char_code(c) == 1)) {
            long lc = to_lower_code(c);
            cur = hexa_concat(cur, hexa_to_lower(hexa_substr(text, i, (i + 1))));
        } else {
            if ((hexa_str_len(cur) > 0)) {
                long h = djb2(cur);
                long b = (h % 64);
                buckets.d[b] = (buckets.d[b] + 1);
    ...
    printf("%s %ld\n", "total words:", (long)(total_words));
    printf("%s\n", "non-empty buckets:");
    while ((bi < 64)) {
        if ((buckets.d[bi] > 0)) {
            printf("%s %ld %s %ld\n", "  bucket", (long)(bi), "=", (long)(buckets.d[bi]));
            non_empty = (non_empty + 1);
        }
        bi = (bi + 1);
    }
    printf("%s %ld %s\n", "collisions visible in", (long)(non_empty), "buckets");
    printf("%s %ld\n", "hash('the') =", (long)(djb2("the")));
    printf("%s %ld\n", "hash('fox') =", (long)(djb2("fox")));
    printf("%s %ld\n", "hash('dog') =", (long)(djb2("dog")));
    printf("%s\n", "done");
    return 0;
}
