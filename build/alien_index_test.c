...
static long max_rank = 10;
static const char* shared_dir = "shared";
static const char* distribution_file = "shared/alien_index_distribution.json";
static const char* discovery_log_file = "shared/discovery_log.jsonl";
static const char* alien_index_dist_file;
static const char* growth_bus_file = "shared/growth_bus.jsonl";

long* ai_new(long d, long r) {
    long clamped = (((r > 10)) ? (10) : (hexa_struct_alloc((long[]){(long)(d), (long)(clamped)}, 2)));
    /* unsupported stmt */
    /* unsupported stmt */
    /* unsupported stmt */
    /* unsupported stmt */
...
int main(int argc, char** argv) {
    ...
    alien_index_dist_file = distribution_file;
    return 0;
}
