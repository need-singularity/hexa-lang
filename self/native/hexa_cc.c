...
HexaVal parse_let(void) {
    ...
    return __hexa_fn_arena_return(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", kind_str), "name", name), "value", typ), "op", hexa_str("")), "left", expr), "right", hexa_str("")), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str("")));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal parse_expr(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("ColonEq")))) {
        ...
        return __hexa_fn_arena_return(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("WalrusExpr")), "name", hexa_map_get_ic(left, "name", &__hexa_parser_ic_129)), "value", hexa_str("")), "op", hexa_str(":=")), "left", left), "right", right), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str("")));
    }
...
HexaVal parse_primary(void) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        p_advance();
        return __hexa_fn_arena_return(node_int_lit(hexa_map_get_ic(tok, "value", &__hexa_parser_ic_146)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
        p_advance();
        return __hexa_fn_arena_return(node_float_lit(hexa_map_get_ic(tok, "value", &__hexa_parser_ic_147)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BoolLit")))) {
        p_advance();
        return __hexa_fn_arena_return(node_bool_lit(hexa_map_get_ic(tok, "value", &__hexa_parser_ic_148)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StringLit")))) {
        p_advance();
        return __hexa_fn_arena_return(node_string_lit(hexa_map_get_ic(tok, "value", &__hexa_parser_ic_149)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("CharLit")))) {
        p_advance();
        return __hexa_fn_arena_return(node_char_lit(hexa_map_get_ic(tok, "value", &__hexa_parser_ic_150)));
    }
...
HexaVal ast_to_string(HexaVal node, HexaVal indent) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("IntLit(")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_199)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("FloatLit(")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_200)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BoolLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("BoolLit(")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_201)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StringLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("StringLit(\"")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_202)), hexa_str("\")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("CharLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("CharLit('")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_203)), hexa_str("')")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("Ident(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_204)), hexa_str(")")));
    }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("BinOp(")), hexa_map_get_ic(node, "op", &__hexa_parser_ic_207)), hexa_str(", ")), l), hexa_str(", ")), r), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("UnaryOp(")), hexa_map_get_ic(node, "op", &__hexa_parser_ic_209)), hexa_str(", ")), operand), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Call")))) {
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("Call(")), callee), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_parser_ic_211))))), hexa_str(" args])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Field")))) {
        obj = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_212), hexa_int(0));
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("Field(")), obj), hexa_str(".")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_213)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("OptField")))) {
        obj = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_214), hexa_int(0));
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("OptField(")), obj), hexa_str("?.")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_215)), hexa_str(")")));
    }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("MatchExpr")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("MatchExpr([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_parser_ic_224))))), hexa_str(" arms])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Array")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("Array([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_225))))), hexa_str(" items])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ListComp")))) {
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ListComp(")), body_s), hexa_str(" for ")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_230)), hexa_str(" in ")), iter_s), filt), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StructInit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("StructInit(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_231)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_parser_ic_232))))), hexa_str(" fields])")));
    }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Range")))) {
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("Range(")), s), hexa_str("..")), e), hexa_str(", ")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_242)), step_str), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumPath")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("EnumPath(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_243)), hexa_str("::")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_244)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Lambda")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("Lambda([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_245))))), hexa_str(" params])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Tuple")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("Tuple([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_246))))), hexa_str(" items])")));
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt")))))) {
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, k), hexa_str("(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_248)), hexa_str(" = ")), v), hexa_str(")")));
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("ConstStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("StaticStmt")))))) {
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, k), hexa_str("(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_250)), hexa_str(" = ")), v), hexa_str(")")));
    }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("FnDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("FnDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_253)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_254))))), hexa_str(" params], [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_255))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StructDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("StructDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_256)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_parser_ic_257))))), hexa_str(" fields])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("EnumDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_258)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "variants", &__hexa_parser_ic_259))))), hexa_str(" variants])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ForStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ForStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_260)), hexa_str(" in ..., [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_261))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("WhileStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("WhileStmt(..., [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_262))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("LoopStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("LoopStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_263))))), hexa_str(" stmts])")));
    }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ProofStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ProofStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_268)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_269))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ImplBlock")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ImplBlock(")), hexa_map_get_ic(node, "target", &__hexa_parser_ic_270)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "methods", &__hexa_parser_ic_271))))), hexa_str(" methods])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("TraitDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("TraitDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_272)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "methods", &__hexa_parser_ic_273))))), hexa_str(" methods])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("UseStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("UseStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_274))))), hexa_str(" segments])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ModStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("ModStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_275)), hexa_str(")")));
    }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("YieldStmt")))) {
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("YieldStmt(")), ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_277), hexa_int(0))), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeFnDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ComptimeFnDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_278)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_279))))), hexa_str(" params])")));
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("ComptimeConst"))) || hexa_truthy(hexa_eq(k, hexa_str("ComptimeLet")))))) {
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, k), hexa_str("(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_281)), hexa_str(" = ")), v), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeBlock")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("ComptimeBlock([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_282))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeAssert")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("ComptimeAssert(")), ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_283), hexa_int(0))), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("IntentStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("IntentStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_284)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_parser_ic_285))))), hexa_str(" fields])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("VerifyStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("VerifyStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_286)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_287))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("GenerateFnStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("GenerateStmt")))))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(pad, k), hexa_str("(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_288)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("OptimizeFnStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("OptimizeFnStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_289)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_290))))), hexa_str(" params])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EffectDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("EffectDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_291)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_292))))), hexa_str(" ops])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("PureFnDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("PureFnDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_293)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_294))))), hexa_str(" params])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("MacroDef")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("MacroDef(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_295)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_296))))), hexa_str(" rules])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("DeriveDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("DeriveDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_297)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_298))))), hexa_str(" traits])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("TheoremStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("TheoremStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_299)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_300))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("HandleWithStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("HandleWithStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_301))))), hexa_str(" handlers])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("GuardStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("GuardStmt(cond, [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_parser_ic_302))))), hexa_str(" else stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("GuardLetStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("GuardLetStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_303)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_parser_ic_304))))), hexa_str(" else stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("WithStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("WithStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_305)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_306))))), hexa_str(" body stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("WalrusExpr")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("WalrusExpr(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_307)), hexa_str(", ")), ast_to_string(hexa_map_get_ic(node, "right", &__hexa_parser_ic_308), hexa_int(0))), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("TryCatch")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("TryCatch(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_309)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ThrowStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("ThrowStmt(")), ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_310), hexa_int(0))), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("PanicStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("PanicStmt(")), ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_311), hexa_int(0))), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("DropStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("DropStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_312)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("SpawnStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("SpawnStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_313))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ScopeStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("ScopeStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_314))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("SelectStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("SelectStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_parser_ic_315))))), hexa_str(" arms])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("AsyncFnDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("AsyncFnDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_316)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_317))))), hexa_str(" params])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ExternFnDecl")))) {
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ExternFnDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_320)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_321))))), hexa_str(" params]")), sym_info), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("TypeAlias")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("TypeAlias(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_322)), hexa_str(" = ")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_323)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("AtomicLet")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("AtomicLet(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_324)), hexa_str(")")));
    }
...
HexaVal gen2_fn_forward(HexaVal node) {
    ...
    HexaVal params = hexa_array_new();
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_cmp_lt(i, hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_44)))))) {
    ...
    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(prefix, hexa_str("HexaVal ")), _hexa_mangle_ident(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_49))), hexa_str("(")), p), hexa_str(");")));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal gen2_fn_decl(HexaVal node) {
    ...
    HexaVal params = hexa_array_new();
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_cmp_lt(i, hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_54)))))) {
        if (hexa_truthy(has_restrict)) {
    ...
    while (hexa_truthy(hexa_cmp_lt(_pi, hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_62)))))) {
...
HexaVal gen2_stmt_stack_alloc(HexaVal node, HexaVal depth) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt")))) {
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_85)), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_86), "kind", &__hexa_codegen_c2_ic_87), hexa_str("ArrayLit")))))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("/* @stack_alloc */ HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_88)), hexa_str(" = hexa_stack_array(1024);\n")));
        }
    }
...
HexaVal gen2_extern_static_decl(HexaVal node) {
    ...
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_cmp_lt(i, hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_93)))))) {
...
HexaVal gen2_extern_includes(HexaVal ast) {
    ...
    while (hexa_truthy(hexa_cmp_lt(i, hexa_int(hexa_len(ast))))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_index_get(ast, i), "kind", &__hexa_codegen_c2_ic_100), hexa_str("ExternFnDecl")))) {
            ...
            HexaVal j = hexa_int(0);
            while (hexa_truthy(hexa_cmp_lt(j, hexa_int(hexa_len(hexa_map_get_ic(hexa_index_get(ast, i), "params", &__hexa_codegen_c2_ic_103)))))) {
...
HexaVal _gen2_collect_lets_stmt(HexaVal node, HexaVal names) {
    ...
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_131)), hexa_str("string")))))) {
        ...
        while (hexa_truthy(hexa_cmp_lt(ai, hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_132)))))) {
...
HexaVal gen2_stmt(HexaVal node, HexaVal depth) {
    ...
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt")))))) {
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt"))) && hexa_truthy(hexa_eq(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_144), hexa_str("__reg_promote__")))))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("register HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_145)), hexa_str(" = ")), init), hexa_str("; /* reg-promoted */\n")));
        }
        if (hexa_truthy(_gen2_has_decl(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_146)))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_147)), hexa_str(" = ")), init), hexa_str(";\n")));
        }
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_148)), hexa_str(" = ")), init), hexa_str(";\n")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ConstStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_149)), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_150))), hexa_str(";\n")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("AssignStmt")))) {
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(pad, gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_178))), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_179))), hexa_str(";\n")));
    }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ReturnStmt")))) {
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_183)), hexa_str("string")))))) {
            if (hexa_truthy(hexa_eq(_gen2_arena_wrap, hexa_int(1)))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("return __hexa_fn_arena_return(")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_184))), hexa_str(");\n")));
            }
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("return ")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_185))), hexa_str(";\n")));
        }
        if (hexa_truthy(hexa_eq(_gen2_arena_wrap, hexa_int(1)))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ExprStmt")))) {
        ...
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(expr, "kind", &__hexa_codegen_c2_ic_188), hexa_str("IfExpr")))) {
            ...
            ti = hexa_int(0);
            while (hexa_truthy(hexa_cmp_lt(ti, hexa_int(hexa_len(hexa_map_get_ic(expr, "then_body", &__hexa_codegen_c2_ic_190)))))) {
            ...
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(expr, "else_body", &__hexa_codegen_c2_ic_192)), hexa_str("string"))))) && hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(hexa_map_get_ic(expr, "else_body", &__hexa_codegen_c2_ic_193))), hexa_int(0)))))) {
                chunks = hexa_array_push(chunks, hexa_str(" else {\n"));
                HexaVal ei = hexa_int(0);
                while (hexa_truthy(hexa_cmp_lt(ei, hexa_int(hexa_len(hexa_map_get_ic(expr, "else_body", &__hexa_codegen_c2_ic_194)))))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("WhileStmt")))) {
        ...
        while (hexa_truthy(hexa_cmp_lt(wi, hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_197)))))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ForStmt")))) {
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(iter), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(iter, "kind", &__hexa_codegen_c2_ic_200), hexa_str("Range")))))) {
            ...
            while (hexa_truthy(hexa_cmp_lt(fi, hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_210)))))) {
        ...
        while (hexa_truthy(hexa_cmp_lt(fi, hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_213)))))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("AssertStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("if (!hexa_truthy(")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_215))), hexa_str(")) { fprintf(stderr, \"assertion failed\\n\"); exit(1); }\n")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ThrowStmt")))) {
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_216)), hexa_str("string")))))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("hexa_throw(")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_217))), hexa_str(");\n")));
        }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("LoopStmt")))) {
        ...
        while (hexa_truthy(hexa_cmp_lt(li, hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_221)))))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("GuardStmt")))) {
        ...
        while (hexa_truthy(hexa_cmp_lt(gi, hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_224)))))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("GuardLetStmt")))) {
        ...
        while (hexa_truthy(hexa_cmp_lt(gli, hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_229)))))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeConst")))) {
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_233)), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_234))), hexa_str(";\n")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("OptimizeFnStmt")))) {
        return __hexa_fn_arena_return(hexa_str(""));
    }
...
HexaVal gen2_expr(HexaVal node) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_int("), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_236)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_float("), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_237)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BoolLit")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("StringLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_str(\""), c_escape(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_239))), hexa_str("\")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("CharLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_str(\""), c_escape(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_240))), hexa_str("\")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        ...
        return __hexa_fn_arena_return(_hexa_mangle_ident(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_242)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_258), hexa_str("-")))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_sub(hexa_int(0), "), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_259))), hexa_str(")")));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_260), hexa_str("!")))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_bool(!hexa_truthy("), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_261))), hexa_str("))")));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_262), hexa_str("~")))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_int(~hexa_as_num("), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_263))), hexa_str("))")));
        }
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("(fprintf(stderr, \"CODEGEN ERROR: unhandled unary op: "), hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_265)), hexa_str("\\n\"), exit(1), hexa_void())")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Field")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("StructInit")))) {
        ...
        si = hexa_int(0);
        while (hexa_truthy(hexa_cmp_lt(si, hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_269)))))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Call")))) {
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(callee), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(callee, "kind", &__hexa_codegen_c2_ic_273), hexa_str("Ident")))))) {
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("println")))) {
                if (hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_275))), hexa_int(0)))) {
                    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_println("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_276), hexa_int(0)))), hexa_str(")")));
                }
                return __hexa_fn_arena_return(hexa_str("(printf(\"\\n\"), hexa_void())"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("print")))) {
                if (hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_277))), hexa_int(0)))) {
                    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("(hexa_print_val("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_278), hexa_int(0)))), hexa_str("), hexa_void())")));
                }
                return __hexa_fn_arena_return(hexa_str("hexa_void()"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("len")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_int(hexa_len("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_279), hexa_int(0)))), hexa_str("))")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("to_string")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_to_string("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_280), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("type_of")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_type_of("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_281), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("sqrt")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_sqrt("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_282), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("floor")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_floor("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_283), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ceil")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_ceil("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_284), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("abs")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_abs("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_285), hexa_int(0)))), hexa_str(")")));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("pow")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_pow("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_292), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_293), hexa_int(1)))), hexa_str(")")));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("format")))) {
                ...
                while (hexa_truthy(hexa_cmp_lt(fi, hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_299)))))) {
                ...
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_format_n("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_301), hexa_int(0)))), hexa_str(", ")), fmt_args), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("eprintln")))) {
                if (hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_302))), hexa_int(0)))) {
                    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("(hexa_eprint_val("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_303), hexa_int(0)))), hexa_str("), fprintf(stderr, \"\\n\"), hexa_void())")));
                }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("exec")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_exec("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_304), hexa_int(0)))), hexa_str(")")));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("read_file")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_read_file("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_310), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_file")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_write_file("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_311), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_312), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("net_listen")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_net_listen("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_313), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("net_accept")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_net_accept("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_314), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("net_close")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_net_close("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_315), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("net_connect")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_net_connect("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_316), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("net_read")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_net_read("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_317), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("net_write")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_net_write("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_318), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_319), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("cstring")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_cstring("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_320), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("from_cstring")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_from_cstring("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_321), hexa_int(0)))), hexa_str(")")));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_addr")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_ptr_addr("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_322), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("host_ffi_open")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_host_ffi_open("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_323), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("host_ffi_sym")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_host_ffi_sym("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_324), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_325), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("host_ffi_call")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_host_ffi_call("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_326), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_327), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_328), hexa_int(2)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_329), hexa_int(3)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("host_ffi_call_6")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_host_ffi_call_6("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_330), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_331), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_332), hexa_int(2)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_333), hexa_int(3)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_334), hexa_int(4)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_335), hexa_int(5)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_336), hexa_int(6)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_337), hexa_int(7)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_338), hexa_int(8)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_339), hexa_int(9)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("callback_create")))) {
                HexaVal arg = hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_340), hexa_int(0));
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(arg), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(arg, "kind", &__hexa_codegen_c2_ic_341), hexa_str("Ident")))))) {
                    HexaVal fn_name = hexa_map_get_ic(arg, "name", &__hexa_codegen_c2_ic_342);
                    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_callback_create(hexa_fn_new((void*)"), fn_name), hexa_str(", 0))")));
                }
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_callback_create("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_343), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("callback_free")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_callback_free("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_344), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("callback_slot_id")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_callback_slot_id("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_345), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_alloc")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_ptr_alloc("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_346), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_free")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_free("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_347), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_348), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_write")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_349), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_350), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_351), hexa_int(2)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_write_f32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write_f32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_352), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_353), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_354), hexa_int(2)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_write_i32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write_i32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_355), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_357), hexa_int(2)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_read")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_358), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_359), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_read_f64")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read_f64("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_360), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_361), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_read_f32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read_f32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_362), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_363), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_read_i32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read_i32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_364), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_365), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_offset")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_offset("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_366), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_367), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("deref")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_deref("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_368), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("__prefetch")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_369), hexa_int(0)));
                b = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_370), hexa_int(1)));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_pack")))) {
                ...
                si = hexa_int(0);
                while (hexa_truthy(hexa_cmp_lt(si, hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_371)))))) {
                    a_strs = hexa_array_push(a_strs, gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_372), si)));
                    si = hexa_add(si, hexa_int(1));
                }
                n = hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_373))));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_pack_f32")))) {
                a_strs = hexa_array_new();
                si = hexa_int(0);
                while (hexa_truthy(hexa_cmp_lt(si, hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_374)))))) {
                    a_strs = hexa_array_push(a_strs, gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_375), si)));
                    si = hexa_add(si, hexa_int(1));
                }
                n = hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_376))));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_unpack")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_unpack("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_377), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_378), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_unpack_f32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_unpack_f32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_379), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_380), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_rect")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_rect("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_381), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_382), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_383), hexa_int(2)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_384), hexa_int(3)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_point")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_point("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_385), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_386), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_size")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_size_pack("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_387), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_388), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_free")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_struct_free("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_389), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("alloc_raw")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_ptr_alloc("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_390), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("free_raw")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_ptr_free("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_391), hexa_int(0)))), hexa_str(", hexa_int(0))")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_f32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write_f32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_392), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_393), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_394), hexa_int(2)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_i32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write_i32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_395), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_396), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_397), hexa_int(2)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_i64")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_398), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_399), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_400), hexa_int(2)))), hexa_str(")")));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_from_int")))) {
                return __hexa_fn_arena_return(gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_405), hexa_int(0))));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("int")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_406), hexa_int(0)));
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_int((HX_IS_STR("), a), hexa_str(")?atoll(hexa_to_cstring(")), a), hexa_str(")):(int64_t)__hx_to_double(")), a), hexa_str(")))")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("str")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_to_string("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_407), hexa_int(0)))), hexa_str(")")));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("tensor")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_new("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_408), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_409), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("randn")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_randn("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_410), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_411), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("tensor_data_f32_ptr")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_tensor_data_ptr("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_412), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("tensor_from_f32_ptr")))) {
                if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_413))), hexa_int(2)))) {
                    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_from_ptr("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_414), hexa_int(0)))), hexa_str(", hexa_int(1), ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_415), hexa_int(1)))), hexa_str(")")));
                }
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_from_ptr("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_416), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_417), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_418), hexa_int(2)))), hexa_str(")")));
            }
            arg_strs = hexa_array_new();
            ai = hexa_int(0);
            while (hexa_truthy(hexa_cmp_lt(ai, hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_419)))))) {
                HexaVal _arg = hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_420), ai);
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(_arg), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(_arg, "kind", &__hexa_codegen_c2_ic_421), hexa_str("Ident"))))) && hexa_truthy(_is_known_fn_global(hexa_map_get_ic(_arg, "name", &__hexa_codegen_c2_ic_422)))))) {
                    arg_strs = hexa_array_push(arg_strs, hexa_add(hexa_add(hexa_str("hexa_fn_new((void*)"), _hexa_mangle_ident(hexa_map_get_ic(_arg, "name", &__hexa_codegen_c2_ic_423))), hexa_str(", 0)")));
                } else {
            ...
            if (hexa_truthy(hexa_cmp_ge(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_424))), hexa_int(2)))) {
            ...
            if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_425))), hexa_int(0)))) {
            ...
            if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_426))), hexa_int(1)))) {
            ...
            if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_427))), hexa_int(2)))) {
            ...
            nargs = hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_428)));
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(callee), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(callee, "kind", &__hexa_codegen_c2_ic_429), hexa_str("Field")))))) {
            obj = gen2_expr(hexa_map_get_ic(callee, "left", &__hexa_codegen_c2_ic_430));
            HexaVal method = hexa_map_get_ic(callee, "name", &__hexa_codegen_c2_ic_431);
            ...
            if (hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(user_types)), hexa_int(0)))) {
                ...
                while (hexa_truthy(hexa_cmp_lt(uai, hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_432)))))) {
                    u_args = hexa_array_push(u_args, gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_433), uai)));
                    uai = hexa_add(uai, hexa_int(1));
                }
                HexaVal u_arg_tail = hexa_str_join(u_args, hexa_str(", "));
                HexaVal __saved_obj = obj;
                HexaVal fb = gen2_method_builtin(hexa_str("__mr"), method, hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_434));
                HexaVal chain = fb;
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("push")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_push("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_435), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("len")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("contains")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_str_contains("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_436), hexa_int(0)))), hexa_str("))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("join")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_join("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_437), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("to_upper")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("split")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_split("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_438), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("trim")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_str_trim("), obj), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("replace")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_replace("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_439), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_440), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("repeat")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_repeat("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_441), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("starts_with")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_str_starts_with("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_442), hexa_int(0)))), hexa_str("))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("ends_with")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_str_ends_with("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_443), hexa_int(0)))), hexa_str("))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("substring")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_substring("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_444), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_445), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("index_of")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_int(hexa_str_index_of("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_446), hexa_int(0)))), hexa_str("))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("keys")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("contains_key")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_map_contains_key("), obj), hexa_str(", hexa_to_cstring(")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_447), hexa_int(0)))), hexa_str(")))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("has_key")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_map_contains_key("), obj), hexa_str(", hexa_to_cstring(")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_448), hexa_int(0)))), hexa_str(")))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("remove")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_map_remove("), obj), hexa_str(", hexa_to_cstring(")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_449), hexa_int(0)))), hexa_str("))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("pop")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("truncate")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_truncate("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_450), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("push_nostat")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_push_nostat("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_451), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("trim_start")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("slice")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_slice("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_452), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_453), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("slice_fast")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_slice_fast("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_454), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_455), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("to_string")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("pad_left")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_pad_left("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_456), hexa_int(0)))), hexa_str(")")));
            }
        ...
        nargs = hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_457)));
        HexaVal cargs = hexa_array_new();
        HexaVal ci = hexa_int(0);
        while (hexa_truthy(hexa_cmp_lt(ci, nargs))) {
            HexaVal _ca = hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_458), ci);
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(_ca), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(_ca, "kind", &__hexa_codegen_c2_ic_459), hexa_str("Ident"))))) && hexa_truthy(_is_known_fn_global(hexa_map_get_ic(_ca, "name", &__hexa_codegen_c2_ic_460)))))) {
                cargs = hexa_array_push(cargs, hexa_add(hexa_add(hexa_str("hexa_fn_new((void*)"), _hexa_mangle_ident(hexa_map_get_ic(_ca, "name", &__hexa_codegen_c2_ic_461))), hexa_str(", 0)")));
            } else {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Array")))) {
        ...
        ai = hexa_int(0);
        while (hexa_truthy(hexa_cmp_lt(ai, hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_462)))))) {
            out = hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_push("), out), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_463), ai))), hexa_str(")"));
            ai = hexa_add(ai, hexa_int(1));
        }
        return __hexa_fn_arena_return(out);
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Index")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_index_get("), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_464))), hexa_str(", ")), gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_465))), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumPath")))) {
        HexaVal ename = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_466);
        HexaVal vname = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_467);
        return __hexa_fn_arena_return(hexa_add(hexa_add(ename, hexa_str("_")), vname));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("IfExpr")))) {
        HexaVal c = gen2_expr(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_468));
        HexaVal t_val = hexa_str("hexa_void()");
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_469)), hexa_str("string"))))) && hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_470))), hexa_int(0)))))) {
            HexaVal t_last = hexa_index_get(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_471), hexa_sub(hexa_int(hexa_len(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_472))), hexa_int(1)));
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(t_last), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(t_last, "kind", &__hexa_codegen_c2_ic_473), hexa_str("ExprStmt"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(t_last, "left", &__hexa_codegen_c2_ic_474)), hexa_str("string")))))))) {
                t_val = gen2_expr(hexa_map_get_ic(t_last, "left", &__hexa_codegen_c2_ic_475));
            }
        }
        HexaVal e_val = hexa_str("hexa_void()");
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_476)), hexa_str("string"))))) && hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_477))), hexa_int(0)))))) {
            HexaVal e_last = hexa_index_get(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_478), hexa_sub(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_479))), hexa_int(1)));
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(e_last), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(e_last, "kind", &__hexa_codegen_c2_ic_480), hexa_str("ExprStmt"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(e_last, "left", &__hexa_codegen_c2_ic_481)), hexa_str("string")))))))) {
                e_val = gen2_expr(hexa_map_get_ic(e_last, "left", &__hexa_codegen_c2_ic_482));
            }
        }
    ...
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("Tuple"))) || hexa_truthy(hexa_eq(k, hexa_str("TupleLit")))))) {
        out = hexa_str("hexa_array_new()");
        HexaVal items = hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_483);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("MapLit")))) {
        ...
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_484)), hexa_str("string")))))) {
            HexaVal mi = hexa_int(0);
            while (hexa_truthy(hexa_cmp_lt(mi, hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_485)))))) {
                HexaVal entry = hexa_index_get(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_486), mi);
                HexaVal key_c = gen2_expr(hexa_map_get_ic(entry, "left", &__hexa_codegen_c2_ic_487));
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(entry, "left", &__hexa_codegen_c2_ic_488)), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(entry, "left", &__hexa_codegen_c2_ic_489), "kind", &__hexa_codegen_c2_ic_490), hexa_str("StringLit")))))) {
                    key_c = hexa_add(hexa_add(hexa_str("\""), c_escape(hexa_map_get_ic(hexa_map_get_ic(entry, "left", &__hexa_codegen_c2_ic_491), "value", &__hexa_codegen_c2_ic_492))), hexa_str("\""));
                }
                out = hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_map_set("), out), hexa_str(", ")), key_c), hexa_str(", ")), gen2_expr(hexa_map_get_ic(entry, "right", &__hexa_codegen_c2_ic_493))), hexa_str(")"));
                mi = hexa_add(mi, hexa_int(1));
            }
        }
        return __hexa_fn_arena_return(out);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("NegFloat")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_float(-HX_FLOAT("), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_494))), hexa_str("))")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Wildcard")))) {
...
HexaVal gen2_struct_forward(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_495);
    HexaVal nfields = hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_496)));
    ...
    while (hexa_truthy(hexa_cmp_lt(fi, nfields))) {
        params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_497), fi), "name", &__hexa_codegen_c2_ic_498)));
        fi = hexa_add(fi, hexa_int(1));
    }
...
HexaVal gen2_struct_decl(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_499);
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(name, hexa_str("Val"))) && hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_500))), hexa_int(12)))))) {
        HexaVal vs_params = hexa_array_new();
        HexaVal vs_args = hexa_array_new();
        HexaVal vi = hexa_int(0);
        while (hexa_truthy(hexa_cmp_lt(vi, hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_501)))))) {
            HexaVal fname = hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_502), vi), "name", &__hexa_codegen_c2_ic_503);
    ...
    HexaVal nfields = hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_504)));
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_cmp_lt(i, nfields))) {
        HexaVal f = hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_505), i);
        params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_506)));
        ...
        keys_parts = hexa_array_push(keys_parts, hexa_add(hexa_add(hexa_str("\""), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_507)), hexa_str("\"")));
        vals_parts = hexa_array_push(vals_parts, hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_508));
        i = hexa_add(i, hexa_int(1));
    }
    HexaVal p = hexa_str_join(params, hexa_str(", "));
    HexaVal p_sig = p;
...
HexaVal gen2_struct_decl_aligned(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_509);
    HexaVal params = hexa_array_new();
    ...
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_cmp_lt(i, hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_510)))))) {
        HexaVal f = hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_511), i);
        params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_512)));
        body_parts = hexa_array_push(body_parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    __s = hexa_map_set(__s, \""), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_513)), hexa_str("\", ")), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_514)), hexa_str(");\n")));
        i = hexa_add(i, hexa_int(1));
    }
    HexaVal p = hexa_str_join(params, hexa_str(", "));
    if (hexa_truthy(hexa_eq(p, hexa_str("")))) {
...
HexaVal gen2_enum_decl(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_515);
    HexaVal vc = hexa_int(hexa_len(hexa_map_get_ic(node, "variants", &__hexa_codegen_c2_ic_516)));
    ...
    while (hexa_truthy(hexa_cmp_lt(i, vc))) {
        HexaVal v = hexa_index_get(hexa_map_get_ic(node, "variants", &__hexa_codegen_c2_ic_517), i);
        parts = hexa_array_push(parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("#define "), name), hexa_str("_")), hexa_map_get_ic(v, "name", &__hexa_codegen_c2_ic_518)), hexa_str(" hexa_int(")), hexa_to_string(i)), hexa_str(")\n")));
        i = hexa_add(i, hexa_int(1));
    }
    return __hexa_fn_arena_return(hexa_str_join(parts, hexa_str("")));
    return __hexa_fn_arena_return(hexa_void());
...
HexaVal gen2_match_stmt(HexaVal node, HexaVal depth) {
    __hexa_fn_arena_enter();
    HexaVal pad = gen2_indent(depth);
    HexaVal scrutinee = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_519));
    HexaVal chunks = hexa_array_new();
    chunks = hexa_array_push(chunks, hexa_add(pad, hexa_str("{\n")));
    ...
    HexaVal ai = hexa_int(0);
    while (hexa_truthy(hexa_cmp_lt(ai, hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_520)))))) {
        HexaVal arm = hexa_index_get(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_521), ai);
        HexaVal pat = hexa_map_get_ic(arm, "left", &__hexa_codegen_c2_ic_522);
        HexaVal is_wildcard = hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(pat), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(pat, "kind", &__hexa_codegen_c2_ic_523), hexa_str("Wildcard"))));
        ...
        HexaVal bi = hexa_int(0);
        while (hexa_truthy(hexa_cmp_lt(bi, hexa_int(hexa_len(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_524)))))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_525), bi), hexa_add(depth, hexa_int(2))));
            bi = hexa_add(bi, hexa_int(1));
        }
        chunks = hexa_array_push(chunks, hexa_add(pad2, hexa_str("}")));
        ai = hexa_add(ai, hexa_int(1));
...
HexaVal gen2_match_cond(HexaVal pat, HexaVal scrutinee_var) {
    ...
    HexaVal k = hexa_map_get_ic(pat, "kind", &__hexa_codegen_c2_ic_526);
    if (hexa_truthy(hexa_eq(k, hexa_str("Wildcard")))) {
        return __hexa_fn_arena_return(hexa_str("1"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_truthy(hexa_eq("), scrutinee_var), hexa_str(", hexa_int(")), hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_527)), hexa_str(")))")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_truthy(hexa_eq("), scrutinee_var), hexa_str(", hexa_float(")), hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_528)), hexa_str(")))")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StringLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_truthy(hexa_eq("), scrutinee_var), hexa_str(", hexa_str(\"")), c_escape(hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_529))), hexa_str("\")))")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BoolLit")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_530), hexa_str("true")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumPath")))) {
        HexaVal enum_const = hexa_add(hexa_add(hexa_map_get_ic(pat, "name", &__hexa_codegen_c2_ic_531), hexa_str("_")), hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_532));
...
HexaVal gen2_match_expr(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal scrutinee = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_533));
    HexaVal arms = hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_534);
...
HexaVal gen2_match_ternary(HexaVal arms, HexaVal scrutinee_c, HexaVal idx) {
    ...
    HexaVal pat = hexa_map_get_ic(arm, "left", &__hexa_codegen_c2_ic_535);
    HexaVal is_wildcard = hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(pat), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(pat, "kind", &__hexa_codegen_c2_ic_536), hexa_str("Wildcard"))));
    HexaVal val = gen2_arm_value(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_537));
...
HexaVal gen2_arm_value(HexaVal body) {
    ...
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(last, "kind", &__hexa_codegen_c2_ic_538), hexa_str("ExprStmt")))) {
        return __hexa_fn_arena_return(gen2_expr(hexa_map_get_ic(last, "left", &__hexa_codegen_c2_ic_539)));
    }
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(last, "kind", &__hexa_codegen_c2_ic_540), hexa_str("ReturnStmt")))) {
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(last, "left", &__hexa_codegen_c2_ic_541)), hexa_str("string")))))) {
            return __hexa_fn_arena_return(gen2_expr(hexa_map_get_ic(last, "left", &__hexa_codegen_c2_ic_542)));
        }
    }
    return __hexa_fn_arena_return(hexa_str("hexa_void()"));
    return __hexa_fn_arena_return(hexa_void());
...
HexaVal gen2_impl_block(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal type_n = hexa_map_get_ic(node, "target", &__hexa_codegen_c2_ic_543);
    HexaVal fwd_chunks = hexa_array_new();
    HexaVal fn_chunks = hexa_array_new();
    HexaVal methods = hexa_map_get_ic(node, "methods", &__hexa_codegen_c2_ic_544);
    HexaVal mi = hexa_int(0);
    while (hexa_truthy(hexa_cmp_lt(mi, hexa_int(hexa_len(methods))))) {
        HexaVal m = hexa_index_get(methods, mi);
        HexaVal mangled = hexa_add(hexa_add(type_n, hexa_str("__")), hexa_map_get_ic(m, "name", &__hexa_codegen_c2_ic_545));
        _method_registry = hexa_array_push(_method_registry, hexa_array_push(hexa_array_push(hexa_array_new(), hexa_map_get_ic(m, "name", &__hexa_codegen_c2_ic_546)), type_n));
        HexaVal params = hexa_array_new();
        HexaVal pi = hexa_int(0);
        while (hexa_truthy(hexa_cmp_lt(pi, hexa_int(hexa_len(hexa_map_get_ic(m, "params", &__hexa_codegen_c2_ic_547)))))) {
            params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(m, "params", &__hexa_codegen_c2_ic_548), pi), "name", &__hexa_codegen_c2_ic_549)));
        ...
        HexaVal bi = hexa_int(0);
        while (hexa_truthy(hexa_cmp_lt(bi, hexa_int(hexa_len(hexa_map_get_ic(m, "body", &__hexa_codegen_c2_ic_550)))))) {
            body_chunks = hexa_array_push(body_chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(m, "body", &__hexa_codegen_c2_ic_551), bi), hexa_int(1)));
            bi = hexa_add(bi, hexa_int(1));
        }
...
HexaVal _cf_as_float(HexaVal lit) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(lit, "kind", &__hexa_codegen_c2_ic_552), hexa_str("FloatLit")))) {
        return __hexa_fn_arena_return(hexa_float(__hx_to_double(hexa_map_get_ic(lit, "value", &__hexa_codegen_c2_ic_553))));
    }
    return __hexa_fn_arena_return(hexa_float(__hx_to_double(hexa_to_string(hexa_int((HX_IS_STR(hexa_map_get_ic(lit, "value", &__hexa_codegen_c2_ic_554))?atoll(hexa_to_cstring(hexa_map_get_ic(lit, "value", &__hexa_codegen_c2_ic_554))):(int64_t)__hx_to_double(hexa_map_get_ic(lit, "value", &__hexa_codegen_c2_ic_554))))))));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal comptime_eval(HexaVal node) {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_555);
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        return __hexa_fn_arena_return(_lookup_comptime_const(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_556)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_557);
        HexaVal v = comptime_eval(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_558));
        if (hexa_truthy(hexa_eq(hexa_type_of(v), hexa_str("string")))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        if (hexa_truthy(hexa_eq(op, hexa_str("-")))) {
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(v, "kind", &__hexa_codegen_c2_ic_559), hexa_str("IntLit")))) {
                HexaVal i = hexa_sub(hexa_int(0), hexa_int((HX_IS_STR(hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_560))?atoll(hexa_to_cstring(hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_560))):(int64_t)__hx_to_double(hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_560)))));
                return __hexa_fn_arena_return(_make_int_lit_node(hexa_to_string(i)));
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(v, "kind", &__hexa_codegen_c2_ic_561), hexa_str("FloatLit")))) {
                HexaVal f = hexa_sub(hexa_int(0), hexa_float(__hx_to_double(hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_562))));
                return __hexa_fn_arena_return(_make_float_lit_node(hexa_to_string(f)));
            }
            return __hexa_fn_arena_return(hexa_str(""));
        }
        if (hexa_truthy(hexa_eq(op, hexa_str("!")))) {
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(v, "kind", &__hexa_codegen_c2_ic_563), hexa_str("BoolLit")))) {
                return __hexa_fn_arena_return(_make_bool_lit_node(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_564), hexa_str("true"))))));
            }
            return __hexa_fn_arena_return(hexa_str(""));
        }
        return __hexa_fn_arena_return(hexa_str(""));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
        op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_565);
        if (hexa_truthy(hexa_eq(op, hexa_str("&&")))) {
            ll = comptime_eval(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_566));
            if (hexa_truthy(hexa_eq(hexa_type_of(ll), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(ll, "kind", &__hexa_codegen_c2_ic_567), hexa_str("BoolLit")))))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(ll, "value", &__hexa_codegen_c2_ic_568), hexa_str("true")))))) {
                return __hexa_fn_arena_return(_make_bool_lit_node(hexa_bool(0)));
            }
            rr = comptime_eval(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_569));
            if (hexa_truthy(hexa_eq(hexa_type_of(rr), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(rr, "kind", &__hexa_codegen_c2_ic_570), hexa_str("BoolLit")))))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            return __hexa_fn_arena_return(_make_bool_lit_node(hexa_eq(hexa_map_get_ic(rr, "value", &__hexa_codegen_c2_ic_571), hexa_str("true"))));
        }
        if (hexa_truthy(hexa_eq(op, hexa_str("||")))) {
            ll = comptime_eval(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_572));
            if (hexa_truthy(hexa_eq(hexa_type_of(ll), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(ll, "kind", &__hexa_codegen_c2_ic_573), hexa_str("BoolLit")))))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(ll, "value", &__hexa_codegen_c2_ic_574), hexa_str("true")))) {
                return __hexa_fn_arena_return(_make_bool_lit_node(hexa_bool(1)));
            }
            rr = comptime_eval(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_575));
            if (hexa_truthy(hexa_eq(hexa_type_of(rr), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(rr, "kind", &__hexa_codegen_c2_ic_576), hexa_str("BoolLit")))))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            return __hexa_fn_arena_return(_make_bool_lit_node(hexa_eq(hexa_map_get_ic(rr, "value", &__hexa_codegen_c2_ic_577), hexa_str("true"))));
        }
        HexaVal l = comptime_eval(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_578));
        if (hexa_truthy(hexa_eq(hexa_type_of(l), hexa_str("string")))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        HexaVal r = comptime_eval(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_579));
        if (hexa_truthy(hexa_eq(hexa_type_of(r), hexa_str("string")))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        HexaVal lk = hexa_map_get_ic(l, "kind", &__hexa_codegen_c2_ic_580);
        HexaVal rk = hexa_map_get_ic(r, "kind", &__hexa_codegen_c2_ic_581);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("=="))) || hexa_truthy(hexa_eq(op, hexa_str("!="))))) || hexa_truthy(hexa_eq(op, hexa_str("<"))))) || hexa_truthy(hexa_eq(op, hexa_str(">"))))) || hexa_truthy(hexa_eq(op, hexa_str("<="))))) || hexa_truthy(hexa_eq(op, hexa_str(">=")))))) {
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(lk, hexa_str("StringLit"))) && hexa_truthy(hexa_eq(rk, hexa_str("StringLit")))))) {
                if (hexa_truthy(hexa_eq(op, hexa_str("==")))) {
                    return __hexa_fn_arena_return(_make_bool_lit_node(hexa_eq(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_582), hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_583))));
                }
                if (hexa_truthy(hexa_eq(op, hexa_str("!=")))) {
                    return __hexa_fn_arena_return(_make_bool_lit_node(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_584), hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_585))))));
                }
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(lk, hexa_str("BoolLit"))) && hexa_truthy(hexa_eq(rk, hexa_str("BoolLit")))))) {
                if (hexa_truthy(hexa_eq(op, hexa_str("==")))) {
                    return __hexa_fn_arena_return(_make_bool_lit_node(hexa_eq(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_586), hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_587))));
                }
                if (hexa_truthy(hexa_eq(op, hexa_str("!=")))) {
                    return __hexa_fn_arena_return(_make_bool_lit_node(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_588), hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_589))))));
                }
                return __hexa_fn_arena_return(hexa_str(""));
            }
            ...
            HexaVal li_c = hexa_int((HX_IS_STR(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_590))?atoll(hexa_to_cstring(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_590))):(int64_t)__hx_to_double(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_590))));
            HexaVal ri_c = hexa_int((HX_IS_STR(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_591))?atoll(hexa_to_cstring(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_591))):(int64_t)__hx_to_double(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_591))));
            if (hexa_truthy(hexa_eq(op, hexa_str("==")))) {
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("+"))) && hexa_truthy(hexa_eq(lk, hexa_str("StringLit"))))) && hexa_truthy(hexa_eq(rk, hexa_str("StringLit")))))) {
            return __hexa_fn_arena_return(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("StringLit")), "name", hexa_str("")), "value", hexa_add(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_592), hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_593))), "op", hexa_str("")), "left", hexa_str("")), "right", hexa_str("")), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str("")));
        }
        ...
        HexaVal li = hexa_int((HX_IS_STR(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_594))?atoll(hexa_to_cstring(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_594))):(int64_t)__hx_to_double(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_594))));
        HexaVal ri = hexa_int((HX_IS_STR(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_595))?atoll(hexa_to_cstring(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_595))):(int64_t)__hx_to_double(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_595))));
        if (hexa_truthy(hexa_eq(op, hexa_str("+")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("IfExpr")))) {
        HexaVal c = comptime_eval(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_596));
        if (hexa_truthy(hexa_eq(hexa_type_of(c), hexa_str("string")))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(c, "kind", &__hexa_codegen_c2_ic_597), hexa_str("BoolLit")))))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        HexaVal pick_true = hexa_eq(hexa_map_get_ic(c, "value", &__hexa_codegen_c2_ic_598), hexa_str("true"));
        HexaVal body = (hexa_truthy(pick_true) ? hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_599) : hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_600));
        ...
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(last, "kind", &__hexa_codegen_c2_ic_601), hexa_str("ExprStmt")))))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(last, "left", &__hexa_codegen_c2_ic_602)), hexa_str("string")))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        return __hexa_fn_arena_return(comptime_eval(hexa_map_get_ic(last, "left", &__hexa_codegen_c2_ic_603)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Call")))) {
        HexaVal fname = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_604);
        if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_605)), hexa_str("string")))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        HexaVal nargs = hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_606)));
        if (hexa_truthy(hexa_eq(nargs, hexa_int(1)))) {
            HexaVal a = comptime_eval(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_607), hexa_int(0)));
            if (hexa_truthy(hexa_eq(hexa_type_of(a), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            HexaVal ak = hexa_map_get_ic(a, "kind", &__hexa_codegen_c2_ic_608);
            ...
            if (hexa_truthy(hexa_eq(fname, hexa_str("abs")))) {
                if (hexa_truthy(hexa_eq(ak, hexa_str("IntLit")))) {
                    HexaVal iv = hexa_int((HX_IS_STR(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_609))?atoll(hexa_to_cstring(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_609))):(int64_t)__hx_to_double(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_609))));
                ...
                HexaVal fv = hexa_float(__hx_to_double(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_610)));
            ...
            if (hexa_truthy(hexa_eq(fname, hexa_str("sqrt")))) {
                ...
                if (hexa_truthy(hexa_eq(ak, hexa_str("IntLit")))) {
                    HexaVal iv2 = hexa_int((HX_IS_STR(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_611))?atoll(hexa_to_cstring(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_611))):(int64_t)__hx_to_double(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_611))));
            ...
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(fname, hexa_str("floor"))) || hexa_truthy(hexa_eq(fname, hexa_str("ceil")))))) {
                if (hexa_truthy(hexa_eq(ak, hexa_str("IntLit")))) {
                    return __hexa_fn_arena_return(_make_int_lit_node(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_612)));
                }
                return __hexa_fn_arena_return(hexa_str(""));
            }
            return __hexa_fn_arena_return(hexa_str(""));
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(nargs, hexa_int(2))) && hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(fname, hexa_str("min"))) || hexa_truthy(hexa_eq(fname, hexa_str("max")))))))) {
            HexaVal a1 = comptime_eval(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_613), hexa_int(0)));
            if (hexa_truthy(hexa_eq(hexa_type_of(a1), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            HexaVal a2 = comptime_eval(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_614), hexa_int(1)));
            if (hexa_truthy(hexa_eq(hexa_type_of(a2), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            HexaVal k1 = hexa_map_get_ic(a1, "kind", &__hexa_codegen_c2_ic_615);
            HexaVal k2 = hexa_map_get_ic(a2, "kind", &__hexa_codegen_c2_ic_616);
            ...
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k1, hexa_str("IntLit"))) && hexa_truthy(hexa_eq(k2, hexa_str("IntLit")))))) {
                HexaVal v1 = hexa_int((HX_IS_STR(hexa_map_get_ic(a1, "value", &__hexa_codegen_c2_ic_617))?atoll(hexa_to_cstring(hexa_map_get_ic(a1, "value", &__hexa_codegen_c2_ic_617))):(int64_t)__hx_to_double(hexa_map_get_ic(a1, "value", &__hexa_codegen_c2_ic_617))));
                HexaVal v2 = hexa_int((HX_IS_STR(hexa_map_get_ic(a2, "value", &__hexa_codegen_c2_ic_618))?atoll(hexa_to_cstring(hexa_map_get_ic(a2, "value", &__hexa_codegen_c2_ic_618))):(int64_t)__hx_to_double(hexa_map_get_ic(a2, "value", &__hexa_codegen_c2_ic_618))));
...
HexaVal _known_set_init(void) {
    ...
    return __hexa_fn_arena_return(_known_int_set_init());
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal _is_known_int(HexaVal node) {
    ...
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_619), hexa_str("IntLit")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_620), hexa_str("Ident")))) {
        return __hexa_fn_arena_return(_is_known_int_name(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_621)));
    }
    return __hexa_fn_arena_return(hexa_bool(0));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal _is_int_init_expr(HexaVal node) {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_622);
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        return __hexa_fn_arena_return(_is_known_int_name(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_623)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
        HexaVal op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_624);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("+"))) || hexa_truthy(hexa_eq(op, hexa_str("-"))))) || hexa_truthy(hexa_eq(op, hexa_str("*"))))) || hexa_truthy(hexa_eq(op, hexa_str("/"))))) || hexa_truthy(hexa_eq(op, hexa_str("%")))))) {
            return __hexa_fn_arena_return(hexa_bool(hexa_truthy(_is_int_init_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_625))) && hexa_truthy(_is_int_init_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_626)))));
        }
        return __hexa_fn_arena_return(hexa_bool(0));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_627), hexa_str("-")))) {
            return __hexa_fn_arena_return(_is_int_init_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_628)));
        }
        return __hexa_fn_arena_return(hexa_bool(0));
    }
    return __hexa_fn_arena_return(hexa_bool(0));
...
HexaVal gen2_collect_free(HexaVal node, HexaVal bound, HexaVal out) {
    ...
    if (hexa_truthy(hexa_eq(hexa_type_of(node), hexa_str("array")))) {
        ...
        while (hexa_truthy(hexa_cmp_lt(i, hexa_int(hexa_len(node))))) {
            ...
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(s), hexa_str("string")))))) {
                HexaVal sk = hexa_map_get_ic(s, "kind", &__hexa_codegen_c2_ic_629);
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(sk, hexa_str("LetStmt"))) || hexa_truthy(hexa_eq(sk, hexa_str("LetMutStmt")))))) {
                    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(s, "left", &__hexa_codegen_c2_ic_630)), hexa_str("string")))))) {
                        result = gen2_collect_free(hexa_map_get_ic(s, "left", &__hexa_codegen_c2_ic_631), local, result);
                    }
                    local = hexa_array_push(local, hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_632));
                } else {
                    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(sk, hexa_str("ForStmt"))) || hexa_truthy(hexa_eq(sk, hexa_str("ForInStmt")))))) {
                        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(s, "left", &__hexa_codegen_c2_ic_633)), hexa_str("string")))))) {
                            result = gen2_collect_free(hexa_map_get_ic(s, "left", &__hexa_codegen_c2_ic_634), local, result);
                        }
                        HexaVal body_local = hexa_array_push(local, hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_635));
                        if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(s, "body", &__hexa_codegen_c2_ic_636)), hexa_str("array")))) {
                            result = gen2_collect_free(hexa_map_get_ic(s, "body", &__hexa_codegen_c2_ic_637), body_local, result);
                        }
                    } else {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_638);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_639);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Lambda")))) {
        ...
        HexaVal pi = hexa_int(0);
        while (hexa_truthy(hexa_cmp_lt(pi, hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_640)))))) {
            inner_bound = hexa_array_push(inner_bound, hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_641), pi));
            pi = hexa_add(pi, hexa_int(1));
        }
        return __hexa_fn_arena_return(gen2_collect_free(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_642), inner_bound, out));
    }
    result = out;
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_643)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_644), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_645)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_646), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_647)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_648), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_649)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_650), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_651)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_652), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_653)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_654), bound, result);
    }
    if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_655)), hexa_str("array")))) {
        HexaVal ai = hexa_int(0);
        while (hexa_truthy(hexa_cmp_lt(ai, hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_656)))))) {
            result = gen2_collect_free(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_657), ai), bound, result);
            ai = hexa_add(ai, hexa_int(1));
        }
    }
    if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_658)), hexa_str("array")))) {
        HexaVal ii = hexa_int(0);
        while (hexa_truthy(hexa_cmp_lt(ii, hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_659)))))) {
            result = gen2_collect_free(hexa_index_get(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_660), ii), bound, result);
            ii = hexa_add(ii, hexa_int(1));
        }
    }
    if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_661)), hexa_str("array")))) {
        HexaVal mi = hexa_int(0);
        while (hexa_truthy(hexa_cmp_lt(mi, hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_662)))))) {
            HexaVal arm = hexa_index_get(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_663), mi);
            if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_664)), hexa_str("array")))) {
                result = gen2_collect_free(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_665), bound, result);
            }
            mi = hexa_add(mi, hexa_int(1));
        }
    }
...
HexaVal gen2_lambda_expr(HexaVal node) {
    ...
    HexaVal pi = hexa_int(0);
    while (hexa_truthy(hexa_cmp_lt(pi, hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_666)))))) {
        bound = hexa_array_push(bound, hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_667), pi));
        pi = hexa_add(pi, hexa_int(1));
    }
    HexaVal free_vars = gen2_collect_free(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_668), bound, hexa_array_new());
    HexaVal arity = hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_669)));
    HexaVal params = hexa_array_new();
    params = hexa_array_push(params, hexa_str("HexaVal __env"));
    pi = hexa_int(0);
    while (hexa_truthy(hexa_cmp_lt(pi, hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_670)))))) {
        params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_671), pi)));
        pi = hexa_add(pi, hexa_int(1));
    }
    HexaVal p = hexa_str_join(params, hexa_str(", "));
    if (hexa_truthy(hexa_eq(p, hexa_str("")))) {
    ...
    HexaVal lbody = hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_672);
...
HexaVal codegen_c2_full(HexaVal ast) {
    ...
    while (hexa_truthy(hexa_cmp_lt(gi, hexa_int(hexa_len(ast))))) {
        HexaVal gk = hexa_map_get_ic(hexa_index_get(ast, gi), "kind", &__hexa_codegen_c2_ic_673);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(gk, hexa_str("FnDecl"))) || hexa_truthy(hexa_eq(gk, hexa_str("ExternFnDecl"))))) || hexa_truthy(hexa_eq(gk, hexa_str("PureFnDecl"))))) || hexa_truthy(hexa_eq(gk, hexa_str("OptimizeFnStmt")))))) {
            _known_fn_globals = hexa_array_push(_known_fn_globals, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_674));
            _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_675));
            _known_fn_globals_add(hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_676));
            _known_nonlocal_add(hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_677));
        } else {
            if (hexa_truthy(hexa_eq(gk, hexa_str("StructDecl")))) {
                _known_fn_globals = hexa_array_push(_known_fn_globals, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_678));
                ...
                _known_fn_globals_add(hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_680));
                _known_nonlocal_add(hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_681));
            } else {
                if (hexa_truthy(hexa_eq(gk, hexa_str("EnumDecl")))) {
                    _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_682));
                    _known_nonlocal_add(hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_683));
                } else {
                    if (hexa_truthy(hexa_eq(gk, hexa_str("ComptimeConst")))) {
                        _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_684));
                        _known_nonlocal_add(hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_685));
                    } else {
                        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(gk, hexa_str("LetMutStmt"))) || hexa_truthy(hexa_eq(gk, hexa_str("LetStmt")))))) {
                            _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_686));
                            _known_nonlocal_add(hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_687));
                        }
                    }
                }
            }
    ...
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_cmp_lt(i, hexa_int(hexa_len(ast))))) {
        HexaVal k = hexa_map_get_ic(hexa_index_get(ast, i), "kind", &__hexa_codegen_c2_ic_688);
        if (hexa_truthy(hexa_eq(k, hexa_str("FnDecl")))) {
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_689), hexa_str("main")))) {
                has_user_main = hexa_bool(1);
            }
            fwd_parts = hexa_array_push(fwd_parts, hexa_add(gen2_fn_forward(hexa_index_get(ast, i)), hexa_str("\n")));
            fn_parts = hexa_array_push(fn_parts, hexa_add(gen2_fn_decl(hexa_index_get(ast, i)), hexa_str("\n\n")));
            ...
            if (hexa_truthy(hexa_eq(k, hexa_str("ExternFnDecl")))) {
                HexaVal ew = gen2_extern_wrapper(hexa_index_get(ast, i));
                global_parts = hexa_array_push(global_parts, hexa_map_get_ic(ew, "global", &__hexa_codegen_c2_ic_690));
                fwd_parts = hexa_array_push(fwd_parts, hexa_add(hexa_map_get_ic(ew, "forward", &__hexa_codegen_c2_ic_691), hexa_str("\n")));
                fn_parts = hexa_array_push(fn_parts, hexa_add(hexa_map_get_ic(ew, "fn_code", &__hexa_codegen_c2_ic_692), hexa_str("\n\n")));
                main_parts = hexa_array_push(main_parts, hexa_map_get_ic(ew, "init", &__hexa_codegen_c2_ic_693));
            } else {
                if (hexa_truthy(hexa_eq(k, hexa_str("StructDecl")))) {
                    fwd_parts = hexa_array_push(fwd_parts, hexa_add(gen2_struct_forward(hexa_index_get(ast, i)), hexa_str("\n")));
                    fn_parts = hexa_array_push(fn_parts, hexa_add(gen2_struct_decl(hexa_index_get(ast, i)), hexa_str("\n\n")));
                    ...
                    if (hexa_truthy(hexa_eq(k, hexa_str("EnumDecl")))) {
                        ...
                        if (hexa_truthy(hexa_eq(k, hexa_str("ImplBlock")))) {
                            HexaVal ib = gen2_impl_block(hexa_index_get(ast, i));
                            fwd_parts = hexa_array_push(fwd_parts, hexa_map_get_ic(ib, "forward", &__hexa_codegen_c2_ic_694));
                            fn_parts = hexa_array_push(fn_parts, hexa_map_get_ic(ib, "fn_code", &__hexa_codegen_c2_ic_695));
                        } else {
                            if (hexa_truthy(hexa_eq(k, hexa_str("PureFnDecl")))) {
                                fwd_parts = hexa_array_push(fwd_parts, hexa_add(gen2_fn_forward(hexa_index_get(ast, i)), hexa_str("\n")));
                                fn_parts = hexa_array_push(fn_parts, hexa_add(gen2_fn_decl(hexa_index_get(ast, i)), hexa_str("\n\n")));
                                ...
                                if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeConst")))) {
                                    HexaVal _cc_folded2 = comptime_eval(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_696));
                                    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(_cc_folded2), hexa_str("string")))))) {
                                        _register_comptime_const(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_697), _cc_folded2);
                                    } else {
                                        global_parts = hexa_array_push(global_parts, hexa_add(hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_698)), hexa_str(";\n")));
                                        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_699)), hexa_str("string")))))) {
                                            main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_700)), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_701))), hexa_str(";\n")));
                                        } else {
                                            main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_str("    "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_702)), hexa_str(" = hexa_void();\n")));
                                        }
                                    }
                                } else {
                                    if (hexa_truthy(hexa_eq(k, hexa_str("OptimizeFnStmt")))) {
                                        ...
                                        if (hexa_truthy(hexa_eq(k, hexa_str("TraitDecl")))) {
                                            ...
                                            if (hexa_truthy(hexa_eq(k, hexa_str("InvariantDecl")))) {
                                                ...
                                                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("ImportStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("UseStmt")))))) {
                                                    (hexa_eprint_val(hexa_add(hexa_str("[codegen_c2] WARNING: import/use not fully resolved: "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_703))), fprintf(stderr, "\n"), hexa_void());
                                                    main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_str("    /* import: "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_704)), hexa_str(" */\n")));
                                                } else {
                                                    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("LetStmt")))))) {
                                                        HexaVal _user_name2 = _hexa_mangle_ident(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_705));
                                                        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetStmt"))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_706)), hexa_str("string")))))))) {
                                                            if (hexa_truthy(_is_int_init_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_707)))) {
                                                                _known_int_add(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_708));
                                                            }
                                                        }
                                                        HexaVal _tls_val2 = hexa_map_get_ic(hexa_index_get(ast, i), "value", &__hexa_codegen_c2_ic_709);
                                                        ...
                                                        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_710)), hexa_str("string")))))) {
                                                            main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    "), _user_name2), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_711))), hexa_str(";\n")));
                                                        } else {
...
HexaVal _hxi_params_str(HexaVal params) {
    ...
    while (hexa_truthy(hexa_cmp_lt(i, hexa_int(hexa_len(params))))) {
        ...
        HexaVal vt = hexa_to_string(hexa_map_get_ic(p, "value", &__hexa_codegen_c2_ic_712));
        HexaVal t = (hexa_truthy(hexa_eq(vt, hexa_str(""))) ? hexa_str("_") : vt);
        parts = hexa_array_push(parts, hexa_add(hexa_add(hexa_to_string(hexa_map_get_ic(p, "name", &__hexa_codegen_c2_ic_713)), hexa_str(":")), t));
        i = hexa_add(i, hexa_int(1));
    }
    return __hexa_fn_arena_return(hexa_str_join(parts, hexa_str(",")));
    return __hexa_fn_arena_return(hexa_void());
...
HexaVal _hxi_fn_line(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal ret = hexa_to_string(hexa_map_get_ic(node, "ret_type", &__hexa_codegen_c2_ic_714));
    HexaVal ret_s = (hexa_truthy(hexa_eq(ret, hexa_str(""))) ? hexa_str("void") : ret);
    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("fn "), hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_715))), hexa_str("(")), _hxi_params_str(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_716))), hexa_str(")->")), ret_s));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal _hxi_struct_line(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal fields = hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_717);
    if (hexa_truthy(hexa_eq(hexa_type_of(fields), hexa_str("string")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("struct "), hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_718))), hexa_str("()")));
    }
    HexaVal parts = hexa_array_new();
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_cmp_lt(i, hexa_int(hexa_len(fields))))) {
        HexaVal f = hexa_index_get(fields, i);
        HexaVal vt = hexa_to_string(hexa_map_get_ic(f, "value", &__hexa_codegen_c2_ic_719));
        HexaVal t = (hexa_truthy(hexa_eq(vt, hexa_str(""))) ? hexa_str("_") : vt);
        parts = hexa_array_push(parts, hexa_add(hexa_add(hexa_to_string(hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_720)), hexa_str(":")), t));
        i = hexa_add(i, hexa_int(1));
    }
    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("struct "), hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_721))), hexa_str("(")), hexa_str_join(parts, hexa_str(","))), hexa_str(")")));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal _hxi_extern_line(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal ret = hexa_to_string(hexa_map_get_ic(node, "ret_type", &__hexa_codegen_c2_ic_722));
    HexaVal ret_s = (hexa_truthy(hexa_eq(ret, hexa_str(""))) ? hexa_str("void") : ret);
    HexaVal sym = hexa_to_string(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_723));
    HexaVal link = hexa_to_string(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_724));
    HexaVal line = hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("extern "), hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_725))), hexa_str("(")), _hxi_params_str(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_726))), hexa_str(")->")), ret_s);
...
HexaVal _hxi_let_line(HexaVal node, HexaVal mutable) {
    ...
    return __hexa_fn_arena_return(hexa_add(hexa_add(prefix, hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_727))), hexa_str(":_")));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal emit_hxi(HexaVal ast, HexaVal src_bytes) {
    ...
    while (hexa_truthy(hexa_cmp_lt(i, hexa_int(hexa_len(ast))))) {
        ...
        HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_728);
        if (hexa_truthy(hexa_eq(k, hexa_str("FnDecl")))) {
            ...
            if (hexa_truthy(hexa_eq(k, hexa_str("PureFnDecl")))) {
                ...
                if (hexa_truthy(hexa_eq(k, hexa_str("AsyncFnDecl")))) {
                    ...
                    if (hexa_truthy(hexa_eq(k, hexa_str("StructDecl")))) {
                        ...
                        if (hexa_truthy(hexa_eq(k, hexa_str("EnumDecl")))) {
                            lines = hexa_array_push(lines, hexa_add(hexa_str("enum "), hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_729))));
                        } else {
                            if (hexa_truthy(hexa_eq(k, hexa_str("ExternFnDecl")))) {
                                ...
                                if (hexa_truthy(hexa_eq(k, hexa_str("LetStmt")))) {
                                    ...
                                    if (hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt")))) {
                                        ...
                                        if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeConst")))) {
                                            lines = hexa_array_push(lines, hexa_add(hexa_str("comptime "), hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_730))));
                                        }
                                    }
                                }
                            }
