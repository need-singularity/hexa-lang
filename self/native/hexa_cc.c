...
static HexaIC __hexa_parser_ic_337 = {0};
static HexaIC __hexa_parser_ic_338 = {0};
static HexaIC __hexa_parser_ic_339 = {0};
static HexaIC __hexa_parser_ic_340 = {0};
static HexaIC __hexa_parser_ic_341 = {0};
    ...
    while ((!hexa_truthy(p_at_end()))) {
        ...
        HexaVal parse_ok = hexa_bool(1);
        {
            ...
            if (setjmp(__jb) == 0) {
                ...
                hexa_array_push(stmts, parse_stmt());
            } else {
...
HexaVal parse_stmt(void) {
    ...
    while (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("At")))) {
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(attr_name, hexa_str("contract"))) && hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("LParen")))))) {
            ...
            while (((!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RParen")))) && (!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))) {
                ...
                HexaVal src_parts = hexa_array_new();
                HexaVal _si = expr_start;
                while (HX_BOOL(hexa_cmp_lt(_si, p_pos))) {
                    src_parts = hexa_array_push(src_parts, hexa_map_get_ic(hexa_index_get(p_tokens, _si), "value", &__hexa_parser_ic_49));
                    _si = hexa_add(_si, hexa_int(1));
                }
                HexaVal src_text = hexa_str_join(src_parts, hexa_str(" "));
            ...
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(attr_name, hexa_str("symbol"))) || hexa_truthy(hexa_eq(attr_name, hexa_str("link")))))) {
                ...
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(attr_name, hexa_str("select"))) && hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("LParen")))))) {
                    p_advance();
                    HexaVal family = hexa_str("");
                    HexaVal pk_fam = p_peek_kind();
                    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(pk_fam, hexa_str("StringLit"))) || hexa_truthy(hexa_eq(pk_fam, hexa_str("CharLit")))))) {
                        fam_tok = p_advance();
                        family = hexa_map_get_ic(fam_tok, "value", &__hexa_parser_ic_51);
                    } else {
                        if (hexa_truthy(hexa_eq(pk_fam, hexa_str("Ident")))) {
                            fam_tok = p_advance();
                            family = hexa_map_get_ic(fam_tok, "value", &__hexa_parser_ic_52);
                        }
                    }
                    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Comma")))) {
                        p_advance();
                    }
                    HexaVal arms_parts = hexa_array_new();
                    while (((!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RParen")))) && (!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))) {
                        HexaVal cond_parts = hexa_array_new();
                        HexaVal is_else = hexa_bool(0);
                        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Else")))) {
                            p_advance();
                            is_else = hexa_bool(1);
                        }
                        if (hexa_truthy(hexa_bool(!hexa_truthy(is_else)))) {
                            HexaVal cdepth = hexa_int(0);
                            while ((!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof"))))) {
                                HexaVal pk3 = p_peek_kind();
                                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(cdepth, hexa_int(0))) && hexa_truthy(hexa_eq(pk3, hexa_str("Arrow")))))) {
                                    break;
                                }
                                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(cdepth, hexa_int(0))) && hexa_truthy(hexa_eq(pk3, hexa_str("Comma")))))) {
                                    break;
                                }
                                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(cdepth, hexa_int(0))) && hexa_truthy(hexa_eq(pk3, hexa_str("RParen")))))) {
                                    break;
                                }
                                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(pk3, hexa_str("LParen"))) || hexa_truthy(hexa_eq(pk3, hexa_str("LBracket"))))) || hexa_truthy(hexa_eq(pk3, hexa_str("LBrace")))))) {
                                    cdepth = hexa_add(cdepth, hexa_int(1));
                                } else {
                                    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(pk3, hexa_str("RParen"))) || hexa_truthy(hexa_eq(pk3, hexa_str("RBracket"))))) || hexa_truthy(hexa_eq(pk3, hexa_str("RBrace")))))) {
                                        cdepth = hexa_sub(cdepth, hexa_int(1));
                                    }
                                }
                                HexaVal ct = p_advance();
                                if (hexa_truthy(hexa_eq(pk3, hexa_str("StringLit")))) {
                                    cond_parts = hexa_array_push(cond_parts, hexa_add(hexa_add(hexa_str("\""), hexa_map_get_ic(ct, "value", &__hexa_parser_ic_53)), hexa_str("\"")));
                                } else {
                                    cond_parts = hexa_array_push(cond_parts, hexa_map_get_ic(ct, "value", &__hexa_parser_ic_54));
                                }
                            }
                        }
                        ...
                        HexaVal algo_name = hexa_str("");
                        HexaVal pk_alg = p_peek_kind();
                        if (hexa_truthy(hexa_eq(pk_alg, hexa_str("Ident")))) {
                            algo_name = p_expect_ident();
                        } else {
                            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(pk_alg, hexa_str("Comma"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(pk_alg, hexa_str("RParen"))))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(pk_alg, hexa_str("Eof")))))))) {
                                HexaVal alg_tok = p_advance();
                                algo_name = hexa_map_get_ic(alg_tok, "value", &__hexa_parser_ic_55);
                            }
                        }
                        HexaVal arm_str = hexa_str("");
                        if (hexa_truthy(is_else)) {
                            arm_str = hexa_add(hexa_str("else~>"), algo_name);
                        } else {
                            arm_str = hexa_add(hexa_add(hexa_str_join(cond_parts, hexa_str(" ")), hexa_str("~>")), algo_name);
                        }
                        arms_parts = hexa_array_push(arms_parts, arm_str);
                        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Comma")))) {
                            p_advance();
                        }
                    }
                    p_expect(hexa_str("RParen"));
                    HexaVal arms_joined = hexa_str_join(arms_parts, hexa_str("@@"));
                    HexaVal serialized = hexa_add(hexa_add(hexa_add(hexa_str("select|"), family), hexa_str("@@")), arms_joined);
                    p_pending_annotations = hexa_array_push(p_pending_annotations, serialized);
                } else {
                    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(attr_name, hexa_str("cli"))) || hexa_truthy(hexa_eq(attr_name, hexa_str("flag"))))) || hexa_truthy(hexa_eq(attr_name, hexa_str("doc"))))) || hexa_truthy(hexa_eq(attr_name, hexa_str("schema"))))) || hexa_truthy(hexa_eq(attr_name, hexa_str("gate"))))) || hexa_truthy(hexa_eq(attr_name, hexa_str("memo")))))) {
                        HexaVal raw_parts = hexa_array_new();
                        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("LParen")))) {
                            p_advance();
                            HexaVal depth = hexa_int(1);
                            while ((HX_BOOL(hexa_cmp_gt(depth, hexa_int(0))) && (!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))) {
                                ...
                                if (hexa_truthy(hexa_eq(pk2, hexa_str("LParen")))) {
                                    depth = hexa_add(depth, hexa_int(1));
                                    t = p_advance();
                                    raw_parts = hexa_array_push(raw_parts, hexa_map_get_ic(t, "value", &__hexa_parser_ic_56));
                                } else {
                                    if (hexa_truthy(hexa_eq(pk2, hexa_str("RParen")))) {
                                        ...
                                        if (hexa_truthy(hexa_eq(depth, hexa_int(0)))) {
                                            ...
                                            t = p_advance();
                                            raw_parts = hexa_array_push(raw_parts, hexa_map_get_ic(t, "value", &__hexa_parser_ic_57));
                                        }
                                    } else {
                                        t = p_advance();
                                        if (hexa_truthy(hexa_eq(pk2, hexa_str("StringLit")))) {
                                            raw_parts = hexa_array_push(raw_parts, hexa_add(hexa_add(hexa_str("\""), hexa_map_get_ic(t, "value", &__hexa_parser_ic_58)), hexa_str("\"")));
                                        } else {
                                            raw_parts = hexa_array_push(raw_parts, hexa_map_get_ic(t, "value", &__hexa_parser_ic_59));
                                        }
                                    }
                                }
                            }
                        }
                        HexaVal raw = hexa_str_join(raw_parts, hexa_str(" "));
    ...
    if (hexa_truthy(hexa_eq(kind, hexa_str("Ident")))) {
        tok = p_peek();
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(tok, "value", &__hexa_parser_ic_60), hexa_str("import")))) {
            p_advance();
            HexaVal path = hexa_str("");
            if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
                HexaVal str_tok = p_advance();
                path = hexa_map_get_ic(str_tok, "value", &__hexa_parser_ic_61);
            }
...
HexaVal parse_invariant_decl(void) {
    ...
    while (((!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RBrace")))) && (!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))) {
        ...
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(key_tok, "kind", &__hexa_parser_ic_62), hexa_str("Ident")))) {
            p_advance();
            key_name = hexa_map_get_ic(key_tok, "value", &__hexa_parser_ic_63);
        } else {
            p_advance();
            key_name = hexa_map_get_ic(key_tok, "value", &__hexa_parser_ic_64);
        }
        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Colon")))) {
            p_advance();
        }
        ...
        if (hexa_truthy(hexa_eq(vk, hexa_str("StringLit")))) {
            ...
            if (hexa_truthy(hexa_eq(key_name, hexa_str("id")))) {
                id_str = hexa_map_get_ic(vt, "value", &__hexa_parser_ic_65);
            } else {
                if (hexa_truthy(hexa_eq(key_name, hexa_str("name")))) {
                    name_str = hexa_map_get_ic(vt, "value", &__hexa_parser_ic_66);
                } else {
                    if (hexa_truthy(hexa_eq(key_name, hexa_str("predicate")))) {
                        pred_str = hexa_map_get_ic(vt, "value", &__hexa_parser_ic_67);
                    } else {
                        if (hexa_truthy(hexa_eq(key_name, hexa_str("target")))) {
                            tgt_str = hexa_map_get_ic(vt, "value", &__hexa_parser_ic_68);
                        } else {
                            if (hexa_truthy(hexa_eq(key_name, hexa_str("context")))) {
                                ctx_str = hexa_map_get_ic(vt, "value", &__hexa_parser_ic_69);
                            }
                        }
                    }
                }
            ...
            if (hexa_truthy(hexa_eq(vk, hexa_str("LBrace")))) {
                ...
                while (((!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RBrace")))) && (!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))) {
                    ...
                    HexaVal nk = hexa_str("");
                    if (hexa_truthy(hexa_eq(hexa_map_get_ic(nk_tok, "kind", &__hexa_parser_ic_70), hexa_str("Ident")))) {
                        p_advance();
                        nk = hexa_map_get_ic(nk_tok, "value", &__hexa_parser_ic_71);
                    } else {
                        p_advance();
                        nk = hexa_map_get_ic(nk_tok, "value", &__hexa_parser_ic_72);
                    }
                    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Colon")))) {
                        p_advance();
                    }
                    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
                        ...
                        if (hexa_truthy(hexa_eq(key_name, hexa_str("pattern")))) {
                            if (hexa_truthy(hexa_eq(nk, hexa_str("target")))) {
                                tgt_str = hexa_map_get_ic(nv, "value", &__hexa_parser_ic_73);
                            } else {
                                if (hexa_truthy(hexa_eq(nk, hexa_str("context")))) {
                                    ctx_str = hexa_map_get_ic(nv, "value", &__hexa_parser_ic_74);
                                }
                            }
                        }
                    } else {
                    ...
                    while (((!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RBracket")))) && (!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))) {
                        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
                            ...
                            if (hexa_truthy(hexa_eq(key_name, hexa_str("exempt")))) {
                                exempt_list = hexa_array_push(exempt_list, hexa_map_get_ic(et, "value", &__hexa_parser_ic_75));
                            }
                        } else {
                            p_advance();
                        }
        ...
        for (int __fi = 0; __fi < __iter_len; __fi++) {
            ...
            if (hexa_truthy(hexa_eq(hexa_type_of(stmt), hexa_str("string")))) {
                ...
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(stmt, "kind", &__hexa_parser_ic_78), hexa_str("ReturnStmt"))) || hexa_truthy(hexa_eq(hexa_map_get_ic(stmt, "kind", &__hexa_parser_ic_79), hexa_str("Return")))))) {
                    ...
                    hexa_array_push(out, let_node);
                    hexa_array_push(out, assert_node);
                    hexa_array_push(out, ret_node);
                } else {
                    if (hexa_truthy(hexa_eq(hexa_map_get_ic(stmt, "kind", &__hexa_parser_ic_81), hexa_str("IfStmt")))) {
                        HexaVal wrapped = stmt;
                        if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(stmt, "then_body", &__hexa_parser_ic_82)), hexa_str("array")))) {
                            wrapped = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("IfStmt")), "name", hexa_map_get_ic(stmt, "name", &__hexa_parser_ic_83)), "value", hexa_map_get_ic(stmt, "value", &__hexa_parser_ic_84)), "op", hexa_map_get_ic(stmt, "op", &__hexa_parser_ic_85)), "left", hexa_map_get_ic(stmt, "left", &__hexa_parser_ic_86)), "right", hexa_map_get_ic(stmt, "right", &__hexa_parser_ic_87)), "cond", hexa_map_get_ic(stmt, "cond", &__hexa_parser_ic_88)), "then_body", contract_wrap_returns(hexa_map_get_ic(stmt, "then_body", &__hexa_parser_ic_89), ens_expr, fn_name, ens_text)), "else_body", hexa_map_get_ic(stmt, "else_body", &__hexa_parser_ic_90)), "params", hexa_map_get_ic(stmt, "params", &__hexa_parser_ic_91)), "body", hexa_map_get_ic(stmt, "body", &__hexa_parser_ic_92)), "args", hexa_map_get_ic(stmt, "args", &__hexa_parser_ic_93)), "fields", hexa_map_get_ic(stmt, "fields", &__hexa_parser_ic_94)), "items", hexa_map_get_ic(stmt, "items", &__hexa_parser_ic_95)), "variants", hexa_map_get_ic(stmt, "variants", &__hexa_parser_ic_96)), "arms", hexa_map_get_ic(stmt, "arms", &__hexa_parser_ic_97)), "iter_expr", hexa_map_get_ic(stmt, "iter_expr", &__hexa_parser_ic_98)), "ret_type", hexa_map_get_ic(stmt, "ret_type", &__hexa_parser_ic_99)), "target", hexa_map_get_ic(stmt, "target", &__hexa_parser_ic_100)), "trait_name", hexa_map_get_ic(stmt, "trait_name", &__hexa_parser_ic_101)), "methods", hexa_map_get_ic(stmt, "methods", &__hexa_parser_ic_102));
                        }
                        if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(wrapped, "else_body", &__hexa_parser_ic_103)), hexa_str("array")))) {
                            wrapped = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("IfStmt")), "name", hexa_map_get_ic(wrapped, "name", &__hexa_parser_ic_104)), "value", hexa_map_get_ic(wrapped, "value", &__hexa_parser_ic_105)), "op", hexa_map_get_ic(wrapped, "op", &__hexa_parser_ic_106)), "left", hexa_map_get_ic(wrapped, "left", &__hexa_parser_ic_107)), "right", hexa_map_get_ic(wrapped, "right", &__hexa_parser_ic_108)), "cond", hexa_map_get_ic(wrapped, "cond", &__hexa_parser_ic_109)), "then_body", hexa_map_get_ic(wrapped, "then_body", &__hexa_parser_ic_110)), "else_body", contract_wrap_returns(hexa_map_get_ic(wrapped, "else_body", &__hexa_parser_ic_111), ens_expr, fn_name, ens_text)), "params", hexa_map_get_ic(wrapped, "params", &__hexa_parser_ic_112)), "body", hexa_map_get_ic(wrapped, "body", &__hexa_parser_ic_113)), "args", hexa_map_get_ic(wrapped, "args", &__hexa_parser_ic_114)), "fields", hexa_map_get_ic(wrapped, "fields", &__hexa_parser_ic_115)), "items", hexa_map_get_ic(wrapped, "items", &__hexa_parser_ic_116)), "variants", hexa_map_get_ic(wrapped, "variants", &__hexa_parser_ic_117)), "arms", hexa_map_get_ic(wrapped, "arms", &__hexa_parser_ic_118)), "iter_expr", hexa_map_get_ic(wrapped, "iter_expr", &__hexa_parser_ic_119)), "ret_type", hexa_map_get_ic(wrapped, "ret_type", &__hexa_parser_ic_120)), "target", hexa_map_get_ic(wrapped, "target", &__hexa_parser_ic_121)), "trait_name", hexa_map_get_ic(wrapped, "trait_name", &__hexa_parser_ic_122)), "methods", hexa_map_get_ic(wrapped, "methods", &__hexa_parser_ic_123));
                        }
                        hexa_array_push(out, wrapped);
                    } else {
                        hexa_array_push(out, stmt);
                    }
                }
...
HexaVal parse_for_stmt(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("LParen")))) {
        ...
        p_expect(hexa_str("RParen"));
        in_tok = p_advance();
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(in_tok, "value", &__hexa_parser_ic_124), hexa_str("in")))))) {
            for_msg = hexa_format_n(hexa_str("expected 'in' after for destructure pattern, got '{}'"), hexa_array_push(hexa_array_new(), hexa_map_get_ic(in_tok, "value", &__hexa_parser_ic_125)));
            p_record_error(hexa_map_get_ic(in_tok, "line", &__hexa_parser_ic_126), hexa_map_get_ic(in_tok, "col", &__hexa_parser_ic_127), for_msg);
    ...
    in_tok = p_advance();
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(in_tok, "value", &__hexa_parser_ic_128), hexa_str("in")))))) {
        for_msg = hexa_format_n(hexa_str("expected 'in' after for variable, got '{}'"), hexa_array_push(hexa_array_new(), hexa_map_get_ic(in_tok, "value", &__hexa_parser_ic_129)));
        p_record_error(hexa_map_get_ic(in_tok, "line", &__hexa_parser_ic_130), hexa_map_get_ic(in_tok, "col", &__hexa_parser_ic_131), for_msg);
        hexa_println(hexa_add(hexa_str("Parse error: "), for_msg));
    }
    prev_supp = p_suppress_struct_lit;
    p_suppress_struct_lit = hexa_bool(1);
...
HexaVal parse_match_pattern(void) {
    ...
    __hexa_fn_arena_enter();
    HexaVal tok = p_peek();
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(tok, "kind", &__hexa_parser_ic_132), hexa_str("Ident"))) && hexa_truthy(hexa_eq(hexa_map_get_ic(tok, "value", &__hexa_parser_ic_133), hexa_str("_")))))) {
        p_advance();
        return __hexa_fn_arena_return(node_wildcard());
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(tok, "kind", &__hexa_parser_ic_134), hexa_str("Ident"))) && hexa_truthy(hexa_eq(hexa_map_get_ic(p_peek_ahead(hexa_int(1)), "kind", &__hexa_parser_ic_135), hexa_str("ColonColon")))))) {
        HexaVal ename = hexa_map_get_ic(tok, "value", &__hexa_parser_ic_136);
        p_advance();
        p_advance();
        HexaVal vname = p_expect_ident();
    ...
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(tok, "kind", &__hexa_parser_ic_137), hexa_str("LBracket")))) {
        p_advance();
...
HexaVal parse_expr(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("ColonEq")))) {
        ...
        return __hexa_fn_arena_return(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("WalrusExpr")), "name", hexa_map_get_ic(left, "name", &__hexa_parser_ic_138)), "value", hexa_str("")), "op", hexa_str(":=")), "left", left), "right", right), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str("")));
    }
...
HexaVal parse_null_coal(void) {
    ...
    while ((hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("NullCoal"))) || hexa_truthy(p_continue_bin_op(hexa_array_push(hexa_array_new(), hexa_str("NullCoal")))))) {
        ...
        left = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("BinOp")), "name", hexa_str("")), "value", hexa_str("")), "op", hexa_map_get_ic(op_tok, "value", &__hexa_parser_ic_140)), "left", left), "right", right), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
    }
    return __hexa_fn_arena_return(left);
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal parse_comparison(void) {
    ...
    left = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("BinOp")), "name", hexa_str("")), "value", hexa_str("")), "op", hexa_map_get_ic(op_tok, "value", &__hexa_parser_ic_144)), "left", left), "right", right), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
    while (hexa_truthy(is_comparison_op(p_peek_kind()))) {
        HexaVal op2_tok = p_advance();
        p_skip_newlines();
        HexaVal middle = right;
        HexaVal next = parse_bitwise();
        HexaVal right_cmp = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("BinOp")), "name", hexa_str("")), "value", hexa_str("")), "op", hexa_map_get_ic(op2_tok, "value", &__hexa_parser_ic_145)), "left", middle), "right", next), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
...
HexaVal parse_bitwise(void) {
    ...
    while (((((((((hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("EqEq"))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("NotEq")))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Lt")))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Gt")))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("LtEq")))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("GtEq")))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("In")))) || (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Ident"))) && hexa_truthy(hexa_eq(hexa_map_get_ic(p_peek(), "value", &__hexa_parser_ic_146), hexa_str("is"))))) || hexa_truthy(p_continue_bin_op(hexa_array_push(hexa_array_push(hexa_array_push(hexa_array_push(hexa_array_push(hexa_array_push(hexa_array_new(), hexa_str("EqEq")), hexa_str("NotEq")), hexa_str("Lt")), hexa_str("Gt")), hexa_str("LtEq")), hexa_str("GtEq")))))) {
        HexaVal op_tok = p_advance();
        p_skip_newlines();
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(op_tok, "value", &__hexa_parser_ic_147), hexa_str("is")))) {
            HexaVal type_tok = p_advance();
            right = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("Ident")), "name", hexa_map_get_ic(type_tok, "value", &__hexa_parser_ic_148)), "value", hexa_map_get_ic(type_tok, "value", &__hexa_parser_ic_149)), "op", hexa_str("")), "left", hexa_str("")), "right", hexa_str("")), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
...
HexaVal parse_addition(void) {
    ...
    while (((hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Plus"))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Minus")))) || hexa_truthy(p_continue_bin_op(hexa_array_push(hexa_array_new(), hexa_str("Plus")))))) {
        ...
        left = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("BinOp")), "name", hexa_str("")), "value", hexa_str("")), "op", hexa_map_get_ic(op_tok, "value", &__hexa_parser_ic_151)), "left", left), "right", right), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
    }
    return __hexa_fn_arena_return(left);
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal parse_multiplication(void) {
    ...
    while (((((hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Star"))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Slash")))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Percent")))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Power")))) || hexa_truthy(p_continue_bin_op(hexa_array_push(hexa_array_push(hexa_array_push(hexa_array_push(hexa_array_new(), hexa_str("Star")), hexa_str("Slash")), hexa_str("Percent")), hexa_str("Power")))))) {
        ...
        left = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("BinOp")), "name", hexa_str("")), "value", hexa_str("")), "op", hexa_map_get_ic(op_tok, "value", &__hexa_parser_ic_152)), "left", left), "right", right), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
    }
    return __hexa_fn_arena_return(left);
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal parse_primary(void) {
    ...
    __hexa_fn_arena_enter();
    HexaVal tok = p_peek();
    HexaVal k = hexa_map_get_ic(tok, "kind", &__hexa_parser_ic_154);
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        p_advance();
        return __hexa_fn_arena_return(node_int_lit(hexa_map_get_ic(tok, "value", &__hexa_parser_ic_155)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
        p_advance();
        return __hexa_fn_arena_return(node_float_lit(hexa_map_get_ic(tok, "value", &__hexa_parser_ic_156)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BoolLit")))) {
        p_advance();
        return __hexa_fn_arena_return(node_bool_lit(hexa_map_get_ic(tok, "value", &__hexa_parser_ic_157)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StringLit")))) {
        p_advance();
        return __hexa_fn_arena_return(node_string_lit(hexa_map_get_ic(tok, "value", &__hexa_parser_ic_158)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("CharLit")))) {
        p_advance();
        return __hexa_fn_arena_return(node_char_lit(hexa_map_get_ic(tok, "value", &__hexa_parser_ic_159)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        p_advance();
        HexaVal name = hexa_map_get_ic(tok, "value", &__hexa_parser_ic_160);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("LBracket")))) {
        ...
        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("For")))) {
            ...
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(in_tok, "value", &__hexa_parser_ic_161), hexa_str("in")))))) {
                HexaVal comp_msg = hexa_format_n(hexa_str("expected 'in' after comprehension variable, got '{}'"), hexa_array_push(hexa_array_new(), hexa_map_get_ic(in_tok, "value", &__hexa_parser_ic_162)));
                p_record_error(hexa_map_get_ic(in_tok, "line", &__hexa_parser_ic_163), hexa_map_get_ic(in_tok, "col", &__hexa_parser_ic_164), comp_msg);
    ...
    HexaVal msg3 = hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("unexpected token "), hexa_map_get_ic(tok, "kind", &__hexa_parser_ic_165)), hexa_str(" ('")), hexa_map_get_ic(tok, "value", &__hexa_parser_ic_166)), hexa_str("')"));
    p_record_error(hexa_map_get_ic(tok, "line", &__hexa_parser_ic_167), hexa_map_get_ic(tok, "col", &__hexa_parser_ic_168), msg3);
...
HexaVal parse_attribute_prefix(void) {
    ...
    HexaVal attr_name = hexa_map_get_ic(attr, "value", &__hexa_parser_ic_169);
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(attr_name, hexa_str("symbol"))) || hexa_truthy(hexa_eq(attr_name, hexa_str("link")))))) {
        p_expect(hexa_str("LParen"));
        HexaVal tok = p_advance();
        HexaVal val = hexa_map_get_ic(tok, "value", &__hexa_parser_ic_170);
        p_expect(hexa_str("RParen"));
        if (hexa_truthy(hexa_eq(attr_name, hexa_str("symbol")))) {
...
HexaVal parse_break_stmt(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Label")))) {
        label = hexa_map_get_ic(p_advance(), "value", &__hexa_parser_ic_171);
    } else {
        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Ident")))) {
            label = hexa_map_get_ic(p_advance(), "value", &__hexa_parser_ic_172);
        }
    }
...
HexaVal parse_continue_stmt(void) {
    ...
    HexaVal label = hexa_str("");
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Label")))) {
        label = hexa_map_get_ic(p_advance(), "value", &__hexa_parser_ic_173);
    } else {
        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Ident")))) {
            label = hexa_map_get_ic(p_advance(), "value", &__hexa_parser_ic_174);
        }
    }
...
HexaVal parse_do_while_stmt(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("While")))) {
        ...
        HexaVal tok = p_peek();
        p_record_error(hexa_map_get_ic(tok, "line", &__hexa_parser_ic_175), hexa_map_get_ic(tok, "col", &__hexa_parser_ic_176), hexa_str("expected 'while' after do block"));
...
HexaVal parse_labeled_loop(void) {
    HexaVal tok = hexa_void();
    __hexa_fn_arena_enter();
    HexaVal label = hexa_map_get_ic(p_advance(), "value", &__hexa_parser_ic_177);
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Colon")))) {
        p_advance();
    } else {
        tok = p_peek();
        p_record_error(hexa_map_get_ic(tok, "line", &__hexa_parser_ic_178), hexa_map_get_ic(tok, "col", &__hexa_parser_ic_179), hexa_str("expected ':' after label"));
    ...
    if (hexa_truthy(hexa_eq(next, hexa_str("For")))) {
        ...
        if (hexa_truthy(hexa_eq(next, hexa_str("While")))) {
            ...
            if (hexa_truthy(hexa_eq(next, hexa_str("Loop")))) {
                ...
                tok = p_peek();
                p_record_error(hexa_map_get_ic(tok, "line", &__hexa_parser_ic_180), hexa_map_get_ic(tok, "col", &__hexa_parser_ic_181), hexa_str("expected for/while/loop after label"));
                hexa_println(hexa_add(hexa_add(hexa_str("Parse error: expected for/while/loop after label '"), label), hexa_str("'")));
                return __hexa_fn_arena_return(empty_node());
            }
        }
    }
    return __hexa_fn_arena_return(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_map_get_ic(loop_node, "kind", &__hexa_parser_ic_182)), "name", hexa_map_get_ic(loop_node, "name", &__hexa_parser_ic_183)), "value", label), "op", hexa_map_get_ic(loop_node, "op", &__hexa_parser_ic_184)), "left", hexa_map_get_ic(loop_node, "left", &__hexa_parser_ic_185)), "right", hexa_map_get_ic(loop_node, "right", &__hexa_parser_ic_186)), "cond", hexa_map_get_ic(loop_node, "cond", &__hexa_parser_ic_187)), "then_body", hexa_map_get_ic(loop_node, "then_body", &__hexa_parser_ic_188)), "else_body", hexa_map_get_ic(loop_node, "else_body", &__hexa_parser_ic_189)), "params", hexa_map_get_ic(loop_node, "params", &__hexa_parser_ic_190)), "body", hexa_map_get_ic(loop_node, "body", &__hexa_parser_ic_191)), "args", hexa_map_get_ic(loop_node, "args", &__hexa_parser_ic_192)), "fields", hexa_map_get_ic(loop_node, "fields", &__hexa_parser_ic_193)), "items", hexa_map_get_ic(loop_node, "items", &__hexa_parser_ic_194)), "variants", hexa_map_get_ic(loop_node, "variants", &__hexa_parser_ic_195)), "arms", hexa_map_get_ic(loop_node, "arms", &__hexa_parser_ic_196)), "iter_expr", hexa_map_get_ic(loop_node, "iter_expr", &__hexa_parser_ic_197)), "ret_type", hexa_map_get_ic(loop_node, "ret_type", &__hexa_parser_ic_198)), "target", hexa_map_get_ic(loop_node, "target", &__hexa_parser_ic_199)), "trait_name", hexa_map_get_ic(loop_node, "trait_name", &__hexa_parser_ic_200)), "methods", hexa_map_get_ic(loop_node, "methods", &__hexa_parser_ic_201)));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal parse_intent_stmt(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
        desc = hexa_map_get_ic(p_advance(), "value", &__hexa_parser_ic_202);
    } else {
        desc = p_expect_ident();
    }
    p_expect(hexa_str("LBrace"));
...
HexaVal parse_verify_stmt(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
        name = hexa_map_get_ic(p_advance(), "value", &__hexa_parser_ic_203);
    } else {
        name = p_expect_ident();
    }
    HexaVal body = parse_block();
...
HexaVal parse_generate_stmt(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Fn")))) {
        ...
        desc = hexa_str("");
        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
            desc = hexa_map_get_ic(p_advance(), "value", &__hexa_parser_ic_204);
        }
        p_skip_newlines();
        p_expect(hexa_str("RBrace"));
    ...
    desc = hexa_str("");
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
        desc = hexa_map_get_ic(p_advance(), "value", &__hexa_parser_ic_205);
    }
    p_skip_newlines();
    p_expect(hexa_str("RBrace"));
...
HexaVal parse_macro_def(void) {
    ...
    while (((!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RBrace")))) && (!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))) {
        ...
        while (((!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RParen")))) && (!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))) {
            HexaVal tok = p_advance();
            pat_tokens = hexa_array_push(pat_tokens, hexa_map_get_ic(tok, "value", &__hexa_parser_ic_206));
            p_skip_newlines();
        }
        p_expect(hexa_str("RParen"));
...
HexaVal ast_to_string(HexaVal node, HexaVal indent) {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_parser_ic_207);
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("IntLit(")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_208)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("FloatLit(")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_209)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BoolLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("BoolLit(")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_210)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StringLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("StringLit(\"")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_211)), hexa_str("\")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("CharLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("CharLit('")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_212)), hexa_str("')")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("Ident(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_213)), hexa_str(")")));
    }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
        l = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_214), hexa_int(0));
        r = ast_to_string(hexa_map_get_ic(node, "right", &__hexa_parser_ic_215), hexa_int(0));
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("BinOp(")), hexa_map_get_ic(node, "op", &__hexa_parser_ic_216)), hexa_str(", ")), l), hexa_str(", ")), r), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        HexaVal operand = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_217), hexa_int(0));
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("UnaryOp(")), hexa_map_get_ic(node, "op", &__hexa_parser_ic_218)), hexa_str(", ")), operand), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Call")))) {
        HexaVal callee = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_219), hexa_int(0));
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("Call(")), callee), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_parser_ic_220))))), hexa_str(" args])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Field")))) {
        obj = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_221), hexa_int(0));
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("Field(")), obj), hexa_str(".")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_222)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("OptField")))) {
        obj = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_223), hexa_int(0));
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("OptField(")), obj), hexa_str("?.")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_224)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Index")))) {
        obj = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_225), hexa_int(0));
        HexaVal idx = ast_to_string(hexa_map_get_ic(node, "right", &__hexa_parser_ic_226), hexa_int(0));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("IfExpr")))) {
        HexaVal c = ast_to_string(hexa_map_get_ic(node, "cond", &__hexa_parser_ic_227), hexa_int(0));
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("IfExpr(")), c), hexa_str(", then=[")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "then_body", &__hexa_parser_ic_228))))), hexa_str("], else=[")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_parser_ic_229))))), hexa_str("])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("IfLetExpr")))) {
        HexaVal p = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_230), hexa_int(0));
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("IfLetExpr(")), p), hexa_str(", then=[")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "then_body", &__hexa_parser_ic_231))))), hexa_str("], else=[")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_parser_ic_232))))), hexa_str("])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("MatchExpr")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("MatchExpr([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_parser_ic_233))))), hexa_str(" arms])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Array")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("Array([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_234))))), hexa_str(" items])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ListComp")))) {
        HexaVal body_s = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_235), hexa_int(0));
        iter_s = ast_to_string(hexa_map_get_ic(node, "iter_expr", &__hexa_parser_ic_236), hexa_int(0));
        HexaVal filt = hexa_str("");
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "cond", &__hexa_parser_ic_237)), hexa_str("string")))))) {
            filt = hexa_add(hexa_str(" if "), ast_to_string(hexa_map_get_ic(node, "cond", &__hexa_parser_ic_238), hexa_int(0)));
        }
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ListComp(")), body_s), hexa_str(" for ")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_239)), hexa_str(" in ")), iter_s), filt), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StructInit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("StructInit(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_240)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_parser_ic_241))))), hexa_str(" fields])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Slice")))) {
        ...
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "right", &__hexa_parser_ic_243), hexa_str("")))))) {
            s_str = ast_to_string(hexa_map_get_ic(node, "right", &__hexa_parser_ic_244), hexa_int(0));
        }
        HexaVal e_str = hexa_str("");
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "cond", &__hexa_parser_ic_245), hexa_str("")))))) {
            e_str = ast_to_string(hexa_map_get_ic(node, "cond", &__hexa_parser_ic_246), hexa_int(0));
        }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Range")))) {
        HexaVal s = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_247), hexa_int(0));
        HexaVal e = ast_to_string(hexa_map_get_ic(node, "right", &__hexa_parser_ic_248), hexa_int(0));
        HexaVal step_str = hexa_str("");
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "cond", &__hexa_parser_ic_249), hexa_str("")))))) {
            step_str = hexa_add(hexa_str(" step "), ast_to_string(hexa_map_get_ic(node, "cond", &__hexa_parser_ic_250), hexa_int(0)));
        }
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("Range(")), s), hexa_str("..")), e), hexa_str(", ")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_251)), step_str), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumPath")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("EnumPath(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_252)), hexa_str("::")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_253)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Lambda")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("Lambda([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_254))))), hexa_str(" params])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Tuple")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("Tuple([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_255))))), hexa_str(" items])")));
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt")))))) {
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, k), hexa_str("(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_257)), hexa_str(" = ")), v), hexa_str(")")));
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("ConstStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("StaticStmt")))))) {
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_258), hexa_int(0));
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, k), hexa_str("(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_259)), hexa_str(" = ")), v), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ReturnStmt")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "left", &__hexa_parser_ic_260), hexa_str("")))) {
            return __hexa_fn_arena_return(hexa_add(pad, hexa_str("ReturnStmt()")));
        }
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_261), hexa_int(0));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("FnDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("FnDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_262)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_263))))), hexa_str(" params], [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_264))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StructDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("StructDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_265)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_parser_ic_266))))), hexa_str(" fields])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("EnumDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_267)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "variants", &__hexa_parser_ic_268))))), hexa_str(" variants])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ForStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ForStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_269)), hexa_str(" in ..., [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_270))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("WhileStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("WhileStmt(..., [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_271))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("LoopStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("LoopStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_272))))), hexa_str(" stmts])")));
    }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("AssignStmt")))) {
        l = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_274), hexa_int(0));
        r = ast_to_string(hexa_map_get_ic(node, "right", &__hexa_parser_ic_275), hexa_int(0));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("AssertStmt")))) {
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_276), hexa_int(0));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ProofStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ProofStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_277)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_278))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ImplBlock")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ImplBlock(")), hexa_map_get_ic(node, "target", &__hexa_parser_ic_279)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "methods", &__hexa_parser_ic_280))))), hexa_str(" methods])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("TraitDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("TraitDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_281)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "methods", &__hexa_parser_ic_282))))), hexa_str(" methods])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("UseStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("UseStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_283))))), hexa_str(" segments])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ModStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("ModStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_284)), hexa_str(")")));
    }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("YieldStmt")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "left", &__hexa_parser_ic_285), hexa_str("")))) {
            return __hexa_fn_arena_return(hexa_add(pad, hexa_str("YieldStmt()")));
        }
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("YieldStmt(")), ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_286), hexa_int(0))), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeFnDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ComptimeFnDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_287)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_288))))), hexa_str(" params])")));
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("ComptimeConst"))) || hexa_truthy(hexa_eq(k, hexa_str("ComptimeLet")))))) {
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_289), hexa_int(0));
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, k), hexa_str("(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_290)), hexa_str(" = ")), v), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeBlock")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("ComptimeBlock([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_291))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeAssert")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("ComptimeAssert(")), ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_292), hexa_int(0))), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("IntentStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("IntentStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_293)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_parser_ic_294))))), hexa_str(" fields])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("VerifyStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("VerifyStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_295)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_296))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("GenerateFnStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("GenerateStmt")))))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(pad, k), hexa_str("(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_297)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("OptimizeFnStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("OptimizeFnStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_298)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_299))))), hexa_str(" params])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EffectDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("EffectDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_300)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_301))))), hexa_str(" ops])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("PureFnDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("PureFnDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_302)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_303))))), hexa_str(" params])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("MacroDef")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("MacroDef(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_304)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_305))))), hexa_str(" rules])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("DeriveDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("DeriveDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_306)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_307))))), hexa_str(" traits])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("TheoremStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("TheoremStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_308)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_309))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("HandleWithStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("HandleWithStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_parser_ic_310))))), hexa_str(" handlers])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("GuardStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("GuardStmt(cond, [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_parser_ic_311))))), hexa_str(" else stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("GuardLetStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("GuardLetStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_312)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_parser_ic_313))))), hexa_str(" else stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("WithStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("WithStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_314)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_315))))), hexa_str(" body stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("WalrusExpr")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("WalrusExpr(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_316)), hexa_str(", ")), ast_to_string(hexa_map_get_ic(node, "right", &__hexa_parser_ic_317), hexa_int(0))), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("TryCatch")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("TryCatch(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_318)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ThrowStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("ThrowStmt(")), ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_319), hexa_int(0))), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("PanicStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("PanicStmt(")), ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_320), hexa_int(0))), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("DropStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("DropStmt(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_321)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("SpawnStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("SpawnStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_322))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ScopeStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("ScopeStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_323))))), hexa_str(" stmts])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("SelectStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("SelectStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_parser_ic_324))))), hexa_str(" arms])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("AsyncFnDecl")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("AsyncFnDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_325)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_326))))), hexa_str(" params])")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ExternFnDecl")))) {
        HexaVal sym_info = hexa_str("");
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "value", &__hexa_parser_ic_327), hexa_str("")))))) {
            sym_info = hexa_add(hexa_add(hexa_str(", @symbol(\""), hexa_map_get_ic(node, "value", &__hexa_parser_ic_328)), hexa_str("\")"));
        }
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ExternFnDecl(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_329)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_parser_ic_330))))), hexa_str(" params]")), sym_info), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("TypeAlias")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("TypeAlias(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_331)), hexa_str(" = ")), hexa_map_get_ic(node, "value", &__hexa_parser_ic_332)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("AtomicLet")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("AtomicLet(")), hexa_map_get_ic(node, "name", &__hexa_parser_ic_333)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("DestructLetStmt")))) {
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_334), hexa_int(0));
        HexaVal rest = hexa_map_get_ic(node, "name", &__hexa_parser_ic_335);
        names = hexa_str_join(hexa_map_get_ic(node, "params", &__hexa_parser_ic_336), hexa_str(", "));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("MapDestructLetStmt")))) {
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_parser_ic_337), hexa_int(0));
        names = hexa_str_join(hexa_map_get_ic(node, "params", &__hexa_parser_ic_338), hexa_str(", "));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ForDestructStmt")))) {
        names = hexa_str_join(hexa_map_get_ic(node, "params", &__hexa_parser_ic_339), hexa_str(", "));
        iter_s = ast_to_string(hexa_map_get_ic(node, "iter_expr", &__hexa_parser_ic_340), hexa_int(0));
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ForDestructStmt((")), names), hexa_str(") in ")), iter_s), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_parser_ic_341))))), hexa_str(" stmts])")));
    }
...
HexaVal _resolve_parse_int(HexaVal s);
...
HexaVal _strlit_dedup(HexaVal escaped);
...
HexaVal _resolve_caller_dir_inited;
...
HexaVal _strlit_keys;
HexaVal _strlit_ids;
HexaVal _strlit_def_parts;
HexaVal _strlit_counter;
...
static HexaIC __hexa_codegen_c2_ic_861 = {0};
static HexaIC __hexa_codegen_c2_ic_862 = {0};
static HexaIC __hexa_codegen_c2_ic_863 = {0};
static HexaIC __hexa_codegen_c2_ic_864 = {0};
static HexaIC __hexa_codegen_c2_ic_865 = {0};
static HexaIC __hexa_codegen_c2_ic_866 = {0};
static HexaIC __hexa_codegen_c2_ic_867 = {0};
static HexaIC __hexa_codegen_c2_ic_868 = {0};
...
HexaVal _hexa_name_is_reserved(HexaVal s) {
    ...
    if (hexa_truthy(hexa_eq(s, hexa_str("log1p")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    ...
    if (hexa_truthy(hexa_eq(s, hexa_str("expm1")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("sqrt")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("cbrt")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("hypot")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    ...
    if (hexa_truthy(hexa_eq(s, hexa_str("trunc")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    ...
    if (hexa_truthy(hexa_eq(s, hexa_str("asin")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("acos")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    ...
    if (hexa_truthy(hexa_eq(s, hexa_str("sinh")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("cosh")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("tanh")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("fmax")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("fmin")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("fma")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("erf")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("erfc")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("gamma")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("lgamma")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("tgamma")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("strchr")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("strrchr")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("strstr")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("strcmp")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("strncmp")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("strcpy")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("strncpy")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("memcpy")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("memcmp")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("memset")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("printf")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("fprintf")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("sprintf")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("snprintf")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("scanf")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("fopen")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("fclose")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(s, hexa_str("fread")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    ...
    if (hexa_truthy(hexa_eq(s, hexa_str("argc")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
...
HexaVal _resolve_dirname(HexaVal path) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(path), hexa_str("string")))))) {
        return __hexa_fn_arena_return(hexa_str("."));
    }
    HexaVal n = hexa_int(hexa_len(path));
    HexaVal i = hexa_sub(n, hexa_int(1));
    while (HX_BOOL(hexa_cmp_ge(i, hexa_int(0)))) {
        if (hexa_truthy(hexa_eq(hexa_str_substring(path, i, hexa_add(i, hexa_int(1))), hexa_str("/")))) {
            return __hexa_fn_arena_return(hexa_str_substring(path, hexa_int(0), i));
        }
        i = hexa_sub(i, hexa_int(1));
    }
    return __hexa_fn_arena_return(hexa_str("."));
...
HexaVal _resolve_caller_dir_get(void) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(_resolve_caller_dir_inited)) {
        return __hexa_fn_arena_return(_resolve_caller_dir);
    }
    _resolve_caller_dir_inited = hexa_bool(1);
    HexaVal av = hexa_args();
    HexaVal n = hexa_int(hexa_len(av));
    HexaVal i = hexa_int(1);
    while (HX_BOOL(hexa_cmp_lt(i, n))) {
        HexaVal a = hexa_index_get(av, i);
        if (hexa_truthy(hexa_eq(hexa_type_of(a), hexa_str("string")))) {
            HexaVal al = hexa_int(hexa_len(a));
            if (hexa_truthy(hexa_cmp_ge(al, hexa_int(5)))) {
                HexaVal tail = hexa_str_substring(a, hexa_sub(al, hexa_int(5)), al);
    ...
    _resolve_caller_dir = hexa_str(".");
    return __hexa_fn_arena_return(_resolve_caller_dir);
    return __hexa_fn_arena_return(hexa_void());
}


HexaVal _resolve_try_candidate(HexaVal cand) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(hexa_eq(hexa_int(hexa_len(cand)), hexa_int(0)))) {
        return __hexa_fn_arena_return(hexa_str(""));
    }
    if (hexa_truthy(hexa_bool(access(HX_STR(cand), F_OK) == 0))) {
        return __hexa_fn_arena_return(cand);
    }
    return __hexa_fn_arena_return(hexa_str(""));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal _resolve_use_path(HexaVal name) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(name), hexa_str("string")))))) {
        return __hexa_fn_arena_return(hexa_str(""));
    }
...
HexaVal _resolve_is_seen(HexaVal name) {
    __hexa_fn_arena_enter();
    HexaVal n = hexa_int(hexa_len(_resolved_modules));
    HexaVal i = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(i, n))) {
        if (hexa_truthy(hexa_eq(hexa_index_get(_resolved_modules, i), name))) {
            return __hexa_fn_arena_return(hexa_bool(1));
        }
        i = hexa_add(i, hexa_int(1));
    }
...
HexaVal _resolve_line_col0(HexaVal line) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(line), hexa_str("string")))))) {
        return __hexa_fn_arena_return(hexa_bool(0));
    }
    if (hexa_truthy(hexa_eq(hexa_int(hexa_len(line)), hexa_int(0)))) {
        return __hexa_fn_arena_return(hexa_bool(0));
    }
    HexaVal c = hexa_str_substring(line, hexa_int(0), hexa_int(1));
    if (hexa_truthy(hexa_eq(c, hexa_str(" ")))) {
        return __hexa_fn_arena_return(hexa_bool(0));
    }
    if (hexa_truthy(hexa_eq(c, hexa_str("\t")))) {
...
HexaVal _resolve_param_arity(HexaVal body) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(body), hexa_str("string")))))) {
        return __hexa_fn_arena_return(hexa_int(0));
    }
    ...
    HexaVal depth = hexa_int(0);
    HexaVal count = hexa_int(1);
    HexaVal i = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(i, n))) {
        HexaVal c = hexa_str_substring(t, i, hexa_add(i, hexa_int(1)));
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(c, hexa_str("("))) || hexa_truthy(hexa_eq(c, hexa_str("["))))) || hexa_truthy(hexa_eq(c, hexa_str("{")))))) {
            depth = hexa_add(depth, hexa_int(1));
        } else {
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(c, hexa_str(")"))) || hexa_truthy(hexa_eq(c, hexa_str("]"))))) || hexa_truthy(hexa_eq(c, hexa_str("}")))))) {
                depth = hexa_sub(depth, hexa_int(1));
            } else {
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(c, hexa_str(","))) && hexa_truthy(hexa_eq(depth, hexa_int(0)))))) {
                    count = hexa_add(count, hexa_int(1));
                }
            }
        }
...
HexaVal _resolve_parse_fn_sig(HexaVal line) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(hexa_bool(!hexa_truthy(_resolve_line_col0(line))))) {
        return __hexa_fn_arena_return(hexa_str(""));
    }
    HexaVal raw = line;
    HexaVal brace = hexa_int(hexa_str_index_of(raw, hexa_str("{")));
    HexaVal sig = raw;
    if (hexa_truthy(hexa_cmp_ge(brace, hexa_int(0)))) {
        sig = hexa_str_substring(raw, hexa_int(0), brace);
    }
    sig = hexa_str_trim(sig);
    if (hexa_truthy(hexa_bool(hexa_str_starts_with(sig, hexa_str("@"))))) {
        HexaVal pfn = hexa_int(hexa_str_index_of(sig, hexa_str(" pub fn ")));
        HexaVal fnsp = hexa_int(hexa_str_index_of(sig, hexa_str(" fn ")));
        HexaVal cut = hexa_sub(hexa_int(0), hexa_int(1));
        if (hexa_truthy(hexa_cmp_ge(pfn, hexa_int(0)))) {
            cut = hexa_add(pfn, hexa_int(1));
        } else {
            if (hexa_truthy(hexa_cmp_ge(fnsp, hexa_int(0)))) {
                cut = hexa_add(fnsp, hexa_int(1));
            }
        }
        if (hexa_truthy(hexa_cmp_lt(cut, hexa_int(0)))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        sig = hexa_str_substring(sig, cut, hexa_int(hexa_len(sig)));
    }
    if (hexa_truthy(hexa_bool(hexa_str_starts_with(sig, hexa_str("pub fn "))))) {
        sig = hexa_str_substring(sig, hexa_int(7), hexa_int(hexa_len(sig)));
    } else {
        if (hexa_truthy(hexa_bool(hexa_str_starts_with(sig, hexa_str("fn "))))) {
            sig = hexa_str_substring(sig, hexa_int(3), hexa_int(hexa_len(sig)));
        } else {
            return __hexa_fn_arena_return(hexa_str(""));
        }
    }
    HexaVal lp = hexa_int(hexa_str_index_of(sig, hexa_str("(")));
    ...
    HexaVal rest = hexa_str_substring(sig, hexa_add(lp, hexa_int(1)), hexa_int(hexa_len(sig)));
    HexaVal rp = hexa_int(hexa_str_index_of(rest, hexa_str(")")));
    if (hexa_truthy(hexa_cmp_lt(rp, hexa_int(0)))) {
        return __hexa_fn_arena_return(hexa_str(""));
    }
    HexaVal body = hexa_str_substring(rest, hexa_int(0), rp);
    HexaVal arity = _resolve_param_arity(body);
    return __hexa_fn_arena_return(hexa_add(hexa_add(name, hexa_str("|")), hexa_to_string(arity)));
    return __hexa_fn_arena_return(hexa_void());
}


HexaVal _resolve_parse_struct_start(HexaVal line) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(hexa_bool(!hexa_truthy(_resolve_line_col0(line))))) {
        return __hexa_fn_arena_return(hexa_str(""));
    }
    ...
    HexaVal body = t;
    if (hexa_truthy(hexa_bool(hexa_str_starts_with(body, hexa_str("pub struct "))))) {
        body = hexa_str_substring(body, hexa_int(11), hexa_int(hexa_len(body)));
    } else {
        if (hexa_truthy(hexa_bool(hexa_str_starts_with(body, hexa_str("struct "))))) {
            body = hexa_str_substring(body, hexa_int(7), hexa_int(hexa_len(body)));
        } else {
            return __hexa_fn_arena_return(hexa_str(""));
        }
    }
    HexaVal lb = hexa_int(hexa_str_index_of(body, hexa_str("{")));
...
HexaVal _resolve_emit_extern_fn(HexaVal rec) {
    __hexa_fn_arena_enter();
    HexaVal bar = hexa_int(hexa_str_index_of(rec, hexa_str("|")));
    if (hexa_truthy(hexa_cmp_lt(bar, hexa_int(0)))) {
        return __hexa_fn_arena_return(hexa_str(""));
    }
    HexaVal name = hexa_str_substring(rec, hexa_int(0), bar);
    HexaVal ar_str = hexa_str_substring(rec, hexa_add(bar, hexa_int(1)), hexa_int(hexa_len(rec)));
    HexaVal arity = _resolve_parse_int(ar_str);
    HexaVal mangled = _hexa_mangle_ident(name);
    HexaVal params = hexa_str("");
    if (hexa_truthy(hexa_eq(arity, hexa_int(0)))) {
        params = hexa_str("void");
    } else {
        HexaVal i = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(i, arity))) {
            if (hexa_truthy(hexa_cmp_gt(i, hexa_int(0)))) {
                params = hexa_add(params, hexa_str(", "));
            }
            params = hexa_add(params, hexa_str("HexaVal"));
            i = hexa_add(i, hexa_int(1));
        }
    }
    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("extern HexaVal "), mangled), hexa_str("(")), params), hexa_str(");\n")));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal _resolve_parse_int(HexaVal s) {
    ...
    while (HX_BOOL(hexa_cmp_lt(i, n))) {
        ...
        HexaVal o = hexa_char_code(c, hexa_int(0));
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_cmp_ge(o, hexa_int(48))) && hexa_truthy(hexa_cmp_le(o, hexa_int(57)))))) {
            v = hexa_add(hexa_mul(v, hexa_int(10)), hexa_sub(o, hexa_int(48)));
        }
        i = hexa_add(i, hexa_int(1));
    }
...
HexaVal _resolve_use_register_names(HexaVal name) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(name), hexa_str("string")))))) {
        return __hexa_fn_arena_return(hexa_int(0));
    }
    ...
    HexaVal path = _resolve_use_path(name);
    if (hexa_truthy(hexa_eq(hexa_int(hexa_len(path)), hexa_int(0)))) {
        return __hexa_fn_arena_return(hexa_int(0));
    }
    HexaVal src = hexa_read_file(path);
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(src), hexa_str("string"))))) || hexa_truthy(hexa_eq(hexa_int(hexa_len(src)), hexa_int(0)))))) {
        return __hexa_fn_arena_return(hexa_int(0));
    }
    HexaVal lines = hexa_str_split(src, hexa_str("\n"));
    HexaVal ln = hexa_int(hexa_len(lines));
    HexaVal i = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(i, ln))) {
        HexaVal line = hexa_index_get(lines, i);
        HexaVal rec = _resolve_parse_fn_sig(line);
        if (hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(rec)), hexa_int(0)))) {
            HexaVal bar = hexa_int(hexa_str_index_of(rec, hexa_str("|")));
            HexaVal fname = hexa_str_substring(rec, hexa_int(0), bar);
            _known_fn_globals = hexa_array_push(_known_fn_globals, fname);
            _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, fname);
            _known_fn_globals_add(fname);
            _known_nonlocal_add(fname);
        } else {
            HexaVal sname = _resolve_parse_struct_start(line);
            if (hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(sname)), hexa_int(0)))) {
                _known_fn_globals = hexa_array_push(_known_fn_globals, sname);
                _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, sname);
...
HexaVal _resolve_use_emit(HexaVal name) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(name), hexa_str("string")))))) {
        return __hexa_fn_arena_return(hexa_str(""));
    }
    ...
    if (hexa_truthy(_resolve_is_seen(name))) {
        return __hexa_fn_arena_return(hexa_str(""));
    }
    _resolved_modules = hexa_array_push(_resolved_modules, name);
    HexaVal path = _resolve_use_path(name);
    if (hexa_truthy(hexa_eq(hexa_int(hexa_len(path)), hexa_int(0)))) {
        (hexa_eprint_val(hexa_add(hexa_add(hexa_str("[codegen_c2] use not found on disk: "), name), hexa_str(" (4-way search: caller-dir, $HEXA_LANG/self, $HEXA_LANG, cwd, ./self)"))), fprintf(stderr, "\n"), hexa_void());
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("/* use: "), name), hexa_str(" (unresolved path) */\n")));
    }
    HexaVal src = hexa_read_file(path);
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(src), hexa_str("string"))))) || hexa_truthy(hexa_eq(hexa_int(hexa_len(src)), hexa_int(0)))))) {
        (hexa_eprint_val(hexa_add(hexa_str("[codegen_c2] use resolved but read_file empty: "), path)), fprintf(stderr, "\n"), hexa_void());
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("/* use: "), name), hexa_str(" (empty source) */\n")));
    }
    HexaVal lines = hexa_str_split(src, hexa_str("\n"));
    HexaVal ln = hexa_int(hexa_len(lines));
    HexaVal out = hexa_str("");
    out = hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(out, hexa_str("/* use: ")), name), hexa_str(" -> ")), path), hexa_str(" */\n"));
    HexaVal i = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(i, ln))) {
        HexaVal line = hexa_index_get(lines, i);
        HexaVal rec = _resolve_parse_fn_sig(line);
        if (hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(rec)), hexa_int(0)))) {
            ...
            _known_fn_globals_add(fname);
            _known_nonlocal_add(fname);
            out = hexa_add(out, _resolve_emit_extern_fn(rec));
        } else {
            HexaVal sname = _resolve_parse_struct_start(line);
            if (hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(sname)), hexa_int(0)))) {
                _known_fn_globals = hexa_array_push(_known_fn_globals, sname);
...
HexaVal codegen_c2(HexaVal ast) {
    ...
    _strlit_def_parts = hexa_array_new();
    _strlit_counter = hexa_int(0);
    _resolved_modules = hexa_array_new();
    _resolve_caller_dir_inited = hexa_bool(0);
    _resolve_caller_dir = hexa_str("");
    ...
    while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(ast))))) {
        HexaVal k = hexa_map_get_ic(hexa_index_get(ast, i), "kind", &__hexa_codegen_c2_ic_16);
        if (hexa_truthy(hexa_eq(k, hexa_str("FnDecl")))) {
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_17), hexa_str("main")))) {
            ...
            if (hexa_truthy(hexa_eq(k, hexa_str("ExternFnDecl")))) {
                extern_fns = hexa_array_push(extern_fns, hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_18));
                HexaVal ew = gen2_extern_wrapper(hexa_index_get(ast, i));
                global_parts = hexa_array_push(global_parts, hexa_map_get_ic(ew, "global", &__hexa_codegen_c2_ic_19));
                fwd_parts = hexa_array_push(fwd_parts, hexa_add(hexa_map_get_ic(ew, "forward", &__hexa_codegen_c2_ic_20), hexa_str("\n")));
                fn_parts = hexa_array_push(fn_parts, hexa_add(hexa_map_get_ic(ew, "fn_code", &__hexa_codegen_c2_ic_21), hexa_str("\n\n")));
                init_parts = hexa_array_push(init_parts, hexa_map_get_ic(ew, "init", &__hexa_codegen_c2_ic_22));
            } else {
                if (hexa_truthy(hexa_eq(k, hexa_str("StructDecl")))) {
                    ...
                    if (hexa_truthy(hexa_eq(k, hexa_str("EnumDecl")))) {
                        ...
                        if (hexa_truthy(hexa_eq(k, hexa_str("ImplBlock")))) {
                            ...
                            fwd_parts = hexa_array_push(fwd_parts, hexa_map_get_ic(ib, "forward", &__hexa_codegen_c2_ic_23));
                            fn_parts = hexa_array_push(fn_parts, hexa_map_get_ic(ib, "fn_code", &__hexa_codegen_c2_ic_24));
                        } else {
                            if (hexa_truthy(hexa_eq(k, hexa_str("PureFnDecl")))) {
                                fwd_parts = hexa_array_push(fwd_parts, hexa_add(gen2_fn_forward(hexa_index_get(ast, i)), hexa_str("\n")));
                                fn_parts = hexa_array_push(fn_parts, hexa_add(gen2_fn_decl(hexa_index_get(ast, i)), hexa_str("\n\n")));
                                ...
                                if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeConst")))) {
                                    HexaVal _cc_folded = comptime_eval(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_25));
                                    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(_cc_folded), hexa_str("string")))))) {
                                        _register_comptime_const(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_26), _cc_folded);
                                    } else {
                                        global_parts = hexa_array_push(global_parts, hexa_add(hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_27)), hexa_str(";\n")));
                                        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_28)), hexa_str("string")))))) {
                                            init_parts = hexa_array_push(init_parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_29)), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_30))), hexa_str(";\n")));
                                        } else {
                                            init_parts = hexa_array_push(init_parts, hexa_add(hexa_add(hexa_str("    "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_31)), hexa_str(" = hexa_void();\n")));
                                        }
                                    }
                                } else {
                                    if (hexa_truthy(hexa_eq(k, hexa_str("OptimizeFnStmt")))) {
                                        ...
                                        if (hexa_truthy(hexa_eq(k, hexa_str("TraitDecl")))) {
                                            ...
                                            if (hexa_truthy(hexa_eq(k, hexa_str("InvariantDecl")))) {
                                                ...
                                                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("ImportStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("UseStmt")))))) {
                                                    HexaVal _use_fwd = _resolve_use_emit(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_32));
                                                    if (hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(_use_fwd)), hexa_int(0)))) {
                                                        fwd_parts = hexa_array_push(fwd_parts, _use_fwd);
                                                    } else {
                                                        main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_str("    /* import: "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_33)), hexa_str(" */\n")));
                                                    }
                                                } else {
                                                    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("LetStmt")))))) {
                                                        HexaVal _user_name = _hexa_mangle_ident(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_34));
                                                        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetStmt"))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_35)), hexa_str("string")))))))) {
                                                            if (hexa_truthy(_is_int_init_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_36)))) {
                                                                _known_int_add(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_37));
                                                            }
                                                            if (hexa_truthy(_is_float_init_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_38)))) {
                                                                _known_float_add(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_39));
                                                            }
                                                        }
                                                        HexaVal _tls_val = hexa_map_get_ic(hexa_index_get(ast, i), "value", &__hexa_codegen_c2_ic_40);
                                                        ...
                                                        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_41)), hexa_str("string")))))) {
                                                            init_parts = hexa_array_push(init_parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    "), _user_name), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_42))), hexa_str(";\n")));
                                                        } else {
                                                        ...
                                                        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(_tls_stmt, "kind", &__hexa_codegen_c2_ic_43), hexa_str("ExprStmt"))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(_tls_stmt, "left", &__hexa_codegen_c2_ic_44)), hexa_str("string")))))))) {
                                                            HexaVal _tls_expr = hexa_map_get_ic(_tls_stmt, "left", &__hexa_codegen_c2_ic_45);
                                                            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(_tls_expr, "kind", &__hexa_codegen_c2_ic_46), hexa_str("Call"))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(_tls_expr, "left", &__hexa_codegen_c2_ic_47)), hexa_str("string")))))))) {
                                                                HexaVal _tls_callee = hexa_map_get_ic(_tls_expr, "left", &__hexa_codegen_c2_ic_48);
                                                                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(_tls_callee, "kind", &__hexa_codegen_c2_ic_49), hexa_str("Ident"))) && hexa_truthy(hexa_eq(hexa_map_get_ic(_tls_callee, "name", &__hexa_codegen_c2_ic_50), hexa_str("main")))))) {
    ...
    if (hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(_strlit_keys)), hexa_int(0)))) {
        ...
        while (HX_BOOL(hexa_cmp_lt(_sli, hexa_int(hexa_len(_strlit_keys))))) {
            parts = hexa_array_push(parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    __hexa_sl_"), hexa_to_string(hexa_index_get(_strlit_ids, _sli))), hexa_str(" = hexa_str(\"")), hexa_index_get(_strlit_keys, _sli)), hexa_str("\");\n")));
            _sli = hexa_add(_sli, hexa_int(1));
        }
        parts = hexa_array_push(parts, hexa_str("}\n"));
    }
     ...
     * `_lambda_def_parts.join("")` which hit T33-class arena aliasing on
     * large body payloads (train_v14.hexa: bodies truncated into
     * "tr(\"exaVal __hexa_sl_6;" / "exaVal __hexa_sl_4;" fragments).
     * Mirror of fcf275f4 (IC) + c461f60a (lambda fwd sigs). */
    {
        HexaVal _ldp_i = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(_ldp_i, _lambda_counter))) {
            parts = hexa_array_push(parts, hexa_index_get(_lambda_def_parts, _ldp_i));
            _ldp_i = hexa_add(_ldp_i, hexa_int(1));
        }
    }
    ...
    if (hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(_strlit_keys)), hexa_int(0)))) {
        parts = hexa_array_push(parts, hexa_str("    __hexa_strlit_init();\n"));
    }
...
HexaVal gen2_has_attr(HexaVal node, HexaVal target) {
    __hexa_fn_arena_enter();
    HexaVal v = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_51);
...
HexaVal gen2_has_inline_always(HexaVal node) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_52)), hexa_str("string")))))) {
        return __hexa_fn_arena_return(hexa_bool(0));
    }
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_53), hexa_str("")))) {
        return __hexa_fn_arena_return(hexa_bool(0));
    }
    HexaVal attrs = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_54);
...
HexaVal gen2_fn_forward(HexaVal node) {
    ...
    HexaVal params = hexa_array_new();
    HexaVal i = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_55)))))) {
        if (hexa_truthy(has_restrict)) {
            params = hexa_array_push(params, hexa_add(hexa_str("HexaVal __restrict "), _hexa_mangle_ident(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_56), i), "name", &__hexa_codegen_c2_ic_57))));
        } else {
            params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), _hexa_mangle_ident(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_58), i), "name", &__hexa_codegen_c2_ic_59))));
        }
        i = hexa_add(i, hexa_int(1));
    }
    ...
    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(prefix, hexa_str("HexaVal ")), _hexa_mangle_ident(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_60))), hexa_str("(")), p), hexa_str(")")), suffix), hexa_str(";")));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal gen2_has_specialize(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal attrs = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_61);
...
HexaVal gen2_specialize_guard(HexaVal node) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_62))), hexa_int(0)))) {
        return __hexa_fn_arena_return(hexa_str(""));
    }
    HexaVal p0 = hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_63), hexa_int(0)), "name", &__hexa_codegen_c2_ic_64);
    HexaVal out = hexa_str("");
...
HexaVal gen2_fn_decl(HexaVal node) {
    ...
    HexaVal params = hexa_array_new();
    HexaVal i = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_65)))))) {
        if (hexa_truthy(has_restrict)) {
            params = hexa_array_push(params, hexa_add(hexa_str("HexaVal __restrict "), _hexa_mangle_ident(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_66), i), "name", &__hexa_codegen_c2_ic_67))));
        } else {
            params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), _hexa_mangle_ident(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_68), i), "name", &__hexa_codegen_c2_ic_69))));
        }
        i = hexa_add(i, hexa_int(1));
    }
    HexaVal p = hexa_str_join(params, hexa_str(", "));
    ...
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_70)), hexa_str("string"))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_71), hexa_str("")))))))) {
        HexaVal _sa_attrs = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_72);
    ...
    while (HX_BOOL(hexa_cmp_lt(_pi, hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_73)))))) {
        _gen2_declared_names = hexa_array_push(_gen2_declared_names, _hexa_mangle_ident(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_74), _pi), "name", &__hexa_codegen_c2_ic_75)));
        _pi = hexa_add(_pi, hexa_int(1));
    }
    HexaVal all_names = _gen2_collect_lets(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_76), hexa_array_new());
    ...
    HexaVal _fn_name = _hexa_mangle_ident(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_77));
    HexaVal prefix = hexa_str("");
    if (hexa_truthy(gen2_has_inline_always(node))) {
        prefix = hexa_str("static inline ");
    }
    ...
    HexaVal _ret_type = hexa_map_get_ic(node, "ret_type", &__hexa_codegen_c2_ic_78);
    ...
    HexaVal body_len = hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_79)));
    HexaVal bi = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(bi, body_len))) {
        HexaVal stmt = hexa_index_get(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_80), bi);
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(_wants_tail_return) && hexa_truthy(hexa_eq(bi, hexa_sub(body_len, hexa_int(1)))))) && hexa_truthy(hexa_bool(!hexa_truthy(has_stack_alloc)))))) {
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(stmt), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(stmt, "kind", &__hexa_codegen_c2_ic_81), hexa_str("ExprStmt")))))) {
                if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(stmt, "left", &__hexa_codegen_c2_ic_82)), hexa_str("string")))))) {
                    HexaVal inner_kind = hexa_map_get_ic(hexa_map_get_ic(stmt, "left", &__hexa_codegen_c2_ic_83), "kind", &__hexa_codegen_c2_ic_84);
                    ...
                    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(inner_kind, hexa_str("Call"))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_map_get_ic(stmt, "left", &__hexa_codegen_c2_ic_85), "left", &__hexa_codegen_c2_ic_86)), hexa_str("string")))))))) {
                        if (hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(hexa_map_get_ic(stmt, "left", &__hexa_codegen_c2_ic_87), "left", &__hexa_codegen_c2_ic_88), "kind", &__hexa_codegen_c2_ic_89), hexa_str("Ident")))) {
                            HexaVal _cname = hexa_map_get_ic(hexa_map_get_ic(hexa_map_get_ic(stmt, "left", &__hexa_codegen_c2_ic_90), "left", &__hexa_codegen_c2_ic_91), "name", &__hexa_codegen_c2_ic_92);
                    ...
                    if (hexa_truthy(hexa_bool(!hexa_truthy(_skip)))) {
                        if (hexa_truthy(has_no_arena)) {
                            chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_str("    return "), gen2_expr(hexa_map_get_ic(stmt, "left", &__hexa_codegen_c2_ic_93))), hexa_str(";\n")));
                        } else {
                            chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_str("    return __hexa_fn_arena_return("), gen2_expr(hexa_map_get_ic(stmt, "left", &__hexa_codegen_c2_ic_94))), hexa_str(");\n")));
                        }
...
HexaVal gen2_stmt_stack_alloc(HexaVal node, HexaVal depth) {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_95);
    if (hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt")))) {
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_96)), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_97), "kind", &__hexa_codegen_c2_ic_98), hexa_str("ArrayLit")))))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("/* @stack_alloc */ HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_99)), hexa_str(" = hexa_stack_array(1024);\n")));
        }
    }
...
HexaVal gen2_has_float_param(HexaVal params) {
    ...
    while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(params))))) {
        HexaVal t = hexa_map_get_ic(hexa_index_get(params, i), "value", &__hexa_codegen_c2_ic_100);
...
HexaVal gen2_extern_static_decl(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_101);
    HexaVal ret_type = hexa_map_get_ic(node, "ret_type", &__hexa_codegen_c2_ic_102);
    HexaVal c_name = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_103);
    ...
    HexaVal i = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_104)))))) {
        HexaVal p = hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_105), i);
        HexaVal c_typ = gen2_static_c_type(hexa_map_get_ic(p, "value", &__hexa_codegen_c2_ic_106));
        if (hexa_truthy(hexa_eq(c_typ, hexa_str("void")))) {
            c_params = hexa_array_push(c_params, hexa_add(hexa_str("long long "), hexa_map_get_ic(p, "name", &__hexa_codegen_c2_ic_107)));
        } else {
            c_params = hexa_array_push(c_params, hexa_add(hexa_add(c_typ, hexa_str(" ")), hexa_map_get_ic(p, "name", &__hexa_codegen_c2_ic_108)));
        }
        i = hexa_add(i, hexa_int(1));
    }
    ...
    HexaVal parts = hexa_array_new();
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_109), hexa_str("")))))) {
        parts = hexa_array_push(parts, hexa_add(hexa_add(hexa_str("// link: -l"), hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_110)), hexa_str("\n")));
    }
...
HexaVal gen2_extern_includes(HexaVal ast) {
    ...
    HexaVal i = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(ast))))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_index_get(ast, i), "kind", &__hexa_codegen_c2_ic_111), hexa_str("ExternFnDecl")))) {
            has_extern = hexa_int(1);
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_index_get(ast, i), "op", &__hexa_codegen_c2_ic_112), hexa_str("m"))) || hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_index_get(ast, i), "op", &__hexa_codegen_c2_ic_113), hexa_str("libm")))))) {
                needs_math = hexa_int(1);
            }
            HexaVal j = hexa_int(0);
            while (HX_BOOL(hexa_cmp_lt(j, hexa_int(hexa_len(hexa_map_get_ic(hexa_index_get(ast, i), "params", &__hexa_codegen_c2_ic_114)))))) {
                HexaVal t = hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(hexa_index_get(ast, i), "params", &__hexa_codegen_c2_ic_115), j), "value", &__hexa_codegen_c2_ic_116);
            ...
            HexaVal rt = hexa_map_get_ic(hexa_index_get(ast, i), "ret_type", &__hexa_codegen_c2_ic_117);
...
HexaVal gen2_static_ffi_block(HexaVal ast) {
    ...
    HexaVal i = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(ast))))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_index_get(ast, i), "kind", &__hexa_codegen_c2_ic_118), hexa_str("ExternFnDecl")))) {
...
HexaVal gen2_extern_wrapper(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_119);
    HexaVal nargs = hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_120)));
    HexaVal ret_type = hexa_map_get_ic(node, "ret_type", &__hexa_codegen_c2_ic_121);
    HexaVal c_sym = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_122);
    ...
    while (HX_BOOL(hexa_cmp_lt(fi, nargs))) {
        fwd_params = hexa_array_push(fwd_params, hexa_add(hexa_str("HexaVal "), _hexa_mangle_ident(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_123), fi), "name", &__hexa_codegen_c2_ic_124))));
        fi = hexa_add(fi, hexa_int(1));
    }
    ...
    HexaVal has_float = gen2_has_float_param(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_125));
    ...
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(has_float, hexa_int(1))) || hexa_truthy(hexa_cmp_gt(nargs, hexa_int(0)))))) {
        ...
        while (HX_BOOL(hexa_cmp_lt(ti, nargs))) {
            typedef_params = hexa_array_push(typedef_params, gen2_ffi_c_type(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_126), ti), "value", &__hexa_codegen_c2_ic_127)));
        ...
        while (HX_BOOL(hexa_cmp_lt(ci, nargs))) {
            call_args = hexa_array_push(call_args, gen2_ffi_marshal_arg(_hexa_mangle_ident(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_128), ci), "name", &__hexa_codegen_c2_ic_129)), hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_130), ci), "value", &__hexa_codegen_c2_ic_131)));
            ci = hexa_add(ci, hexa_int(1));
        }
    ...
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_132), hexa_str("")))))) {
        lib_arg = hexa_add(hexa_add(hexa_str("\""), hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_133)), hexa_str("\""));
    }
...
HexaVal _gen2_collect_lets_stmt(HexaVal node, HexaVal names) {
    ...
    HexaVal sk = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_134);
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(sk, hexa_str("LetStmt"))) || hexa_truthy(hexa_eq(sk, hexa_str("LetMutStmt")))))) {
        names = hexa_array_push(names, hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_135));
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_136)), hexa_str("string")))))) {
        names = _gen2_collect_lets(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_137), names);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_138)), hexa_str("string")))))) {
        names = _gen2_collect_lets(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_139), names);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_140)), hexa_str("string")))))) {
        names = _gen2_collect_lets(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_141), names);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_142)), hexa_str("string")))))) {
        HexaVal ai = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(ai, hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_143)))))) {
            HexaVal arm = hexa_index_get(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_144), ai);
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(arm), hexa_str("string"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_145)), hexa_str("string")))))))) {
                names = _gen2_collect_lets(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_146), names);
            }
            ai = hexa_add(ai, hexa_int(1));
        }
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(sk, hexa_str("ExprStmt"))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_147)), hexa_str("string")))))))) {
        names = _gen2_collect_lets_stmt(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_148), names);
    }
    return __hexa_fn_arena_return(names);
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal gen2_stmt(HexaVal node, HexaVal depth) {
    ...
    __hexa_fn_arena_enter();
    HexaVal pad = gen2_indent(depth);
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_149);
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt")))))) {
        HexaVal init = hexa_str("hexa_void()");
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_150)), hexa_str("string")))))) {
            init = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_151));
        }
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetStmt"))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_152)), hexa_str("string")))))))) {
            if (hexa_truthy(_is_int_init_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_153)))) {
                _known_int_add(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_154));
            }
            if (hexa_truthy(_is_float_init_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_155)))) {
                _known_float_add(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_156));
            }
        }
        /* 2026-04-19: local let decls mangle through _hexa_mangle_ident so
           names in the reserved set (fmax, j1, argv, printf, …) match the
           Ident-reference mangling at every read site. */
        HexaVal _local_name = _hexa_mangle_ident(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_158));
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt"))) && hexa_truthy(hexa_eq(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_157), hexa_str("__reg_promote__")))))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("register HexaVal ")), _local_name), hexa_str(" = ")), init), hexa_str("; /* reg-promoted */\n")));
        }
        if (hexa_truthy(_gen2_has_decl(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_159)))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(pad, _local_name), hexa_str(" = ")), init), hexa_str(";\n")));
        }
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("HexaVal ")), _local_name), hexa_str(" = ")), init), hexa_str(";\n")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ConstStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_162)), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_163))), hexa_str(";\n")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("AssignStmt")))) {
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_164)), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_165), "kind", &__hexa_codegen_c2_ic_166), hexa_str("Index")))))) {
            HexaVal idx = gen2_expr(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_167), "right", &__hexa_codegen_c2_ic_168));
            val = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_169));
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_170), "left", &__hexa_codegen_c2_ic_171)), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_172), "left", &__hexa_codegen_c2_ic_173), "kind", &__hexa_codegen_c2_ic_174), hexa_str("Index")))))) {
                HexaVal outer_container = gen2_expr(hexa_map_get_ic(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_175), "left", &__hexa_codegen_c2_ic_176), "left", &__hexa_codegen_c2_ic_177));
                HexaVal outer_idx = gen2_expr(hexa_map_get_ic(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_178), "left", &__hexa_codegen_c2_ic_179), "right", &__hexa_codegen_c2_ic_180));
            ...
            HexaVal container = gen2_expr(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_181), "left", &__hexa_codegen_c2_ic_182));
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_183)), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_184), "kind", &__hexa_codegen_c2_ic_185), hexa_str("Field")))))) {
            HexaVal obj = gen2_expr(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_186), "left", &__hexa_codegen_c2_ic_187));
            HexaVal field = hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_188), "name", &__hexa_codegen_c2_ic_189);
            val = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_190));
        ...
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(pad, gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_191))), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_192))), hexa_str(";\n")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("CompoundAssign")))) {
        HexaVal op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_193);
        if (hexa_truthy(hexa_eq(op, hexa_str("+=")))) {
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_194)), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_195), "kind", &__hexa_codegen_c2_ic_196), hexa_str("BinaryOp"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_197), "op", &__hexa_codegen_c2_ic_198), hexa_str("*")))))) {
                lhs = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_199));
                HexaVal fa = gen2_expr(hexa_map_get_ic(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_200), "left", &__hexa_codegen_c2_ic_201));
                HexaVal fb = gen2_expr(hexa_map_get_ic(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_202), "right", &__hexa_codegen_c2_ic_203));
        ...
        lhs = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_204));
        HexaVal rhs = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_205));
        if (hexa_truthy(hexa_eq(op, hexa_str("+=")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ReturnStmt")))) {
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_206)), hexa_str("string")))))) {
            if (hexa_truthy(hexa_eq(_gen2_arena_wrap, hexa_int(1)))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("return __hexa_fn_arena_return(")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_207))), hexa_str(");\n")));
            }
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("return ")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_208))), hexa_str(";\n")));
        }
        if (hexa_truthy(hexa_eq(_gen2_arena_wrap, hexa_int(1)))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ExprStmt")))) {
        HexaVal expr = hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_209);
        if (hexa_truthy(hexa_eq(hexa_type_of(expr), hexa_str("string")))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(expr, "kind", &__hexa_codegen_c2_ic_210), hexa_str("MatchExpr")))) {
            return __hexa_fn_arena_return(gen2_match_stmt(expr, depth));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(expr, "kind", &__hexa_codegen_c2_ic_211), hexa_str("IfExpr")))) {
            chunks = hexa_array_new();
            chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(pad, hexa_str("if (hexa_truthy(")), gen2_expr(hexa_map_get_ic(expr, "cond", &__hexa_codegen_c2_ic_212))), hexa_str(")) {\n")));
            ti = hexa_int(0);
            while (HX_BOOL(hexa_cmp_lt(ti, hexa_int(hexa_len(hexa_map_get_ic(expr, "then_body", &__hexa_codegen_c2_ic_213)))))) {
                chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(expr, "then_body", &__hexa_codegen_c2_ic_214), ti), hexa_add(depth, hexa_int(1))));
                ti = hexa_add(ti, hexa_int(1));
            }
            chunks = hexa_array_push(chunks, hexa_add(pad, hexa_str("}")));
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(expr, "else_body", &__hexa_codegen_c2_ic_215)), hexa_str("string"))))) && hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(hexa_map_get_ic(expr, "else_body", &__hexa_codegen_c2_ic_216))), hexa_int(0)))))) {
                chunks = hexa_array_push(chunks, hexa_str(" else {\n"));
                HexaVal ei = hexa_int(0);
                while (HX_BOOL(hexa_cmp_lt(ei, hexa_int(hexa_len(hexa_map_get_ic(expr, "else_body", &__hexa_codegen_c2_ic_217)))))) {
                    chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(expr, "else_body", &__hexa_codegen_c2_ic_218), ei), hexa_add(depth, hexa_int(1))));
                    ei = hexa_add(ei, hexa_int(1));
                }
                chunks = hexa_array_push(chunks, hexa_add(pad, hexa_str("}")));
            }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("WhileStmt")))) {
        chunks = hexa_array_new();
        HexaVal cond_c = _gen2_while_cond(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_219));
        chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(pad, hexa_str("while (")), cond_c), hexa_str(") {\n")));
        HexaVal wi = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(wi, hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_220)))))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_221), wi), hexa_add(depth, hexa_int(1))));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ForStmt")))) {
        iter = hexa_map_get_ic(node, "iter_expr", &__hexa_codegen_c2_ic_222);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(iter), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(iter, "kind", &__hexa_codegen_c2_ic_223), hexa_str("Range")))))) {
            HexaVal s = gen2_expr(hexa_map_get_ic(iter, "left", &__hexa_codegen_c2_ic_224));
            HexaVal e = gen2_expr(hexa_map_get_ic(iter, "right", &__hexa_codegen_c2_ic_225));
            pad2 = gen2_indent(hexa_add(depth, hexa_int(1)));
            chunks = hexa_array_new();
            chunks = hexa_array_push(chunks, hexa_add(pad, hexa_str("{\n")));
            HexaVal _ei = _is_known_int(hexa_map_get_ic(iter, "right", &__hexa_codegen_c2_ic_226));
            ...
            chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad2, hexa_str("int64_t __hx_ne_")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_227)), hexa_str(" = ")), e_extract), hexa_str(";\n")));
            chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad2, hexa_str("for (int64_t __hx_ni_")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_228)), hexa_str(" = HX_INT(")), s), hexa_str("); __hx_ni_")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_229)), hexa_str(" < __hx_ne_")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_230)), hexa_str("; __hx_ni_")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_231)), hexa_str("++) {\n")));
            pad3 = gen2_indent(hexa_add(depth, hexa_int(2)));
            chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad3, hexa_str("HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_232)), hexa_str(" = hexa_int(__hx_ni_")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_233)), hexa_str(");\n")));
            _known_int_add(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_234));
            fi = hexa_int(0);
            while (HX_BOOL(hexa_cmp_lt(fi, hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_235)))))) {
                chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_236), fi), hexa_add(depth, hexa_int(2))));
                fi = hexa_add(fi, hexa_int(1));
            }
        ...
        pad3 = gen2_indent(hexa_add(depth, hexa_int(2)));
        chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(pad3, hexa_str("HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_237)), hexa_str(" = hexa_iter_get(__iter_arr, __fi);\n")));
        fi = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(fi, hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_238)))))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_239), fi), hexa_add(depth, hexa_int(2))));
            fi = hexa_add(fi, hexa_int(1));
        }
        chunks = hexa_array_push(chunks, hexa_add(pad2, hexa_str("}\n")));
        chunks = hexa_array_push(chunks, hexa_add(pad, hexa_str("}\n")));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ForDestructStmt")))) {
        iter = hexa_map_get_ic(node, "iter_expr", &__hexa_codegen_c2_ic_240);
        iter_c = gen2_expr(iter);
        HexaVal destruct_names = hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_241);
        ...
        while (HX_BOOL(hexa_cmp_lt(fi, hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_242)))))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_243), fi), hexa_add(depth, hexa_int(2))));
            fi = hexa_add(fi, hexa_int(1));
        }
        chunks = hexa_array_push(chunks, hexa_add(pad2, hexa_str("}\n")));
        chunks = hexa_array_push(chunks, hexa_add(pad, hexa_str("}\n")));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("AssertStmt")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("if (!hexa_truthy(")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_244))), hexa_str(")) { fprintf(stderr, \"assertion failed\\n\"); exit(1); }\n")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ThrowStmt")))) {
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_245)), hexa_str("string")))))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(pad, hexa_str("hexa_throw(")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_246))), hexa_str(");\n")));
        }
    ...
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("TryCatchStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("TryCatch")))))) {
        HexaVal try_body = hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_247);
        HexaVal catch_body = hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_248);
        HexaVal catch_var = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_249);
        chunks = hexa_array_new();
        chunks = hexa_array_push(chunks, hexa_add(pad, hexa_str("{\n")));
        pad2 = gen2_indent(hexa_add(depth, hexa_int(1)));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("LoopStmt")))) {
        ...
        while (HX_BOOL(hexa_cmp_lt(li, hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_250)))))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_251), li), hexa_add(depth, hexa_int(1))));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("GuardStmt")))) {
        chunks = hexa_array_new();
        chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(pad, hexa_str("if (!hexa_truthy(")), gen2_expr(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_252))), hexa_str(")) {\n")));
        HexaVal gi = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(gi, hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_253)))))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_254), gi), hexa_add(depth, hexa_int(1))));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("GuardLetStmt")))) {
        chunks = hexa_array_new();
        chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_255)), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_256))), hexa_str(";\n")));
        chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(pad, hexa_str("if (!hexa_truthy(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_257)), hexa_str(")) {\n")));
        HexaVal gli = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(gli, hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_258)))))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_259), gli), hexa_add(depth, hexa_int(1))));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeConst")))) {
        HexaVal _cc_local = comptime_eval(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_260));
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(_cc_local), hexa_str("string")))))) {
            _register_comptime_const(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_261), _cc_local);
            return __hexa_fn_arena_return(hexa_str(""));
        }
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_262)), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_263))), hexa_str(";\n")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("OptimizeFnStmt")))) {
        return __hexa_fn_arena_return(hexa_str(""));
    }
...
HexaVal gen2_expr(HexaVal node) {
    ...
    HexaVal a = hexa_void();
    HexaVal b = hexa_void();
    HexaVal c_tensor_arg = hexa_void();
    HexaVal d_tensor_arg = hexa_void();
    HexaVal e_tensor_arg = hexa_void();
    ...
    __hexa_fn_arena_enter();
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_264);
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_int("), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_265)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_float("), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_266)), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BoolLit")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_267), hexa_str("true")))) {
            return __hexa_fn_arena_return(hexa_str("hexa_bool(1)"));
        }
        return __hexa_fn_arena_return(hexa_str("hexa_bool(0)"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StringLit")))) {
        return __hexa_fn_arena_return(_strlit_dedup(c_escape(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_268))));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("CharLit")))) {
        return __hexa_fn_arena_return(_strlit_dedup(c_escape(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_269))));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        HexaVal _cc_inline = _lookup_comptime_const(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_270));
        ...
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_271), hexa_str("nil")))) {
            return __hexa_fn_arena_return(hexa_str("hexa_void()"));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_272), hexa_str("void")))) {
            return __hexa_fn_arena_return(hexa_str("hexa_void()"));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_273), hexa_str("true")))) {
            return __hexa_fn_arena_return(hexa_str("hexa_bool(1)"));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_274), hexa_str("false")))) {
            return __hexa_fn_arena_return(hexa_str("hexa_bool(0)"));
        }
        return __hexa_fn_arena_return(_hexa_mangle_ident(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_275)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
        HexaVal op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_276);
        HexaVal _lk = hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_277), "kind", &__hexa_codegen_c2_ic_278);
        HexaVal _rk = hexa_map_get_ic(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_279), "kind", &__hexa_codegen_c2_ic_280);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(_lk, hexa_str("IntLit"))) && hexa_truthy(hexa_eq(_rk, hexa_str("IntLit")))))) {
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("+"))) || hexa_truthy(hexa_eq(op, hexa_str("-"))))) || hexa_truthy(hexa_eq(op, hexa_str("*"))))) || hexa_truthy(hexa_eq(op, hexa_str("/"))))) || hexa_truthy(hexa_eq(op, hexa_str("%"))))) || hexa_truthy(hexa_eq(op, hexa_str("&"))))) || hexa_truthy(hexa_eq(op, hexa_str("|"))))) || hexa_truthy(hexa_eq(op, hexa_str("^"))))) || hexa_truthy(hexa_eq(op, hexa_str("<<"))))) || hexa_truthy(hexa_eq(op, hexa_str(">>")))))) {
                _lv = hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_281), "value", &__hexa_codegen_c2_ic_282);
                _rv = hexa_map_get_ic(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_283), "value", &__hexa_codegen_c2_ic_284);
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(_lk, hexa_str("FloatLit"))) && hexa_truthy(hexa_eq(_rk, hexa_str("FloatLit")))))) {
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("+"))) || hexa_truthy(hexa_eq(op, hexa_str("-"))))) || hexa_truthy(hexa_eq(op, hexa_str("*"))))) || hexa_truthy(hexa_eq(op, hexa_str("/"))))) || hexa_truthy(hexa_eq(op, hexa_str("%")))))) {
                _lv = hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_285), "value", &__hexa_codegen_c2_ic_286);
                _rv = hexa_map_get_ic(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_287), "value", &__hexa_codegen_c2_ic_288);
        ...
        HexaVal _li = _is_known_int(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_289));
        HexaVal _ri = _is_known_int(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_290));
        if (hexa_truthy(hexa_bool(hexa_truthy(_li) && hexa_truthy(_ri)))) {
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("+"))) || hexa_truthy(hexa_eq(op, hexa_str("-"))))) || hexa_truthy(hexa_eq(op, hexa_str("*"))))) || hexa_truthy(hexa_eq(op, hexa_str("/"))))) || hexa_truthy(hexa_eq(op, hexa_str("%"))))) || hexa_truthy(hexa_eq(op, hexa_str("&"))))) || hexa_truthy(hexa_eq(op, hexa_str("|"))))) || hexa_truthy(hexa_eq(op, hexa_str("^"))))) || hexa_truthy(hexa_eq(op, hexa_str("<<"))))) || hexa_truthy(hexa_eq(op, hexa_str(">>")))))) {
                l = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_291));
                r = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_292));
            ...
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("<"))) || hexa_truthy(hexa_eq(op, hexa_str(">"))))) || hexa_truthy(hexa_eq(op, hexa_str("<="))))) || hexa_truthy(hexa_eq(op, hexa_str(">="))))) || hexa_truthy(hexa_eq(op, hexa_str("=="))))) || hexa_truthy(hexa_eq(op, hexa_str("!=")))))) {
                l = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_293));
                r = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_294));
        ...
        HexaVal _lf = _is_known_float(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_295));
        HexaVal _rf = _is_known_float(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_296));
        if (hexa_truthy(hexa_bool(hexa_truthy(_lf) && hexa_truthy(_rf)))) {
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("+"))) || hexa_truthy(hexa_eq(op, hexa_str("-"))))) || hexa_truthy(hexa_eq(op, hexa_str("*"))))) || hexa_truthy(hexa_eq(op, hexa_str("/"))))) || hexa_truthy(hexa_eq(op, hexa_str("%")))))) {
                l = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_297));
                r = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_298));
            ...
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("<"))) || hexa_truthy(hexa_eq(op, hexa_str(">"))))) || hexa_truthy(hexa_eq(op, hexa_str("<="))))) || hexa_truthy(hexa_eq(op, hexa_str(">="))))) || hexa_truthy(hexa_eq(op, hexa_str("=="))))) || hexa_truthy(hexa_eq(op, hexa_str("!=")))))) {
                l = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_299));
                r = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_300));
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("+"))) || hexa_truthy(hexa_eq(op, hexa_str("-")))))) {
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_301)), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_302), "kind", &__hexa_codegen_c2_ic_303), hexa_str("BinaryOp"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_304), "op", &__hexa_codegen_c2_ic_305), hexa_str("*")))))) {
                HexaVal fa = gen2_expr(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_306), "left", &__hexa_codegen_c2_ic_307));
                fb = gen2_expr(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_308), "right", &__hexa_codegen_c2_ic_309));
                HexaVal fc = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_310));
                if (hexa_truthy(hexa_eq(op, hexa_str("+")))) {
        ...
        r = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_312));
        if (hexa_truthy(hexa_eq(op, hexa_str("+")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_313), hexa_str("-"))) && hexa_truthy(_is_known_float(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_314)))))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_float(-HX_FLOAT("), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_315))), hexa_str("))")));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_316), hexa_str("-")))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_sub(hexa_int(0), "), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_317))), hexa_str(")")));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_318), hexa_str("!")))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_bool(!hexa_truthy("), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_319))), hexa_str("))")));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_320), hexa_str("~")))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_int(~hexa_as_num("), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_321))), hexa_str("))")));
        }
        (hexa_eprint_val(hexa_add(hexa_str("[codegen_c2] ERROR: unhandled unary operator: "), hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_322))), fprintf(stderr, "\n"), hexa_void());
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("(fprintf(stderr, \"CODEGEN ERROR: unhandled unary op: "), hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_323)), hexa_str("\\n\"), exit(1), hexa_void())")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Field")))) {
        obj = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_324));
        HexaVal field = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_325);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("StructInit")))) {
        ...
        while (HX_BOOL(hexa_cmp_lt(si, hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_327)))))) {
            arg_strs = hexa_array_push(arg_strs, gen2_expr(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_328), si), "left", &__hexa_codegen_c2_ic_329)));
            si = hexa_add(si, hexa_int(1));
        }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Call")))) {
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(callee), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(callee, "kind", &__hexa_codegen_c2_ic_331), hexa_str("Ident")))))) {
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("to_string")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_to_string("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_338), hexa_int(0)))), hexa_str(")")));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("floor")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_floor("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_341), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ceil")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_ceil("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_342), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("abs")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_abs("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_343), hexa_int(0)))), hexa_str(")")));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("cos")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_349), hexa_int(0)));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("pow")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_pow("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_350), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_351), hexa_int(1)))), hexa_str(")")));
            }
            ...
            /* FIX-A (Anima ML eval unblock, 2026-04-19): 8 tensor_* / rms_norm / softmax / matmul fallback builtins */
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("tensor_slice")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(0)));
                b = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(1)));
                c_tensor_arg = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(2)));
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_slice("), a), hexa_str(", ")), b), hexa_str(", ")), c_tensor_arg), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("tensor_add")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(0)));
                b = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(1)));
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_add("), a), hexa_str(", ")), b), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("tensor_dot")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(0)));
                b = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(1)));
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_dot("), a), hexa_str(", ")), b), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("tensor_mul_scalar")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(0)));
                b = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(1)));
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_mul_scalar("), a), hexa_str(", ")), b), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("rms_norm")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(0)));
                b = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(1)));
                c_tensor_arg = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(2)));
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_rms_norm("), a), hexa_str(", ")), b), hexa_str(", ")), c_tensor_arg), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("softmax")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(0)));
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_softmax("), a), hexa_str(")")));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("format")))) {
                ...
                while (HX_BOOL(hexa_cmp_lt(fi, hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_357)))))) {
                    fmt_args = hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_push("), fmt_args), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_358), fi))), hexa_str(")"));
                    fi = hexa_add(fi, hexa_int(1));
                }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("exec")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_exec("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_362), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("exec_with_status")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_exec_with_status("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_363), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("to_int")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_364), hexa_int(0)));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("max")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_367), hexa_int(0)));
                b = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_368), hexa_int(1)));
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("({ int64_t __a = hexa_as_num("), a), hexa_str("); int64_t __b = hexa_as_num(")), b), hexa_str("); hexa_int(__a > __b ? __a : __b); })")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("read_file")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_read_file("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_369), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_file")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_write_file("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_370), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_371), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_bytes")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_write_bytes("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_372), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_373), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_bytes_v")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_write_bytes_v("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_374), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_375), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("read_file_bytes")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_read_file_bytes("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_376), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("read_bytes_at")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_read_bytes_at("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_377), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_378), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_379), hexa_int(2)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_bytes_append")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_write_bytes_append("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_380), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_381), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_bytes_append_v")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_write_bytes_append_v("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_382), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_383), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("file_size_native")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_file_size("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_384), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("net_listen")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_net_listen("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_385), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("net_accept")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_net_accept("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_386), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("net_close")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_net_close("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_387), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("net_connect")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_net_connect("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_388), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("net_read")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_net_read("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_389), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("net_write")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_net_write("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_390), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_391), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("cstring")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_cstring("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_392), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("from_cstring")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_from_cstring("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_393), hexa_int(0)))), hexa_str(")")));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_addr")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_ptr_addr("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_394), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("host_ffi_open")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_host_ffi_open("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_395), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("host_ffi_sym")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_host_ffi_sym("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_396), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_397), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("host_ffi_call")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_host_ffi_call("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_398), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_399), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_400), hexa_int(2)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_401), hexa_int(3)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("host_ffi_call_6")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_host_ffi_call_6("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_402), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_403), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_404), hexa_int(2)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_405), hexa_int(3)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_406), hexa_int(4)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_407), hexa_int(5)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_408), hexa_int(6)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_409), hexa_int(7)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_410), hexa_int(8)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_411), hexa_int(9)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("callback_create")))) {
                HexaVal arg = hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_412), hexa_int(0));
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(arg), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(arg, "kind", &__hexa_codegen_c2_ic_413), hexa_str("Ident")))))) {
                    HexaVal fn_name = hexa_map_get_ic(arg, "name", &__hexa_codegen_c2_ic_414);
                    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_callback_create(hexa_fn_new((void*)"), fn_name), hexa_str(", 0))")));
                }
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_callback_create("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_415), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("callback_free")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_callback_free("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_416), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("callback_slot_id")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_callback_slot_id("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_417), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_alloc")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_ptr_alloc("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_418), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_free")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_free("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_419), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_420), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_write")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_421), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_422), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_423), hexa_int(2)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_write_f32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write_f32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_424), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_425), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_426), hexa_int(2)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_write_i32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write_i32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_427), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_428), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_429), hexa_int(2)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_read")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_430), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_431), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_read_f64")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read_f64("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_432), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_433), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_read_f32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read_f32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_434), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_435), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_read_i32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read_i32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_436), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_437), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_offset")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_offset("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_438), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_439), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("deref")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_deref("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_440), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("__prefetch")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_441), hexa_int(0)));
                b = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_442), hexa_int(1)));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_pack")))) {
                ...
                si = hexa_int(0);
                while (HX_BOOL(hexa_cmp_lt(si, hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_443)))))) {
                    a_strs = hexa_array_push(a_strs, gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_444), si)));
                    si = hexa_add(si, hexa_int(1));
                }
                n = hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_445))));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_pack_f32")))) {
                a_strs = hexa_array_new();
                si = hexa_int(0);
                while (HX_BOOL(hexa_cmp_lt(si, hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_446)))))) {
                    a_strs = hexa_array_push(a_strs, gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_447), si)));
                    si = hexa_add(si, hexa_int(1));
                }
                n = hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_448))));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_unpack")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_unpack("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_449), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_450), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_unpack_f32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_unpack_f32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_451), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_452), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_rect")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_rect("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_453), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_454), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_455), hexa_int(2)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_456), hexa_int(3)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_point")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_point("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_457), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_458), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_size")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_size_pack("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_459), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_460), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_free")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_struct_free("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_461), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("alloc_raw")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_ptr_alloc("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_462), hexa_int(0)))), hexa_str(")")));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("write_i32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write_i32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_467), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_468), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_469), hexa_int(2)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_i64")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_470), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_471), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_472), hexa_int(2)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("deref_f32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read_f32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_473), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_474), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("deref_i32")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read_i32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_475), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_476), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_from_int")))) {
                return __hexa_fn_arena_return(gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_477), hexa_int(0))));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("int")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_478), hexa_int(0)));
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_int((HX_IS_STR("), a), hexa_str(")?atoll(hexa_to_cstring(")), a), hexa_str(")):(int64_t)__hx_to_double(")), a), hexa_str(")))")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("str")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_to_string("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_479), hexa_int(0)))), hexa_str(")")));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("tensor")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_new("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_480), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_481), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("randn")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_randn("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_482), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_483), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("tensor_data_f32_ptr")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_tensor_data_ptr("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_484), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("tensor_from_f32_ptr")))) {
                if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_485))), hexa_int(2)))) {
                    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_from_ptr("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_486), hexa_int(0)))), hexa_str(", hexa_int(1), ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_487), hexa_int(1)))), hexa_str(")")));
                }
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_from_ptr("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_488), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_489), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_490), hexa_int(2)))), hexa_str(")")));
            }
            arg_strs = hexa_array_new();
            ai = hexa_int(0);
            while (HX_BOOL(hexa_cmp_lt(ai, hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_491)))))) {
                HexaVal _arg = hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_492), ai);
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(_arg), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(_arg, "kind", &__hexa_codegen_c2_ic_493), hexa_str("Ident"))))) && hexa_truthy(_is_known_fn_global(hexa_map_get_ic(_arg, "name", &__hexa_codegen_c2_ic_494)))))) {
                    arg_strs = hexa_array_push(arg_strs, hexa_add(hexa_add(hexa_str("hexa_fn_new((void*)"), _hexa_mangle_ident(hexa_map_get_ic(_arg, "name", &__hexa_codegen_c2_ic_495))), hexa_str(", 0)")));
                } else {
            ...
            if (hexa_truthy(hexa_cmp_ge(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_496))), hexa_int(2)))) {
            ...
            if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_497))), hexa_int(0)))) {
            ...
            if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_498))), hexa_int(1)))) {
            ...
            if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_499))), hexa_int(2)))) {
            ...
            if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_500))), hexa_int(4)))) {
            ...
            nargs = hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_501)));
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(callee), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(callee, "kind", &__hexa_codegen_c2_ic_502), hexa_str("Field")))))) {
            obj = gen2_expr(hexa_map_get_ic(callee, "left", &__hexa_codegen_c2_ic_503));
            HexaVal method = hexa_map_get_ic(callee, "name", &__hexa_codegen_c2_ic_504);
            ...
            if (hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(user_types)), hexa_int(0)))) {
                ...
                while (HX_BOOL(hexa_cmp_lt(uai, hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_505)))))) {
                    u_args = hexa_array_push(u_args, gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_506), uai)));
                    uai = hexa_add(uai, hexa_int(1));
                }
                HexaVal u_arg_tail = hexa_str_join(u_args, hexa_str(", "));
                HexaVal __saved_obj = obj;
                fb = gen2_method_builtin(hexa_str("__mr"), method, hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_507));
                HexaVal chain = fb;
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("contains")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_str_contains("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_509), hexa_int(0)))), hexa_str("))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("join")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_join("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_510), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("to_upper")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("split")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_split("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_511), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("trim")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_str_trim("), obj), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("replace")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_replace("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_512), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_513), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("repeat")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_repeat("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_514), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("starts_with")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_str_starts_with("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_515), hexa_int(0)))), hexa_str("))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("ends_with")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_str_ends_with("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_516), hexa_int(0)))), hexa_str("))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("substring")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_substring("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_517), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_518), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("index_of")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_int(hexa_str_index_of("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_519), hexa_int(0)))), hexa_str("))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("keys")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("contains_key")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_map_contains_key("), obj), hexa_str(", hexa_to_cstring(")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_520), hexa_int(0)))), hexa_str(")))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("has_key")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_map_contains_key("), obj), hexa_str(", hexa_to_cstring(")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_521), hexa_int(0)))), hexa_str(")))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("remove")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_map_remove("), obj), hexa_str(", hexa_to_cstring(")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_522), hexa_int(0)))), hexa_str("))")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("pop")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("truncate")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_truncate("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_523), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("push_nostat")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_push_nostat("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_524), hexa_int(0)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("trim_start")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("slice")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_slice("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_525), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_526), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("slice_fast")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_slice_fast("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_527), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_528), hexa_int(1)))), hexa_str(")")));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("to_string")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("pad_left")))) {
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_pad_left("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_529), hexa_int(0)))), hexa_str(")")));
            }
        ...
        nargs = hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_530)));
        HexaVal cargs = hexa_array_new();
        HexaVal ci = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(ci, nargs))) {
            HexaVal _ca = hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_531), ci);
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(_ca), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(_ca, "kind", &__hexa_codegen_c2_ic_532), hexa_str("Ident"))))) && hexa_truthy(_is_known_fn_global(hexa_map_get_ic(_ca, "name", &__hexa_codegen_c2_ic_533)))))) {
                cargs = hexa_array_push(cargs, hexa_add(hexa_add(hexa_str("hexa_fn_new((void*)"), _hexa_mangle_ident(hexa_map_get_ic(_ca, "name", &__hexa_codegen_c2_ic_534))), hexa_str(", 0)")));
            } else {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Array")))) {
        ...
        ai = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(ai, hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_535)))))) {
            out = hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_push("), out), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_536), ai))), hexa_str(")"));
            ai = hexa_add(ai, hexa_int(1));
        }
        return __hexa_fn_arena_return(out);
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Index")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_index_get("), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_537))), hexa_str(", ")), gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_538))), hexa_str(")")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumPath")))) {
        HexaVal ename = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_539);
        HexaVal vname = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_540);
        return __hexa_fn_arena_return(hexa_add(hexa_add(ename, hexa_str("_")), vname));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("IfExpr")))) {
        HexaVal c = gen2_expr(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_541));
        HexaVal t_val = hexa_str("hexa_void()");
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_542)), hexa_str("string"))))) && hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_543))), hexa_int(0)))))) {
            HexaVal t_last = hexa_index_get(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_544), hexa_sub(hexa_int(hexa_len(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_545))), hexa_int(1)));
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(t_last), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(t_last, "kind", &__hexa_codegen_c2_ic_546), hexa_str("ExprStmt"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(t_last, "left", &__hexa_codegen_c2_ic_547)), hexa_str("string")))))))) {
                t_val = gen2_expr(hexa_map_get_ic(t_last, "left", &__hexa_codegen_c2_ic_548));
            }
        }
        HexaVal e_val = hexa_str("hexa_void()");
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_549)), hexa_str("string"))))) && hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_550))), hexa_int(0)))))) {
            HexaVal e_last = hexa_index_get(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_551), hexa_sub(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_552))), hexa_int(1)));
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(e_last), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(e_last, "kind", &__hexa_codegen_c2_ic_553), hexa_str("ExprStmt"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(e_last, "left", &__hexa_codegen_c2_ic_554)), hexa_str("string")))))))) {
                e_val = gen2_expr(hexa_map_get_ic(e_last, "left", &__hexa_codegen_c2_ic_555));
            }
        }
    ...
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("Tuple"))) || hexa_truthy(hexa_eq(k, hexa_str("TupleLit")))))) {
        out = hexa_str("hexa_array_new()");
        HexaVal items = hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_556);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("MapLit")))) {
        ...
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_557)), hexa_str("string")))))) {
            HexaVal mi = hexa_int(0);
            while (HX_BOOL(hexa_cmp_lt(mi, hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_558)))))) {
                HexaVal entry = hexa_index_get(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_559), mi);
                HexaVal key_c = gen2_expr(hexa_map_get_ic(entry, "left", &__hexa_codegen_c2_ic_560));
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(entry, "left", &__hexa_codegen_c2_ic_561)), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(entry, "left", &__hexa_codegen_c2_ic_562), "kind", &__hexa_codegen_c2_ic_563), hexa_str("StringLit")))))) {
                    key_c = hexa_add(hexa_add(hexa_str("\""), c_escape(hexa_map_get_ic(hexa_map_get_ic(entry, "left", &__hexa_codegen_c2_ic_564), "value", &__hexa_codegen_c2_ic_565))), hexa_str("\""));
                }
                out = hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_map_set("), out), hexa_str(", ")), key_c), hexa_str(", ")), gen2_expr(hexa_map_get_ic(entry, "right", &__hexa_codegen_c2_ic_566))), hexa_str(")"));
                mi = hexa_add(mi, hexa_int(1));
            }
        }
        return __hexa_fn_arena_return(out);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("NegFloat")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_float(-HX_FLOAT("), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_567))), hexa_str("))")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Wildcard")))) {
...
HexaVal gen2_struct_forward(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_568);
    HexaVal nfields = hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_569)));
    ...
    while (HX_BOOL(hexa_cmp_lt(fi, nfields))) {
        params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_570), fi), "name", &__hexa_codegen_c2_ic_571)));
        fi = hexa_add(fi, hexa_int(1));
    }
...
HexaVal gen2_struct_decl(HexaVal node) {
    ...
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(name, hexa_str("Val"))) && hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_573))), hexa_int(12)))))) {
        HexaVal vs_params = hexa_array_new();
        HexaVal vs_args = hexa_array_new();
        HexaVal vi = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(vi, hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_574)))))) {
            HexaVal fname = hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_575), vi), "name", &__hexa_codegen_c2_ic_576);
    ...
    HexaVal nfields = hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_577)));
    HexaVal i = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(i, nfields))) {
        HexaVal f = hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_578), i);
        params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_579)));
        if (hexa_truthy(hexa_cmp_gt(i, hexa_int(0)))) {
            keys_parts = hexa_array_push(keys_parts, hexa_str(", "));
            vals_parts = hexa_array_push(vals_parts, hexa_str(", "));
        }
        keys_parts = hexa_array_push(keys_parts, hexa_add(hexa_add(hexa_str("\""), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_580)), hexa_str("\"")));
        vals_parts = hexa_array_push(vals_parts, hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_581));
        i = hexa_add(i, hexa_int(1));
    }
    HexaVal p = hexa_str_join(params, hexa_str(", "));
    HexaVal p_sig = p;
...
HexaVal gen2_struct_decl_aligned(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_582);
    HexaVal params = hexa_array_new();
    ...
    HexaVal i = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_583)))))) {
        HexaVal f = hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_584), i);
        params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_585)));
        body_parts = hexa_array_push(body_parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    __s = hexa_map_set(__s, \""), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_586)), hexa_str("\", ")), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_587)), hexa_str(");\n")));
        i = hexa_add(i, hexa_int(1));
    }
    HexaVal p = hexa_str_join(params, hexa_str(", "));
    if (hexa_truthy(hexa_eq(p, hexa_str("")))) {
...
HexaVal gen2_enum_decl(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_588);
    HexaVal vc = hexa_int(hexa_len(hexa_map_get_ic(node, "variants", &__hexa_codegen_c2_ic_589)));
    ...
    while (HX_BOOL(hexa_cmp_lt(i, vc))) {
        HexaVal v = hexa_index_get(hexa_map_get_ic(node, "variants", &__hexa_codegen_c2_ic_590), i);
        parts = hexa_array_push(parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("#define "), name), hexa_str("_")), hexa_map_get_ic(v, "name", &__hexa_codegen_c2_ic_591)), hexa_str(" hexa_int(")), hexa_to_string(i)), hexa_str(")\n")));
        i = hexa_add(i, hexa_int(1));
    }
    return __hexa_fn_arena_return(hexa_str_join(parts, hexa_str("")));
    return __hexa_fn_arena_return(hexa_void());
...
HexaVal gen2_match_stmt(HexaVal node, HexaVal depth) {
    __hexa_fn_arena_enter();
    HexaVal pad = gen2_indent(depth);
    HexaVal scrutinee = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_592));
    HexaVal chunks = hexa_array_new();
    chunks = hexa_array_push(chunks, hexa_add(pad, hexa_str("{\n")));
    ...
    HexaVal ai = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(ai, hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_593)))))) {
        HexaVal arm = hexa_index_get(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_594), ai);
        HexaVal pat = hexa_map_get_ic(arm, "left", &__hexa_codegen_c2_ic_595);
        HexaVal is_wildcard = hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(pat), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(pat, "kind", &__hexa_codegen_c2_ic_596), hexa_str("Wildcard"))));
        ...
        HexaVal bi = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(bi, hexa_int(hexa_len(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_597)))))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_598), bi), hexa_add(depth, hexa_int(2))));
            bi = hexa_add(bi, hexa_int(1));
        }
        chunks = hexa_array_push(chunks, hexa_add(pad2, hexa_str("}")));
        ai = hexa_add(ai, hexa_int(1));
...
HexaVal gen2_match_cond(HexaVal pat, HexaVal scrutinee_var) {
    ...
    HexaVal k = hexa_map_get_ic(pat, "kind", &__hexa_codegen_c2_ic_599);
    if (hexa_truthy(hexa_eq(k, hexa_str("Wildcard")))) {
        return __hexa_fn_arena_return(hexa_str("1"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_truthy(hexa_eq("), scrutinee_var), hexa_str(", hexa_int(")), hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_600)), hexa_str(")))")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_truthy(hexa_eq("), scrutinee_var), hexa_str(", hexa_float(")), hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_601)), hexa_str(")))")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StringLit")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_truthy(hexa_eq("), scrutinee_var), hexa_str(", hexa_str(\"")), c_escape(hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_602))), hexa_str("\")))")));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BoolLit")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_603), hexa_str("true")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumPath")))) {
        HexaVal enum_const = hexa_add(hexa_add(hexa_map_get_ic(pat, "name", &__hexa_codegen_c2_ic_604), hexa_str("_")), hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_605));
...
HexaVal gen2_match_expr(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal scrutinee = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_606));
    HexaVal arms = hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_607);
...
HexaVal gen2_match_ternary(HexaVal arms, HexaVal scrutinee_c, HexaVal idx) {
    ...
    HexaVal pat = hexa_map_get_ic(arm, "left", &__hexa_codegen_c2_ic_608);
    HexaVal is_wildcard = hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(pat), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(pat, "kind", &__hexa_codegen_c2_ic_609), hexa_str("Wildcard"))));
    HexaVal val = gen2_arm_value(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_610));
...
HexaVal gen2_arm_value(HexaVal body) {
    ...
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(last, "kind", &__hexa_codegen_c2_ic_611), hexa_str("ExprStmt")))) {
        return __hexa_fn_arena_return(gen2_expr(hexa_map_get_ic(last, "left", &__hexa_codegen_c2_ic_612)));
    }
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(last, "kind", &__hexa_codegen_c2_ic_613), hexa_str("ReturnStmt")))) {
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(last, "left", &__hexa_codegen_c2_ic_614)), hexa_str("string")))))) {
            return __hexa_fn_arena_return(gen2_expr(hexa_map_get_ic(last, "left", &__hexa_codegen_c2_ic_615)));
        }
    }
    return __hexa_fn_arena_return(hexa_str("hexa_void()"));
    return __hexa_fn_arena_return(hexa_void());
...
HexaVal gen2_impl_block(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal type_n = hexa_map_get_ic(node, "target", &__hexa_codegen_c2_ic_616);
    HexaVal fwd_chunks = hexa_array_new();
    HexaVal fn_chunks = hexa_array_new();
    HexaVal methods = hexa_map_get_ic(node, "methods", &__hexa_codegen_c2_ic_617);
    HexaVal mi = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(mi, hexa_int(hexa_len(methods))))) {
        HexaVal m = hexa_index_get(methods, mi);
        HexaVal mangled = hexa_add(hexa_add(type_n, hexa_str("__")), hexa_map_get_ic(m, "name", &__hexa_codegen_c2_ic_618));
        _method_registry = hexa_array_push(_method_registry, hexa_array_push(hexa_array_push(hexa_array_new(), hexa_map_get_ic(m, "name", &__hexa_codegen_c2_ic_619)), type_n));
        HexaVal params = hexa_array_new();
        HexaVal pi = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(pi, hexa_int(hexa_len(hexa_map_get_ic(m, "params", &__hexa_codegen_c2_ic_620)))))) {
            params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(m, "params", &__hexa_codegen_c2_ic_621), pi), "name", &__hexa_codegen_c2_ic_622)));
        ...
        HexaVal bi = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(bi, hexa_int(hexa_len(hexa_map_get_ic(m, "body", &__hexa_codegen_c2_ic_623)))))) {
            body_chunks = hexa_array_push(body_chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(m, "body", &__hexa_codegen_c2_ic_624), bi), hexa_int(1)));
            bi = hexa_add(bi, hexa_int(1));
        }
...
HexaVal _strlit_dedup(HexaVal escaped) {
    ...
    while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(_strlit_keys))))) {
        if (hexa_truthy(hexa_eq(hexa_index_get(_strlit_keys, i), escaped))) {
            return __hexa_fn_arena_return(hexa_add(hexa_str("__hexa_sl_"), hexa_to_string(hexa_index_get(_strlit_ids, i))));
        }
        i = hexa_add(i, hexa_int(1));
    }
    HexaVal id = _strlit_counter;
...
HexaVal _cf_as_float(HexaVal lit) {
    __hexa_fn_arena_enter();
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(lit, "kind", &__hexa_codegen_c2_ic_625), hexa_str("FloatLit")))) {
        return __hexa_fn_arena_return(hexa_float(__hx_to_double(hexa_map_get_ic(lit, "value", &__hexa_codegen_c2_ic_626))));
    }
    return __hexa_fn_arena_return(hexa_float(__hx_to_double(hexa_to_string(hexa_int((HX_IS_STR(hexa_map_get_ic(lit, "value", &__hexa_codegen_c2_ic_627))?atoll(hexa_to_cstring(hexa_map_get_ic(lit, "value", &__hexa_codegen_c2_ic_627))):(int64_t)__hx_to_double(hexa_map_get_ic(lit, "value", &__hexa_codegen_c2_ic_627))))))));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal comptime_eval(HexaVal node) {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_628);
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        return __hexa_fn_arena_return(_lookup_comptime_const(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_629)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_630);
        HexaVal v = comptime_eval(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_631));
        if (hexa_truthy(hexa_eq(hexa_type_of(v), hexa_str("string")))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        if (hexa_truthy(hexa_eq(op, hexa_str("-")))) {
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(v, "kind", &__hexa_codegen_c2_ic_632), hexa_str("IntLit")))) {
                HexaVal i = hexa_sub(hexa_int(0), hexa_int((HX_IS_STR(hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_633))?atoll(hexa_to_cstring(hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_633))):(int64_t)__hx_to_double(hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_633)))));
                return __hexa_fn_arena_return(_make_int_lit_node(hexa_to_string(i)));
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(v, "kind", &__hexa_codegen_c2_ic_634), hexa_str("FloatLit")))) {
                HexaVal f = hexa_sub(hexa_int(0), hexa_float(__hx_to_double(hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_635))));
                return __hexa_fn_arena_return(_make_float_lit_node(hexa_to_string(f)));
            }
            return __hexa_fn_arena_return(hexa_str(""));
        }
        if (hexa_truthy(hexa_eq(op, hexa_str("!")))) {
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(v, "kind", &__hexa_codegen_c2_ic_636), hexa_str("BoolLit")))) {
                return __hexa_fn_arena_return(_make_bool_lit_node(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_637), hexa_str("true"))))));
            }
            return __hexa_fn_arena_return(hexa_str(""));
        }
        return __hexa_fn_arena_return(hexa_str(""));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
        op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_638);
        if (hexa_truthy(hexa_eq(op, hexa_str("&&")))) {
            ll = comptime_eval(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_639));
            if (hexa_truthy(hexa_eq(hexa_type_of(ll), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(ll, "kind", &__hexa_codegen_c2_ic_640), hexa_str("BoolLit")))))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(ll, "value", &__hexa_codegen_c2_ic_641), hexa_str("true")))))) {
                return __hexa_fn_arena_return(_make_bool_lit_node(hexa_bool(0)));
            }
            rr = comptime_eval(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_642));
            if (hexa_truthy(hexa_eq(hexa_type_of(rr), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(rr, "kind", &__hexa_codegen_c2_ic_643), hexa_str("BoolLit")))))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            return __hexa_fn_arena_return(_make_bool_lit_node(hexa_eq(hexa_map_get_ic(rr, "value", &__hexa_codegen_c2_ic_644), hexa_str("true"))));
        }
        if (hexa_truthy(hexa_eq(op, hexa_str("||")))) {
            ll = comptime_eval(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_645));
            if (hexa_truthy(hexa_eq(hexa_type_of(ll), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(ll, "kind", &__hexa_codegen_c2_ic_646), hexa_str("BoolLit")))))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(ll, "value", &__hexa_codegen_c2_ic_647), hexa_str("true")))) {
                return __hexa_fn_arena_return(_make_bool_lit_node(hexa_bool(1)));
            }
            rr = comptime_eval(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_648));
            if (hexa_truthy(hexa_eq(hexa_type_of(rr), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(rr, "kind", &__hexa_codegen_c2_ic_649), hexa_str("BoolLit")))))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            return __hexa_fn_arena_return(_make_bool_lit_node(hexa_eq(hexa_map_get_ic(rr, "value", &__hexa_codegen_c2_ic_650), hexa_str("true"))));
        }
        HexaVal l = comptime_eval(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_651));
        if (hexa_truthy(hexa_eq(hexa_type_of(l), hexa_str("string")))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        HexaVal r = comptime_eval(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_652));
        if (hexa_truthy(hexa_eq(hexa_type_of(r), hexa_str("string")))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        HexaVal lk = hexa_map_get_ic(l, "kind", &__hexa_codegen_c2_ic_653);
        HexaVal rk = hexa_map_get_ic(r, "kind", &__hexa_codegen_c2_ic_654);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("=="))) || hexa_truthy(hexa_eq(op, hexa_str("!="))))) || hexa_truthy(hexa_eq(op, hexa_str("<"))))) || hexa_truthy(hexa_eq(op, hexa_str(">"))))) || hexa_truthy(hexa_eq(op, hexa_str("<="))))) || hexa_truthy(hexa_eq(op, hexa_str(">=")))))) {
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(lk, hexa_str("StringLit"))) && hexa_truthy(hexa_eq(rk, hexa_str("StringLit")))))) {
                if (hexa_truthy(hexa_eq(op, hexa_str("==")))) {
                    return __hexa_fn_arena_return(_make_bool_lit_node(hexa_eq(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_655), hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_656))));
                }
                if (hexa_truthy(hexa_eq(op, hexa_str("!=")))) {
                    return __hexa_fn_arena_return(_make_bool_lit_node(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_657), hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_658))))));
                }
                return __hexa_fn_arena_return(hexa_str(""));
            }
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(lk, hexa_str("BoolLit"))) && hexa_truthy(hexa_eq(rk, hexa_str("BoolLit")))))) {
                if (hexa_truthy(hexa_eq(op, hexa_str("==")))) {
                    return __hexa_fn_arena_return(_make_bool_lit_node(hexa_eq(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_659), hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_660))));
                }
                if (hexa_truthy(hexa_eq(op, hexa_str("!=")))) {
                    return __hexa_fn_arena_return(_make_bool_lit_node(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_661), hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_662))))));
                }
                return __hexa_fn_arena_return(hexa_str(""));
            }
            ...
            HexaVal li_c = hexa_int((HX_IS_STR(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_663))?atoll(hexa_to_cstring(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_663))):(int64_t)__hx_to_double(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_663))));
            HexaVal ri_c = hexa_int((HX_IS_STR(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_664))?atoll(hexa_to_cstring(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_664))):(int64_t)__hx_to_double(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_664))));
            if (hexa_truthy(hexa_eq(op, hexa_str("==")))) {
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("+"))) && hexa_truthy(hexa_eq(lk, hexa_str("StringLit"))))) && hexa_truthy(hexa_eq(rk, hexa_str("StringLit")))))) {
            return __hexa_fn_arena_return(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("StringLit")), "name", hexa_str("")), "value", hexa_add(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_665), hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_666))), "op", hexa_str("")), "left", hexa_str("")), "right", hexa_str("")), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str("")));
        }
        ...
        HexaVal li = hexa_int((HX_IS_STR(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_667))?atoll(hexa_to_cstring(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_667))):(int64_t)__hx_to_double(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_667))));
        HexaVal ri = hexa_int((HX_IS_STR(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_668))?atoll(hexa_to_cstring(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_668))):(int64_t)__hx_to_double(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_668))));
        if (hexa_truthy(hexa_eq(op, hexa_str("+")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("IfExpr")))) {
        HexaVal c = comptime_eval(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_669));
        if (hexa_truthy(hexa_eq(hexa_type_of(c), hexa_str("string")))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(c, "kind", &__hexa_codegen_c2_ic_670), hexa_str("BoolLit")))))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        HexaVal pick_true = hexa_eq(hexa_map_get_ic(c, "value", &__hexa_codegen_c2_ic_671), hexa_str("true"));
        HexaVal body = (hexa_truthy(pick_true) ? hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_672) : hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_673));
        ...
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(last, "kind", &__hexa_codegen_c2_ic_674), hexa_str("ExprStmt")))))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(last, "left", &__hexa_codegen_c2_ic_675)), hexa_str("string")))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        return __hexa_fn_arena_return(comptime_eval(hexa_map_get_ic(last, "left", &__hexa_codegen_c2_ic_676)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Call")))) {
        HexaVal fname = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_677);
        if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_678)), hexa_str("string")))) {
            return __hexa_fn_arena_return(hexa_str(""));
        }
        HexaVal nargs = hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_679)));
        if (hexa_truthy(hexa_eq(nargs, hexa_int(1)))) {
            HexaVal a = comptime_eval(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_680), hexa_int(0)));
            if (hexa_truthy(hexa_eq(hexa_type_of(a), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            HexaVal ak = hexa_map_get_ic(a, "kind", &__hexa_codegen_c2_ic_681);
            ...
            if (hexa_truthy(hexa_eq(fname, hexa_str("abs")))) {
                if (hexa_truthy(hexa_eq(ak, hexa_str("IntLit")))) {
                    HexaVal iv = hexa_int((HX_IS_STR(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_682))?atoll(hexa_to_cstring(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_682))):(int64_t)__hx_to_double(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_682))));
                ...
                HexaVal fv = hexa_float(__hx_to_double(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_683)));
            ...
            if (hexa_truthy(hexa_eq(fname, hexa_str("sqrt")))) {
                ...
                if (hexa_truthy(hexa_eq(ak, hexa_str("IntLit")))) {
                    HexaVal iv2 = hexa_int((HX_IS_STR(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_684))?atoll(hexa_to_cstring(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_684))):(int64_t)__hx_to_double(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_684))));
            ...
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(fname, hexa_str("floor"))) || hexa_truthy(hexa_eq(fname, hexa_str("ceil")))))) {
                if (hexa_truthy(hexa_eq(ak, hexa_str("IntLit")))) {
                    return __hexa_fn_arena_return(_make_int_lit_node(hexa_map_get_ic(a, "value", &__hexa_codegen_c2_ic_685)));
                }
                return __hexa_fn_arena_return(hexa_str(""));
            }
            return __hexa_fn_arena_return(hexa_str(""));
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(nargs, hexa_int(2))) && hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(fname, hexa_str("min"))) || hexa_truthy(hexa_eq(fname, hexa_str("max")))))))) {
            HexaVal a1 = comptime_eval(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_686), hexa_int(0)));
            if (hexa_truthy(hexa_eq(hexa_type_of(a1), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            HexaVal a2 = comptime_eval(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_687), hexa_int(1)));
            if (hexa_truthy(hexa_eq(hexa_type_of(a2), hexa_str("string")))) {
                return __hexa_fn_arena_return(hexa_str(""));
            }
            HexaVal k1 = hexa_map_get_ic(a1, "kind", &__hexa_codegen_c2_ic_688);
            HexaVal k2 = hexa_map_get_ic(a2, "kind", &__hexa_codegen_c2_ic_689);
            ...
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k1, hexa_str("IntLit"))) && hexa_truthy(hexa_eq(k2, hexa_str("IntLit")))))) {
                HexaVal v1 = hexa_int((HX_IS_STR(hexa_map_get_ic(a1, "value", &__hexa_codegen_c2_ic_690))?atoll(hexa_to_cstring(hexa_map_get_ic(a1, "value", &__hexa_codegen_c2_ic_690))):(int64_t)__hx_to_double(hexa_map_get_ic(a1, "value", &__hexa_codegen_c2_ic_690))));
                HexaVal v2 = hexa_int((HX_IS_STR(hexa_map_get_ic(a2, "value", &__hexa_codegen_c2_ic_691))?atoll(hexa_to_cstring(hexa_map_get_ic(a2, "value", &__hexa_codegen_c2_ic_691))):(int64_t)__hx_to_double(hexa_map_get_ic(a2, "value", &__hexa_codegen_c2_ic_691))));
...
HexaVal _is_known_int(HexaVal node) {
    ...
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_692), hexa_str("IntLit")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_693), hexa_str("Ident")))) {
        return __hexa_fn_arena_return(_is_known_int_name(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_694)));
    }
    return __hexa_fn_arena_return(hexa_bool(0));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal _is_int_init_expr(HexaVal node) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        return __hexa_fn_arena_return(_is_known_int_name(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_696)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
        HexaVal op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_697);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("+"))) || hexa_truthy(hexa_eq(op, hexa_str("-"))))) || hexa_truthy(hexa_eq(op, hexa_str("*"))))) || hexa_truthy(hexa_eq(op, hexa_str("/"))))) || hexa_truthy(hexa_eq(op, hexa_str("%")))))) {
            return __hexa_fn_arena_return(hexa_bool(hexa_truthy(_is_int_init_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_698))) && hexa_truthy(_is_int_init_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_699)))));
        }
        return __hexa_fn_arena_return(hexa_bool(0));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_700), hexa_str("-")))) {
            return __hexa_fn_arena_return(_is_int_init_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_701)));
        }
        return __hexa_fn_arena_return(hexa_bool(0));
    }
    return __hexa_fn_arena_return(hexa_bool(0));
...
HexaVal _is_known_float(HexaVal node) {
    ...
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_702), hexa_str("FloatLit")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_703), hexa_str("Ident")))) {
        return __hexa_fn_arena_return(_is_known_float_name(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_704)));
    }
    return __hexa_fn_arena_return(hexa_bool(0));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal _is_float_init_expr(HexaVal node) {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_705);
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
        return __hexa_fn_arena_return(hexa_bool(1));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        return __hexa_fn_arena_return(_is_known_float_name(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_706)));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
        HexaVal op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_707);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("+"))) || hexa_truthy(hexa_eq(op, hexa_str("-"))))) || hexa_truthy(hexa_eq(op, hexa_str("*"))))) || hexa_truthy(hexa_eq(op, hexa_str("/"))))) || hexa_truthy(hexa_eq(op, hexa_str("%")))))) {
            HexaVal lf = _is_float_init_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_708));
            HexaVal rf = _is_float_init_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_709));
            if (hexa_truthy(hexa_bool(hexa_truthy(lf) && hexa_truthy(rf)))) {
                return __hexa_fn_arena_return(hexa_bool(1));
            }
            if (hexa_truthy(hexa_bool(hexa_truthy(lf) && hexa_truthy(_is_int_init_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_710)))))) {
                return __hexa_fn_arena_return(hexa_bool(1));
            }
            if (hexa_truthy(hexa_bool(hexa_truthy(rf) && hexa_truthy(_is_int_init_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_711)))))) {
                return __hexa_fn_arena_return(hexa_bool(1));
            }
        }
        return __hexa_fn_arena_return(hexa_bool(0));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_712), hexa_str("-")))) {
            return __hexa_fn_arena_return(_is_float_init_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_713)));
        }
        return __hexa_fn_arena_return(hexa_bool(0));
    }
    return __hexa_fn_arena_return(hexa_bool(0));
...
HexaVal _gen2_while_cond(HexaVal node) {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_714);
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
        HexaVal op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_715);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(op, hexa_str("<"))) || hexa_truthy(hexa_eq(op, hexa_str(">"))))) || hexa_truthy(hexa_eq(op, hexa_str("<="))))) || hexa_truthy(hexa_eq(op, hexa_str(">=")))))) {
            ...
            l = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_724));
            r = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_725));
            if (hexa_truthy(hexa_eq(op, hexa_str("<")))) {
        ...
        if (hexa_truthy(hexa_eq(op, hexa_str("!=")))) {
            li = _is_known_int(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_736));
            ri = _is_known_int(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_737));
            if (hexa_truthy(hexa_bool(hexa_truthy(li) && hexa_truthy(ri)))) {
                l = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_738));
                r = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_739));
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("(HX_INT("), l), hexa_str(") != HX_INT(")), r), hexa_str("))")));
            }
            lf = _is_known_float(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_740));
            rf = _is_known_float(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_741));
            if (hexa_truthy(hexa_bool(hexa_truthy(lf) && hexa_truthy(rf)))) {
                l = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_742));
                r = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_743));
                return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("(HX_FLOAT("), l), hexa_str(") != HX_FLOAT(")), r), hexa_str("))")));
            }
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("(!hexa_truthy(hexa_eq("), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_744))), hexa_str(", ")), gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_745))), hexa_str(")))")));
        }
        if (hexa_truthy(hexa_eq(op, hexa_str("&&")))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("("), _gen2_while_cond(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_746))), hexa_str(" && ")), _gen2_while_cond(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_747))), hexa_str(")")));
        }
        if (hexa_truthy(hexa_eq(op, hexa_str("||")))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("("), _gen2_while_cond(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_748))), hexa_str(" || ")), _gen2_while_cond(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_749))), hexa_str(")")));
        }
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_750), hexa_str("!")))) {
            return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("(!"), _gen2_while_cond(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_751))), hexa_str(")")));
        }
    }
    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("hexa_truthy("), gen2_expr(node)), hexa_str(")")));
    return __hexa_fn_arena_return(hexa_void());
...
HexaVal gen2_collect_free(HexaVal node, HexaVal bound, HexaVal out) {
    ...
    if (hexa_truthy(hexa_eq(hexa_type_of(node), hexa_str("array")))) {
        ...
        while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(node))))) {
            ...
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(s), hexa_str("string")))))) {
                HexaVal sk = hexa_map_get_ic(s, "kind", &__hexa_codegen_c2_ic_752);
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(sk, hexa_str("LetStmt"))) || hexa_truthy(hexa_eq(sk, hexa_str("LetMutStmt")))))) {
                    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(s, "left", &__hexa_codegen_c2_ic_753)), hexa_str("string")))))) {
                        result = gen2_collect_free(hexa_map_get_ic(s, "left", &__hexa_codegen_c2_ic_754), local, result);
                    }
                    local = hexa_array_push(local, hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_755));
                } else {
                    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(sk, hexa_str("ForStmt"))) || hexa_truthy(hexa_eq(sk, hexa_str("ForInStmt")))))) {
                        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(s, "left", &__hexa_codegen_c2_ic_756)), hexa_str("string")))))) {
                            result = gen2_collect_free(hexa_map_get_ic(s, "left", &__hexa_codegen_c2_ic_757), local, result);
                        }
                        HexaVal body_local = hexa_array_push(local, hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_758));
                        if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(s, "body", &__hexa_codegen_c2_ic_759)), hexa_str("array")))) {
                            result = gen2_collect_free(hexa_map_get_ic(s, "body", &__hexa_codegen_c2_ic_760), body_local, result);
                        }
                    } else {
                        if (hexa_truthy(hexa_eq(sk, hexa_str("ForDestructStmt")))) {
                            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(s, "iter_expr", &__hexa_codegen_c2_ic_761)), hexa_str("string")))))) {
                                result = gen2_collect_free(hexa_map_get_ic(s, "iter_expr", &__hexa_codegen_c2_ic_762), local, result);
                            }
                            HexaVal fd_local = local;
                            if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(s, "params", &__hexa_codegen_c2_ic_763)), hexa_str("array")))) {
                                HexaVal _fdi = hexa_int(0);
                                while (HX_BOOL(hexa_cmp_lt(_fdi, hexa_int(hexa_len(hexa_map_get_ic(s, "params", &__hexa_codegen_c2_ic_764)))))) {
                                    fd_local = hexa_array_push(fd_local, hexa_index_get(hexa_map_get_ic(s, "params", &__hexa_codegen_c2_ic_765), _fdi));
                                    _fdi = hexa_add(_fdi, hexa_int(1));
                                }
                            }
                            if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(s, "body", &__hexa_codegen_c2_ic_766)), hexa_str("array")))) {
                                result = gen2_collect_free(hexa_map_get_ic(s, "body", &__hexa_codegen_c2_ic_767), fd_local, result);
                            }
                        } else {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_768);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_769);
    ...
    result = out;
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_773)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_774), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_775)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_776), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_777)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_778), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_779)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_780), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_781)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_782), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_783)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_784), bound, result);
    }
    if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_785)), hexa_str("array")))) {
        HexaVal ai = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(ai, hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_786)))))) {
            result = gen2_collect_free(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_787), ai), bound, result);
            ai = hexa_add(ai, hexa_int(1));
        }
    }
    if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_788)), hexa_str("array")))) {
        HexaVal ii = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(ii, hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_789)))))) {
            result = gen2_collect_free(hexa_index_get(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_790), ii), bound, result);
            ii = hexa_add(ii, hexa_int(1));
        }
    }
    if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_791)), hexa_str("array")))) {
        HexaVal mi = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(mi, hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_792)))))) {
            HexaVal arm = hexa_index_get(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_793), mi);
            if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_794)), hexa_str("array")))) {
                result = gen2_collect_free(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_795), bound, result);
            }
            mi = hexa_add(mi, hexa_int(1));
        }
    }
...
HexaVal gen2_lambda_expr(HexaVal node) {
    ...
    HexaVal arity = hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_799)));
    HexaVal params = hexa_array_new();
    ...
    HexaVal lbody = hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_802);
...
HexaVal codegen_c2_full(HexaVal ast) {
    ...
    while (HX_BOOL(hexa_cmp_lt(gi, hexa_int(hexa_len(ast))))) {
        HexaVal gk = hexa_map_get_ic(hexa_index_get(ast, gi), "kind", &__hexa_codegen_c2_ic_803);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(gk, hexa_str("FnDecl"))) || hexa_truthy(hexa_eq(gk, hexa_str("ExternFnDecl"))))) || hexa_truthy(hexa_eq(gk, hexa_str("PureFnDecl"))))) || hexa_truthy(hexa_eq(gk, hexa_str("OptimizeFnStmt")))))) {
            _known_fn_globals = hexa_array_push(_known_fn_globals, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_804));
            _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_805));
            _known_fn_globals_add(hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_806));
            ...
            if (hexa_truthy(hexa_eq(gk, hexa_str("StructDecl")))) {
                _known_fn_globals = hexa_array_push(_known_fn_globals, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_808));
                _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_809));
                _known_fn_globals_add(hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_810));
                _known_nonlocal_add(hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_811));
            } else {
                if (hexa_truthy(hexa_eq(gk, hexa_str("EnumDecl")))) {
                    _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_812));
                    _known_nonlocal_add(hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_813));
                } else {
                    if (hexa_truthy(hexa_eq(gk, hexa_str("ComptimeConst")))) {
                        _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_814));
                        _known_nonlocal_add(hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_815));
                    } else {
    ...
    HexaVal i = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(ast))))) {
        HexaVal k = hexa_map_get_ic(hexa_index_get(ast, i), "kind", &__hexa_codegen_c2_ic_819);
        if (hexa_truthy(hexa_eq(k, hexa_str("FnDecl")))) {
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_820), hexa_str("main")))) {
                has_user_main = hexa_bool(1);
            }
            fwd_parts = hexa_array_push(fwd_parts, hexa_add(gen2_fn_forward(hexa_index_get(ast, i)), hexa_str("\n")));
            fn_parts = hexa_array_push(fn_parts, hexa_add(gen2_fn_decl(hexa_index_get(ast, i)), hexa_str("\n\n")));
            ...
            if (hexa_truthy(hexa_eq(k, hexa_str("ExternFnDecl")))) {
                HexaVal ew = gen2_extern_wrapper(hexa_index_get(ast, i));
                global_parts = hexa_array_push(global_parts, hexa_map_get_ic(ew, "global", &__hexa_codegen_c2_ic_821));
                fwd_parts = hexa_array_push(fwd_parts, hexa_add(hexa_map_get_ic(ew, "forward", &__hexa_codegen_c2_ic_822), hexa_str("\n")));
                fn_parts = hexa_array_push(fn_parts, hexa_add(hexa_map_get_ic(ew, "fn_code", &__hexa_codegen_c2_ic_823), hexa_str("\n\n")));
                init_parts = hexa_array_push(init_parts, hexa_map_get_ic(ew, "init", &__hexa_codegen_c2_ic_824));
            } else {
                if (hexa_truthy(hexa_eq(k, hexa_str("StructDecl")))) {
                    fwd_parts = hexa_array_push(fwd_parts, hexa_add(gen2_struct_forward(hexa_index_get(ast, i)), hexa_str("\n")));
                    fn_parts = hexa_array_push(fn_parts, hexa_add(gen2_struct_decl(hexa_index_get(ast, i)), hexa_str("\n\n")));
                    ...
                    if (hexa_truthy(hexa_eq(k, hexa_str("EnumDecl")))) {
                        ...
                        if (hexa_truthy(hexa_eq(k, hexa_str("ImplBlock")))) {
                            HexaVal ib = gen2_impl_block(hexa_index_get(ast, i));
                            fwd_parts = hexa_array_push(fwd_parts, hexa_map_get_ic(ib, "forward", &__hexa_codegen_c2_ic_825));
                            fn_parts = hexa_array_push(fn_parts, hexa_map_get_ic(ib, "fn_code", &__hexa_codegen_c2_ic_826));
                        } else {
                            if (hexa_truthy(hexa_eq(k, hexa_str("PureFnDecl")))) {
                                fwd_parts = hexa_array_push(fwd_parts, hexa_add(gen2_fn_forward(hexa_index_get(ast, i)), hexa_str("\n")));
                                fn_parts = hexa_array_push(fn_parts, hexa_add(gen2_fn_decl(hexa_index_get(ast, i)), hexa_str("\n\n")));
                                ...
                                if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeConst")))) {
                                    HexaVal _cc_folded2 = comptime_eval(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_827));
                                    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(_cc_folded2), hexa_str("string")))))) {
                                        _register_comptime_const(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_828), _cc_folded2);
                                    } else {
                                        global_parts = hexa_array_push(global_parts, hexa_add(hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_829)), hexa_str(";\n")));
                                        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_830)), hexa_str("string")))))) {
                                            init_parts = hexa_array_push(init_parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_831)), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_832))), hexa_str(";\n")));
                                        } else {
                                            init_parts = hexa_array_push(init_parts, hexa_add(hexa_add(hexa_str("    "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_833)), hexa_str(" = hexa_void();\n")));
                                        }
                                    }
                                } else {
                                    if (hexa_truthy(hexa_eq(k, hexa_str("OptimizeFnStmt")))) {
                                        ...
                                        if (hexa_truthy(hexa_eq(k, hexa_str("TraitDecl")))) {
                                            ...
                                            if (hexa_truthy(hexa_eq(k, hexa_str("InvariantDecl")))) {
                                                ...
                                                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("ImportStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("UseStmt")))))) {
                                                    HexaVal _use_fwd2 = _resolve_use_emit(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_834));
                                                    if (hexa_truthy(hexa_cmp_gt(hexa_int(hexa_len(_use_fwd2)), hexa_int(0)))) {
                                                        fwd_parts = hexa_array_push(fwd_parts, _use_fwd2);
                                                    } else {
                                                        main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_str("    /* import: "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_835)), hexa_str(" */\n")));
                                                    }
                                                } else {
                                                    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("LetStmt")))))) {
                                                        HexaVal _user_name2 = _hexa_mangle_ident(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_836));
                                                        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetStmt"))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_837)), hexa_str("string")))))))) {
                                                            if (hexa_truthy(_is_int_init_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_838)))) {
                                                                _known_int_add(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_839));
                                                            }
                                                            if (hexa_truthy(_is_float_init_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_840)))) {
                                                                _known_float_add(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_841));
                                                            }
                                                        }
                                                        HexaVal _tls_val2 = hexa_map_get_ic(hexa_index_get(ast, i), "value", &__hexa_codegen_c2_ic_842);
                                                        ...
                                                        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_843)), hexa_str("string")))))) {
                                                            init_parts = hexa_array_push(init_parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    "), _user_name2), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_844))), hexa_str(";\n")));
                                                        } else {
                                                        ...
                                                        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(_tls_stmt2, "kind", &__hexa_codegen_c2_ic_845), hexa_str("ExprStmt"))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(_tls_stmt2, "left", &__hexa_codegen_c2_ic_846)), hexa_str("string")))))))) {
                                                            HexaVal _tls_expr2 = hexa_map_get_ic(_tls_stmt2, "left", &__hexa_codegen_c2_ic_847);
                                                            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(_tls_expr2, "kind", &__hexa_codegen_c2_ic_848), hexa_str("Call"))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(_tls_expr2, "left", &__hexa_codegen_c2_ic_849)), hexa_str("string")))))))) {
                                                                HexaVal _tls_callee2 = hexa_map_get_ic(_tls_expr2, "left", &__hexa_codegen_c2_ic_850);
                                                                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(_tls_callee2, "kind", &__hexa_codegen_c2_ic_851), hexa_str("Ident"))) && hexa_truthy(hexa_eq(hexa_map_get_ic(_tls_callee2, "name", &__hexa_codegen_c2_ic_852), hexa_str("main")))))) {
                                                                    has_explicit_main_call = hexa_bool(1);
                                                                }
                                                            }
                                                        }
    ...
    /* FIX-C 2026-04-19: counter-driven per-slot read — see above. */
    {
        HexaVal _ldp_i_full = hexa_int(0);
        while (HX_BOOL(hexa_cmp_lt(_ldp_i_full, _lambda_counter))) {
            out_parts = hexa_array_push(out_parts, hexa_index_get(_lambda_def_parts, _ldp_i_full));
            _ldp_i_full = hexa_add(_ldp_i_full, hexa_int(1));
        }
    }
...
HexaVal _hxi_params_str(HexaVal params) {
    ...
    while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(params))))) {
        ...
        HexaVal vt = hexa_to_string(hexa_map_get_ic(p, "value", &__hexa_codegen_c2_ic_853));
        HexaVal t = (hexa_truthy(hexa_eq(vt, hexa_str(""))) ? hexa_str("_") : vt);
        parts = hexa_array_push(parts, hexa_add(hexa_add(hexa_to_string(hexa_map_get_ic(p, "name", &__hexa_codegen_c2_ic_854)), hexa_str(":")), t));
        i = hexa_add(i, hexa_int(1));
    }
    return __hexa_fn_arena_return(hexa_str_join(parts, hexa_str(",")));
    return __hexa_fn_arena_return(hexa_void());
...
HexaVal _hxi_fn_line(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal ret = hexa_to_string(hexa_map_get_ic(node, "ret_type", &__hexa_codegen_c2_ic_855));
    HexaVal ret_s = (hexa_truthy(hexa_eq(ret, hexa_str(""))) ? hexa_str("void") : ret);
    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("fn "), hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_856))), hexa_str("(")), _hxi_params_str(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_857))), hexa_str(")->")), ret_s));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal _hxi_struct_line(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal fields = hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_858);
    if (hexa_truthy(hexa_eq(hexa_type_of(fields), hexa_str("string")))) {
        return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_str("struct "), hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_859))), hexa_str("()")));
    }
    HexaVal parts = hexa_array_new();
    HexaVal i = hexa_int(0);
    while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(fields))))) {
        HexaVal f = hexa_index_get(fields, i);
        HexaVal vt = hexa_to_string(hexa_map_get_ic(f, "value", &__hexa_codegen_c2_ic_860));
        HexaVal t = (hexa_truthy(hexa_eq(vt, hexa_str(""))) ? hexa_str("_") : vt);
        parts = hexa_array_push(parts, hexa_add(hexa_add(hexa_to_string(hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_861)), hexa_str(":")), t));
        i = hexa_add(i, hexa_int(1));
    }
    return __hexa_fn_arena_return(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("struct "), hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_862))), hexa_str("(")), hexa_str_join(parts, hexa_str(","))), hexa_str(")")));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal _hxi_extern_line(HexaVal node) {
    __hexa_fn_arena_enter();
    HexaVal ret = hexa_to_string(hexa_map_get_ic(node, "ret_type", &__hexa_codegen_c2_ic_863));
    HexaVal ret_s = (hexa_truthy(hexa_eq(ret, hexa_str(""))) ? hexa_str("void") : ret);
    HexaVal sym = hexa_to_string(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_864));
    HexaVal link = hexa_to_string(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_865));
    HexaVal line = hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("extern "), hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_866))), hexa_str("(")), _hxi_params_str(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_867))), hexa_str(")->")), ret_s);
...
HexaVal _hxi_let_line(HexaVal node, HexaVal mutable) {
    ...
    return __hexa_fn_arena_return(hexa_add(hexa_add(prefix, hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_868))), hexa_str(":_")));
    return __hexa_fn_arena_return(hexa_void());
}
...
HexaVal emit_hxi(HexaVal ast, HexaVal src_bytes) {
    ...
    while (HX_BOOL(hexa_cmp_lt(i, hexa_int(hexa_len(ast))))) {
        ...
        HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_869);
        if (hexa_truthy(hexa_eq(k, hexa_str("FnDecl")))) {
            ...
            if (hexa_truthy(hexa_eq(k, hexa_str("PureFnDecl")))) {
                ...
                if (hexa_truthy(hexa_eq(k, hexa_str("AsyncFnDecl")))) {
                    ...
                    if (hexa_truthy(hexa_eq(k, hexa_str("StructDecl")))) {
                        ...
                        if (hexa_truthy(hexa_eq(k, hexa_str("EnumDecl")))) {
                            lines = hexa_array_push(lines, hexa_add(hexa_str("enum "), hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_870))));
                        } else {
                            if (hexa_truthy(hexa_eq(k, hexa_str("ExternFnDecl")))) {
                                ...
                                if (hexa_truthy(hexa_eq(k, hexa_str("LetStmt")))) {
                                    ...
                                    if (hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt")))) {
                                        ...
                                        if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeConst")))) {
                                            lines = hexa_array_push(lines, hexa_add(hexa_str("comptime "), hexa_to_string(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_871))));
                                        }
                                    }
                                }
                            }
