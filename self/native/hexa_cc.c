...
HexaVal count_kind(HexaVal tokens, HexaVal kind) {
    HexaVal count = hexa_int(0);
    {
        ...
        for (int __fi = 0; __fi < hexa_len(__iter_arr); __fi++) {
            ...
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(t, "kind", &__hexa_codegen_c2_ic_0), kind))) {
...
HexaVal p_synchronize(void) {
    while (hexa_truthy(hexa_bool(!hexa_truthy(p_at_end())))) {
        HexaVal cur = p_peek();
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(cur, "kind", &__hexa_codegen_c2_ic_0), hexa_str("Newline")))) {
            p_advance();
            HexaVal next = p_peek();
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_1), hexa_str("Let")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_2), hexa_str("Const")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_3), hexa_str("Static")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_4), hexa_str("Fn")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_5), hexa_str("Struct")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_6), hexa_str("Enum")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_7), hexa_str("For")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_8), hexa_str("While")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_9), hexa_str("Loop")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_10), hexa_str("Do")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_11), hexa_str("Defer")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_12), hexa_str("Return")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_13), hexa_str("If")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_14), hexa_str("Match")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_15), hexa_str("Impl")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_16), hexa_str("Trait")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_17), hexa_str("Use")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_18), hexa_str("Mod")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_19), hexa_str("Try")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_20), hexa_str("Assert")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_21), hexa_str("Proof")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_22), hexa_str("At")))) {
                return hexa_bool(1);
            }
            if (hexa_truthy(hexa_eq(hexa_map_get_ic(next, "kind", &__hexa_codegen_c2_ic_23), hexa_str("Eof")))) {
                return hexa_bool(1);
            }
        } else {
            p_advance();
...
HexaVal p_peek_kind(void) {
    return hexa_map_get_ic(p_peek(), "kind", &__hexa_codegen_c2_ic_27);
    return hexa_void();
}
...
HexaVal p_expect_ident(void) {
    HexaVal tok = p_peek();
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(tok, "kind", &__hexa_codegen_c2_ic_34), hexa_str("Ident")))) {
        p_pos = hexa_add(p_pos, hexa_int(1));
...
HexaVal p_continue_bin_op(HexaVal kinds) {
    ...
    while (hexa_truthy(hexa_bool(1))) {
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(_t, "kind", &__hexa_codegen_c2_ic_42), hexa_str("Newline"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(_t, "kind", &__hexa_codegen_c2_ic_43), hexa_str("Semicolon")))))))) {
            ...
            while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(_i); HexaVal __r=(hexa_int(hexa_len(kinds))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                if (hexa_truthy(hexa_eq(hexa_map_get_ic(_t, "kind", &__hexa_codegen_c2_ic_44), hexa_index_get(kinds, _i)))) {
                    p_skip_newlines();
                    return hexa_bool(1);
                }
    ...
    while (hexa_truthy(hexa_bool(!hexa_truthy(p_at_end())))) {
        ...
        HexaVal parse_ok = hexa_bool(1);
        {
            ...
            if (setjmp(__jb) == 0) {
                ...
                p_record_error(hexa_map_get_ic(err_tok, "line", &__hexa_codegen_c2_ic_45), hexa_map_get_ic(err_tok, "col", &__hexa_codegen_c2_ic_46), hexa_to_string(parse_err));
                p_synchronize();
...
HexaVal parse_stmt(void) {
    ...
    while (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("At")))) {
        ...
        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Ident")))) {
            ...
            attr_name = hexa_map_get_ic(next_tok, "value", &__hexa_codegen_c2_ic_47);
            p_advance();
        }
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(attr_name, hexa_str("contract"))) && hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("LParen")))))) {
            ...
            while (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RParen"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))))) {
                ...
                HexaVal clause_name = hexa_map_get_ic(clause_tok, "value", &__hexa_codegen_c2_ic_48);
                ...
                while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(_si); HexaVal __r=(p_pos); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                    ...
                    src_text = hexa_add(src_text, hexa_map_get_ic(hexa_index_get(p_tokens, _si), "value", &__hexa_codegen_c2_ic_49));
            ...
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(attr_name, hexa_str("symbol"))) || hexa_truthy(hexa_eq(attr_name, hexa_str("link")))))) {
                ...
                if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("LParen")))) {
                    ...
                    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RParen")))))) {
                        tok = p_advance();
                        attr_arg = hexa_map_get_ic(tok, "value", &__hexa_codegen_c2_ic_50);
                        while (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RParen"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))))) {
                            p_advance();
                        }
                    }
    ...
    if (hexa_truthy(hexa_eq(kind, hexa_str("Ident")))) {
        tok = p_peek();
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(tok, "value", &__hexa_codegen_c2_ic_51), hexa_str("import")))) {
            p_advance();
            HexaVal path = hexa_str("");
            if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
                HexaVal str_tok = p_advance();
                path = hexa_map_get_ic(str_tok, "value", &__hexa_codegen_c2_ic_52);
            }
...
HexaVal parse_invariant_decl(void) {
    ...
    while (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RBrace"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))))) {
        ...
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(key_tok, "kind", &__hexa_codegen_c2_ic_53), hexa_str("Ident")))) {
            p_advance();
            key_name = hexa_map_get_ic(key_tok, "value", &__hexa_codegen_c2_ic_54);
        } else {
            p_advance();
            key_name = hexa_map_get_ic(key_tok, "value", &__hexa_codegen_c2_ic_55);
        }
        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Colon")))) {
            p_advance();
        }
        ...
        if (hexa_truthy(hexa_eq(vk, hexa_str("StringLit")))) {
            ...
            if (hexa_truthy(hexa_eq(key_name, hexa_str("id")))) {
                id_str = hexa_map_get_ic(vt, "value", &__hexa_codegen_c2_ic_56);
            } else {
                if (hexa_truthy(hexa_eq(key_name, hexa_str("name")))) {
                    name_str = hexa_map_get_ic(vt, "value", &__hexa_codegen_c2_ic_57);
                } else {
                    if (hexa_truthy(hexa_eq(key_name, hexa_str("predicate")))) {
                        pred_str = hexa_map_get_ic(vt, "value", &__hexa_codegen_c2_ic_58);
                    } else {
                        if (hexa_truthy(hexa_eq(key_name, hexa_str("target")))) {
                            tgt_str = hexa_map_get_ic(vt, "value", &__hexa_codegen_c2_ic_59);
                        } else {
                            if (hexa_truthy(hexa_eq(key_name, hexa_str("context")))) {
                                ctx_str = hexa_map_get_ic(vt, "value", &__hexa_codegen_c2_ic_60);
                            }
                        }
                    }
                }
            ...
            if (hexa_truthy(hexa_eq(vk, hexa_str("LBrace")))) {
                ...
                while (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RBrace"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))))) {
                    ...
                    HexaVal nk = hexa_str("");
                    if (hexa_truthy(hexa_eq(hexa_map_get_ic(nk_tok, "kind", &__hexa_codegen_c2_ic_61), hexa_str("Ident")))) {
                        p_advance();
                        nk = hexa_map_get_ic(nk_tok, "value", &__hexa_codegen_c2_ic_62);
                    } else {
                        p_advance();
                        nk = hexa_map_get_ic(nk_tok, "value", &__hexa_codegen_c2_ic_63);
                    }
                    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Colon")))) {
                        p_advance();
                    }
                    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
                        ...
                        if (hexa_truthy(hexa_eq(key_name, hexa_str("pattern")))) {
                            if (hexa_truthy(hexa_eq(nk, hexa_str("target")))) {
                                tgt_str = hexa_map_get_ic(nv, "value", &__hexa_codegen_c2_ic_64);
                            } else {
                                if (hexa_truthy(hexa_eq(nk, hexa_str("context")))) {
                                    ctx_str = hexa_map_get_ic(nv, "value", &__hexa_codegen_c2_ic_65);
                                }
                            }
                        }
                    } else {
                    ...
                    while (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RBracket"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))))) {
                        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
                            ...
                            if (hexa_truthy(hexa_eq(key_name, hexa_str("exempt")))) {
                                exempt_list = hexa_array_push(exempt_list, hexa_map_get_ic(et, "value", &__hexa_codegen_c2_ic_66));
                            }
                        } else {
                            p_advance();
                        }
        ...
        for (int __fi = 0; __fi < hexa_len(__iter_arr); __fi++) {
            ...
            if (hexa_truthy(hexa_eq(hexa_type_of(stmt), hexa_str("string")))) {
                ...
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(stmt, "kind", &__hexa_codegen_c2_ic_69), hexa_str("ReturnStmt"))) || hexa_truthy(hexa_eq(hexa_map_get_ic(stmt, "kind", &__hexa_codegen_c2_ic_70), hexa_str("Return")))))) {
                    ...
                    if (hexa_truthy(hexa_eq(hexa_map_get_ic(stmt, "kind", &__hexa_codegen_c2_ic_72), hexa_str("IfStmt")))) {
                        HexaVal wrapped = stmt;
                        if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(stmt, "then_body", &__hexa_codegen_c2_ic_73)), hexa_str("array")))) {
                            wrapped = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("IfStmt")), "name", hexa_map_get_ic(stmt, "name", &__hexa_codegen_c2_ic_74)), "value", hexa_map_get_ic(stmt, "value", &__hexa_codegen_c2_ic_75)), "op", hexa_map_get_ic(stmt, "op", &__hexa_codegen_c2_ic_76)), "left", hexa_map_get_ic(stmt, "left", &__hexa_codegen_c2_ic_77)), "right", hexa_map_get_ic(stmt, "right", &__hexa_codegen_c2_ic_78)), "cond", hexa_map_get_ic(stmt, "cond", &__hexa_codegen_c2_ic_79)), "then_body", contract_wrap_returns(hexa_map_get_ic(stmt, "then_body", &__hexa_codegen_c2_ic_80), ens_expr, fn_name, ens_text)), "else_body", hexa_map_get_ic(stmt, "else_body", &__hexa_codegen_c2_ic_81)), "params", hexa_map_get_ic(stmt, "params", &__hexa_codegen_c2_ic_82)), "body", hexa_map_get_ic(stmt, "body", &__hexa_codegen_c2_ic_83)), "args", hexa_map_get_ic(stmt, "args", &__hexa_codegen_c2_ic_84)), "fields", hexa_map_get_ic(stmt, "fields", &__hexa_codegen_c2_ic_85)), "items", hexa_map_get_ic(stmt, "items", &__hexa_codegen_c2_ic_86)), "variants", hexa_map_get_ic(stmt, "variants", &__hexa_codegen_c2_ic_87)), "arms", hexa_map_get_ic(stmt, "arms", &__hexa_codegen_c2_ic_88)), "iter_expr", hexa_map_get_ic(stmt, "iter_expr", &__hexa_codegen_c2_ic_89)), "ret_type", hexa_map_get_ic(stmt, "ret_type", &__hexa_codegen_c2_ic_90)), "target", hexa_map_get_ic(stmt, "target", &__hexa_codegen_c2_ic_91)), "trait_name", hexa_map_get_ic(stmt, "trait_name", &__hexa_codegen_c2_ic_92)), "methods", hexa_map_get_ic(stmt, "methods", &__hexa_codegen_c2_ic_93));
                        }
                        if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(wrapped, "else_body", &__hexa_codegen_c2_ic_94)), hexa_str("array")))) {
                            wrapped = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("IfStmt")), "name", hexa_map_get_ic(wrapped, "name", &__hexa_codegen_c2_ic_95)), "value", hexa_map_get_ic(wrapped, "value", &__hexa_codegen_c2_ic_96)), "op", hexa_map_get_ic(wrapped, "op", &__hexa_codegen_c2_ic_97)), "left", hexa_map_get_ic(wrapped, "left", &__hexa_codegen_c2_ic_98)), "right", hexa_map_get_ic(wrapped, "right", &__hexa_codegen_c2_ic_99)), "cond", hexa_map_get_ic(wrapped, "cond", &__hexa_codegen_c2_ic_100)), "then_body", hexa_map_get_ic(wrapped, "then_body", &__hexa_codegen_c2_ic_101)), "else_body", contract_wrap_returns(hexa_map_get_ic(wrapped, "else_body", &__hexa_codegen_c2_ic_102), ens_expr, fn_name, ens_text)), "params", hexa_map_get_ic(wrapped, "params", &__hexa_codegen_c2_ic_103)), "body", hexa_map_get_ic(wrapped, "body", &__hexa_codegen_c2_ic_104)), "args", hexa_map_get_ic(wrapped, "args", &__hexa_codegen_c2_ic_105)), "fields", hexa_map_get_ic(wrapped, "fields", &__hexa_codegen_c2_ic_106)), "items", hexa_map_get_ic(wrapped, "items", &__hexa_codegen_c2_ic_107)), "variants", hexa_map_get_ic(wrapped, "variants", &__hexa_codegen_c2_ic_108)), "arms", hexa_map_get_ic(wrapped, "arms", &__hexa_codegen_c2_ic_109)), "iter_expr", hexa_map_get_ic(wrapped, "iter_expr", &__hexa_codegen_c2_ic_110)), "ret_type", hexa_map_get_ic(wrapped, "ret_type", &__hexa_codegen_c2_ic_111)), "target", hexa_map_get_ic(wrapped, "target", &__hexa_codegen_c2_ic_112)), "trait_name", hexa_map_get_ic(wrapped, "trait_name", &__hexa_codegen_c2_ic_113)), "methods", hexa_map_get_ic(wrapped, "methods", &__hexa_codegen_c2_ic_114));
                        }
...
HexaVal parse_for_stmt(void) {
    ...
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(in_tok, "value", &__hexa_codegen_c2_ic_115), hexa_str("in")))))) {
        HexaVal for_msg = hexa_format_n(hexa_str("expected 'in' after for variable, got '{}'"), hexa_array_push(hexa_array_new(), hexa_map_get_ic(in_tok, "value", &__hexa_codegen_c2_ic_116)));
        p_record_error(hexa_map_get_ic(in_tok, "line", &__hexa_codegen_c2_ic_117), hexa_map_get_ic(in_tok, "col", &__hexa_codegen_c2_ic_118), for_msg);
...
HexaVal parse_match_pattern(void) {
    ...
    HexaVal tok = p_peek();
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(tok, "kind", &__hexa_codegen_c2_ic_119), hexa_str("Ident"))) && hexa_truthy(hexa_eq(hexa_map_get_ic(tok, "value", &__hexa_codegen_c2_ic_120), hexa_str("_")))))) {
        p_advance();
        return node_wildcard();
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(tok, "kind", &__hexa_codegen_c2_ic_121), hexa_str("Ident"))) && hexa_truthy(hexa_eq(hexa_map_get_ic(p_peek_ahead(hexa_int(1)), "kind", &__hexa_codegen_c2_ic_122), hexa_str("ColonColon")))))) {
        HexaVal ename = hexa_map_get_ic(tok, "value", &__hexa_codegen_c2_ic_123);
        p_advance();
        p_advance();
        HexaVal vname = p_expect_ident();
    ...
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(tok, "kind", &__hexa_codegen_c2_ic_124), hexa_str("LBracket")))) {
        p_advance();
...
HexaVal parse_expr(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("ColonEq")))) {
        ...
        return hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("WalrusExpr")), "name", hexa_map_get_ic(left, "name", &__hexa_codegen_c2_ic_125)), "value", hexa_str("")), "op", hexa_str(":=")), "left", left), "right", right), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
    }
    return left;
    return hexa_void();
}
...
HexaVal parse_null_coal(void) {
    ...
    while (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("NullCoal"))) || hexa_truthy(p_continue_bin_op(hexa_array_push(hexa_array_new(), hexa_str("NullCoal"))))))) {
        ...
        left = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("BinOp")), "name", hexa_str("")), "value", hexa_str("")), "op", hexa_map_get_ic(op_tok, "value", &__hexa_codegen_c2_ic_127)), "left", left), "right", right), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
    }
    return left;
    return hexa_void();
}
...
HexaVal parse_or(void) {
    ...
    while (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Or"))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Xor"))))) || hexa_truthy(p_continue_bin_op(hexa_array_push(hexa_array_push(hexa_array_new(), hexa_str("Or")), hexa_str("Xor"))))))) {
        ...
        left = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("BinOp")), "name", hexa_str("")), "value", hexa_str("")), "op", hexa_map_get_ic(op_tok, "value", &__hexa_codegen_c2_ic_128)), "left", left), "right", right), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
    }
    return left;
    return hexa_void();
}
...
HexaVal parse_and(void) {
    ...
    while (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("And"))) || hexa_truthy(p_continue_bin_op(hexa_array_push(hexa_array_new(), hexa_str("And"))))))) {
        ...
        left = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("BinOp")), "name", hexa_str("")), "value", hexa_str("")), "op", hexa_map_get_ic(op_tok, "value", &__hexa_codegen_c2_ic_129)), "left", left), "right", right), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
    }
    return left;
    return hexa_void();
}
...
HexaVal parse_comparison(void) {
    ...
    left = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("BinOp")), "name", hexa_str("")), "value", hexa_str("")), "op", hexa_map_get_ic(op_tok, "value", &__hexa_codegen_c2_ic_130)), "left", left), "right", right), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
    while (hexa_truthy(is_comparison_op(p_peek_kind()))) {
        HexaVal op2_tok = p_advance();
        p_skip_newlines();
        HexaVal middle = right;
        HexaVal next = parse_bitwise();
        HexaVal right_cmp = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("BinOp")), "name", hexa_str("")), "value", hexa_str("")), "op", hexa_map_get_ic(op2_tok, "value", &__hexa_codegen_c2_ic_131)), "left", middle), "right", next), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
...
HexaVal parse_bitwise(void) {
    ...
    while (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("EqEq"))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("NotEq"))))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Lt"))))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Gt"))))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("LtEq"))))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("GtEq"))))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("In"))))) || hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Ident"))) && hexa_truthy(hexa_eq(hexa_map_get_ic(p_peek(), "value", &__hexa_codegen_c2_ic_132), hexa_str("is"))))))) || hexa_truthy(p_continue_bin_op(hexa_array_push(hexa_array_push(hexa_array_push(hexa_array_push(hexa_array_push(hexa_array_push(hexa_array_new(), hexa_str("EqEq")), hexa_str("NotEq")), hexa_str("Lt")), hexa_str("Gt")), hexa_str("LtEq")), hexa_str("GtEq"))))))) {
        HexaVal op_tok = p_advance();
        p_skip_newlines();
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(op_tok, "value", &__hexa_codegen_c2_ic_133), hexa_str("is")))) {
            HexaVal type_tok = p_advance();
            right = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("Ident")), "name", hexa_map_get_ic(type_tok, "value", &__hexa_codegen_c2_ic_134)), "value", hexa_map_get_ic(type_tok, "value", &__hexa_codegen_c2_ic_135)), "op", hexa_str("")), "left", hexa_str("")), "right", hexa_str("")), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
...
HexaVal parse_addition(void) {
    ...
    while (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Plus"))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Minus"))))) || hexa_truthy(p_continue_bin_op(hexa_array_push(hexa_array_new(), hexa_str("Plus"))))))) {
        ...
        left = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("BinOp")), "name", hexa_str("")), "value", hexa_str("")), "op", hexa_map_get_ic(op_tok, "value", &__hexa_codegen_c2_ic_137)), "left", left), "right", right), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
    }
    return left;
    return hexa_void();
}
...
HexaVal parse_multiplication(void) {
    ...
    while (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Star"))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Slash"))))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Percent"))))) || hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Power"))))) || hexa_truthy(p_continue_bin_op(hexa_array_push(hexa_array_push(hexa_array_push(hexa_array_push(hexa_array_new(), hexa_str("Star")), hexa_str("Slash")), hexa_str("Percent")), hexa_str("Power"))))))) {
        ...
        left = hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_str("BinOp")), "name", hexa_str("")), "value", hexa_str("")), "op", hexa_map_get_ic(op_tok, "value", &__hexa_codegen_c2_ic_138)), "left", left), "right", right), "cond", hexa_str("")), "then_body", hexa_str("")), "else_body", hexa_str("")), "params", hexa_str("")), "body", hexa_str("")), "args", hexa_str("")), "fields", hexa_str("")), "items", hexa_str("")), "variants", hexa_str("")), "arms", hexa_str("")), "iter_expr", hexa_str("")), "ret_type", hexa_str("")), "target", hexa_str("")), "trait_name", hexa_str("")), "methods", hexa_str(""));
    }
    return left;
    return hexa_void();
}
...
HexaVal parse_primary(void) {
    ...
    HexaVal tok = p_peek();
    HexaVal k = hexa_map_get_ic(tok, "kind", &__hexa_codegen_c2_ic_140);
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        p_advance();
        return node_int_lit(hexa_map_get_ic(tok, "value", &__hexa_codegen_c2_ic_141));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
        p_advance();
        return node_float_lit(hexa_map_get_ic(tok, "value", &__hexa_codegen_c2_ic_142));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BoolLit")))) {
        p_advance();
        return node_bool_lit(hexa_map_get_ic(tok, "value", &__hexa_codegen_c2_ic_143));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StringLit")))) {
        p_advance();
        return node_string_lit(hexa_map_get_ic(tok, "value", &__hexa_codegen_c2_ic_144));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("CharLit")))) {
        p_advance();
        return node_char_lit(hexa_map_get_ic(tok, "value", &__hexa_codegen_c2_ic_145));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        p_advance();
        HexaVal name = hexa_map_get_ic(tok, "value", &__hexa_codegen_c2_ic_146);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("LBracket")))) {
        ...
        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("For")))) {
            ...
            HexaVal in_tok = p_advance();
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(in_tok, "value", &__hexa_codegen_c2_ic_147), hexa_str("in")))))) {
                HexaVal comp_msg = hexa_format_n(hexa_str("expected 'in' after comprehension variable, got '{}'"), hexa_array_push(hexa_array_new(), hexa_map_get_ic(in_tok, "value", &__hexa_codegen_c2_ic_148)));
                p_record_error(hexa_map_get_ic(in_tok, "line", &__hexa_codegen_c2_ic_149), hexa_map_get_ic(in_tok, "col", &__hexa_codegen_c2_ic_150), comp_msg);
...
HexaVal parse_attribute_prefix(void) {
    ...
    HexaVal attr_name = hexa_map_get_ic(attr, "value", &__hexa_codegen_c2_ic_157);
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(attr_name, hexa_str("symbol"))) || hexa_truthy(hexa_eq(attr_name, hexa_str("link")))))) {
        p_expect(hexa_str("LParen"));
        HexaVal tok = p_advance();
        HexaVal val = hexa_map_get_ic(tok, "value", &__hexa_codegen_c2_ic_158);
        p_expect(hexa_str("RParen"));
        if (hexa_truthy(hexa_eq(attr_name, hexa_str("symbol")))) {
...
HexaVal parse_break_stmt(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Label")))) {
        label = hexa_map_get_ic(p_advance(), "value", &__hexa_codegen_c2_ic_159);
    } else {
        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Ident")))) {
            label = hexa_map_get_ic(p_advance(), "value", &__hexa_codegen_c2_ic_160);
        }
    }
...
HexaVal parse_continue_stmt(void) {
    ...
    HexaVal label = hexa_str("");
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Label")))) {
        label = hexa_map_get_ic(p_advance(), "value", &__hexa_codegen_c2_ic_161);
    } else {
        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Ident")))) {
            label = hexa_map_get_ic(p_advance(), "value", &__hexa_codegen_c2_ic_162);
        }
    }
...
HexaVal parse_do_while_stmt(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("While")))) {
        ...
        HexaVal tok = p_peek();
        p_record_error(hexa_map_get_ic(tok, "line", &__hexa_codegen_c2_ic_163), hexa_map_get_ic(tok, "col", &__hexa_codegen_c2_ic_164), hexa_str("expected 'while' after do block"));
...
HexaVal parse_labeled_loop(void) {
    HexaVal tok = hexa_void();
    HexaVal label = hexa_map_get_ic(p_advance(), "value", &__hexa_codegen_c2_ic_165);
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Colon")))) {
        p_advance();
    } else {
        tok = p_peek();
        p_record_error(hexa_map_get_ic(tok, "line", &__hexa_codegen_c2_ic_166), hexa_map_get_ic(tok, "col", &__hexa_codegen_c2_ic_167), hexa_str("expected ':' after label"));
    ...
    if (hexa_truthy(hexa_eq(next, hexa_str("For")))) {
        ...
        if (hexa_truthy(hexa_eq(next, hexa_str("While")))) {
            ...
            if (hexa_truthy(hexa_eq(next, hexa_str("Loop")))) {
                ...
                tok = p_peek();
                p_record_error(hexa_map_get_ic(tok, "line", &__hexa_codegen_c2_ic_168), hexa_map_get_ic(tok, "col", &__hexa_codegen_c2_ic_169), hexa_str("expected for/while/loop after label"));
                hexa_println(hexa_add(hexa_add(hexa_str("Parse error: expected for/while/loop after label '"), label), hexa_str("'")));
                return empty_node();
            }
        }
    }
    return hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_set(hexa_map_new(), "kind", hexa_map_get_ic(loop_node, "kind", &__hexa_codegen_c2_ic_170)), "name", hexa_map_get_ic(loop_node, "name", &__hexa_codegen_c2_ic_171)), "value", label), "op", hexa_map_get_ic(loop_node, "op", &__hexa_codegen_c2_ic_172)), "left", hexa_map_get_ic(loop_node, "left", &__hexa_codegen_c2_ic_173)), "right", hexa_map_get_ic(loop_node, "right", &__hexa_codegen_c2_ic_174)), "cond", hexa_map_get_ic(loop_node, "cond", &__hexa_codegen_c2_ic_175)), "then_body", hexa_map_get_ic(loop_node, "then_body", &__hexa_codegen_c2_ic_176)), "else_body", hexa_map_get_ic(loop_node, "else_body", &__hexa_codegen_c2_ic_177)), "params", hexa_map_get_ic(loop_node, "params", &__hexa_codegen_c2_ic_178)), "body", hexa_map_get_ic(loop_node, "body", &__hexa_codegen_c2_ic_179)), "args", hexa_map_get_ic(loop_node, "args", &__hexa_codegen_c2_ic_180)), "fields", hexa_map_get_ic(loop_node, "fields", &__hexa_codegen_c2_ic_181)), "items", hexa_map_get_ic(loop_node, "items", &__hexa_codegen_c2_ic_182)), "variants", hexa_map_get_ic(loop_node, "variants", &__hexa_codegen_c2_ic_183)), "arms", hexa_map_get_ic(loop_node, "arms", &__hexa_codegen_c2_ic_184)), "iter_expr", hexa_map_get_ic(loop_node, "iter_expr", &__hexa_codegen_c2_ic_185)), "ret_type", hexa_map_get_ic(loop_node, "ret_type", &__hexa_codegen_c2_ic_186)), "target", hexa_map_get_ic(loop_node, "target", &__hexa_codegen_c2_ic_187)), "trait_name", hexa_map_get_ic(loop_node, "trait_name", &__hexa_codegen_c2_ic_188)), "methods", hexa_map_get_ic(loop_node, "methods", &__hexa_codegen_c2_ic_189));
    return hexa_void();
}
...
HexaVal parse_intent_stmt(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
        desc = hexa_map_get_ic(p_advance(), "value", &__hexa_codegen_c2_ic_190);
    } else {
        desc = p_expect_ident();
    }
    p_expect(hexa_str("LBrace"));
...
HexaVal parse_verify_stmt(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
        name = hexa_map_get_ic(p_advance(), "value", &__hexa_codegen_c2_ic_191);
    } else {
        name = p_expect_ident();
    }
    HexaVal body = parse_block();
...
HexaVal parse_generate_stmt(void) {
    ...
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Fn")))) {
        ...
        desc = hexa_str("");
        if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
            desc = hexa_map_get_ic(p_advance(), "value", &__hexa_codegen_c2_ic_192);
        }
        p_skip_newlines();
        p_expect(hexa_str("RBrace"));
    ...
    desc = hexa_str("");
    if (hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("StringLit")))) {
        desc = hexa_map_get_ic(p_advance(), "value", &__hexa_codegen_c2_ic_193);
    }
    p_skip_newlines();
    p_expect(hexa_str("RBrace"));
...
HexaVal parse_macro_def(void) {
    ...
    while (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RBrace"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))))) {
        ...
        while (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("RParen"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(p_peek_kind(), hexa_str("Eof")))))))) {
            HexaVal tok = p_advance();
            pat_tokens = hexa_array_push(pat_tokens, hexa_map_get_ic(tok, "value", &__hexa_codegen_c2_ic_194));
            p_skip_newlines();
        }
        p_expect(hexa_str("RParen"));
...
HexaVal ast_to_string(HexaVal node, HexaVal indent) {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_195);
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("IntLit(")), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_196)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("FloatLit(")), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_197)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BoolLit")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("BoolLit(")), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_198)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StringLit")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("StringLit(\"")), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_199)), hexa_str("\")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("CharLit")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("CharLit('")), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_200)), hexa_str("')"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("Ident(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_201)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Wildcard")))) {
        return hexa_add(pad, hexa_str("Wildcard"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
        l = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_202), hexa_int(0));
        r = ast_to_string(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_203), hexa_int(0));
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("BinOp(")), hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_204)), hexa_str(", ")), l), hexa_str(", ")), r), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        HexaVal operand = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_205), hexa_int(0));
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("UnaryOp(")), hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_206)), hexa_str(", ")), operand), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Call")))) {
        HexaVal callee = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_207), hexa_int(0));
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("Call(")), callee), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_208))))), hexa_str(" args])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Field")))) {
        obj = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_209), hexa_int(0));
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("Field(")), obj), hexa_str(".")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_210)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("OptField")))) {
        obj = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_211), hexa_int(0));
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("OptField(")), obj), hexa_str("?.")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_212)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Index")))) {
        obj = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_213), hexa_int(0));
        HexaVal idx = ast_to_string(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_214), hexa_int(0));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("IfExpr")))) {
        HexaVal c = ast_to_string(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_215), hexa_int(0));
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("IfExpr(")), c), hexa_str(", then=[")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_216))))), hexa_str("], else=[")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_217))))), hexa_str("])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("IfLetExpr")))) {
        HexaVal p = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_218), hexa_int(0));
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("IfLetExpr(")), p), hexa_str(", then=[")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_219))))), hexa_str("], else=[")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_220))))), hexa_str("])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("MatchExpr")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("MatchExpr([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_221))))), hexa_str(" arms])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Array")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("Array([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_222))))), hexa_str(" items])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ListComp")))) {
        HexaVal body_s = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_223), hexa_int(0));
        HexaVal iter_s = ast_to_string(hexa_map_get_ic(node, "iter_expr", &__hexa_codegen_c2_ic_224), hexa_int(0));
        HexaVal filt = hexa_str("");
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_225)), hexa_str("string")))))) {
            filt = hexa_add(hexa_str(" if "), ast_to_string(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_226), hexa_int(0)));
        }
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ListComp(")), body_s), hexa_str(" for ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_227)), hexa_str(" in ")), iter_s), filt), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StructInit")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("StructInit(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_228)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_229))))), hexa_str(" fields])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Slice")))) {
        obj = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_230), hexa_int(0));
        HexaVal s_str = hexa_str("");
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_231), hexa_str("")))))) {
            s_str = ast_to_string(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_232), hexa_int(0));
        }
        HexaVal e_str = hexa_str("");
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_233), hexa_str("")))))) {
            e_str = ast_to_string(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_234), hexa_int(0));
        }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Range")))) {
        HexaVal s = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_235), hexa_int(0));
        HexaVal e = ast_to_string(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_236), hexa_int(0));
        HexaVal step_str = hexa_str("");
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_237), hexa_str("")))))) {
            step_str = hexa_add(hexa_str(" step "), ast_to_string(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_238), hexa_int(0)));
        }
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("Range(")), s), hexa_str("..")), e), hexa_str(", ")), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_239)), step_str), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumPath")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("EnumPath(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_240)), hexa_str("::")), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_241)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Lambda")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("Lambda([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_242))))), hexa_str(" params])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Tuple")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("Tuple([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_243))))), hexa_str(" items])"));
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt")))))) {
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_244), hexa_int(0));
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, k), hexa_str("(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_245)), hexa_str(" = ")), v), hexa_str(")"));
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("ConstStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("StaticStmt")))))) {
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_246), hexa_int(0));
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, k), hexa_str("(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_247)), hexa_str(" = ")), v), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ReturnStmt")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_248), hexa_str("")))) {
            return hexa_add(pad, hexa_str("ReturnStmt()"));
        }
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_249), hexa_int(0));
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("ReturnStmt(")), v), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FnDecl")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("FnDecl(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_250)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_251))))), hexa_str(" params], [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_252))))), hexa_str(" stmts])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StructDecl")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("StructDecl(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_253)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_254))))), hexa_str(" fields])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumDecl")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("EnumDecl(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_255)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "variants", &__hexa_codegen_c2_ic_256))))), hexa_str(" variants])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ForStmt")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ForStmt(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_257)), hexa_str(" in ..., [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_258))))), hexa_str(" stmts])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("WhileStmt")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("WhileStmt(..., [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_259))))), hexa_str(" stmts])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("LoopStmt")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("LoopStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_260))))), hexa_str(" stmts])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ExprStmt")))) {
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_261), hexa_int(0));
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("ExprStmt(")), v), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("AssignStmt")))) {
        l = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_262), hexa_int(0));
        r = ast_to_string(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_263), hexa_int(0));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("AssertStmt")))) {
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_264), hexa_int(0));
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("AssertStmt(")), v), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ProofStmt")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ProofStmt(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_265)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_266))))), hexa_str(" stmts])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ImplBlock")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ImplBlock(")), hexa_map_get_ic(node, "target", &__hexa_codegen_c2_ic_267)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "methods", &__hexa_codegen_c2_ic_268))))), hexa_str(" methods])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("TraitDecl")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("TraitDecl(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_269)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "methods", &__hexa_codegen_c2_ic_270))))), hexa_str(" methods])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("UseStmt")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("UseStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_271))))), hexa_str(" segments])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ModStmt")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("ModStmt(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_272)), hexa_str(")"));
    }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("YieldStmt")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_273), hexa_str("")))) {
            return hexa_add(pad, hexa_str("YieldStmt()"));
        }
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("YieldStmt(")), ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_274), hexa_int(0))), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeFnDecl")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ComptimeFnDecl(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_275)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_276))))), hexa_str(" params])"));
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("ComptimeConst"))) || hexa_truthy(hexa_eq(k, hexa_str("ComptimeLet")))))) {
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_277), hexa_int(0));
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, k), hexa_str("(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_278)), hexa_str(" = ")), v), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeBlock")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("ComptimeBlock([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_279))))), hexa_str(" stmts])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeAssert")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("ComptimeAssert(")), ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_280), hexa_int(0))), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("IntentStmt")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("IntentStmt(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_281)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_282))))), hexa_str(" fields])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("VerifyStmt")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("VerifyStmt(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_283)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_284))))), hexa_str(" stmts])"));
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("GenerateFnStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("GenerateStmt")))))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(pad, k), hexa_str("(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_285)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("OptimizeFnStmt")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("OptimizeFnStmt(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_286)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_287))))), hexa_str(" params])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EffectDecl")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("EffectDecl(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_288)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_289))))), hexa_str(" ops])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("PureFnDecl")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("PureFnDecl(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_290)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_291))))), hexa_str(" params])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("MacroDef")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("MacroDef(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_292)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_293))))), hexa_str(" rules])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("DeriveDecl")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("DeriveDecl(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_294)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_295))))), hexa_str(" traits])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("TheoremStmt")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("TheoremStmt(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_296)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_297))))), hexa_str(" stmts])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("HandleWithStmt")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("HandleWithStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_298))))), hexa_str(" handlers])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("GuardStmt")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("GuardStmt(cond, [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_299))))), hexa_str(" else stmts])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("GuardLetStmt")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("GuardLetStmt(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_300)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_301))))), hexa_str(" else stmts])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("WithStmt")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("WithStmt(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_302)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_303))))), hexa_str(" body stmts])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("WalrusExpr")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("WalrusExpr(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_304)), hexa_str(", ")), ast_to_string(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_305), hexa_int(0))), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("TryCatch")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("TryCatch(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_306)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ThrowStmt")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("ThrowStmt(")), ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_307), hexa_int(0))), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("PanicStmt")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("PanicStmt(")), ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_308), hexa_int(0))), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("DropStmt")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("DropStmt(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_309)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("SpawnStmt")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("SpawnStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_310))))), hexa_str(" stmts])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ScopeStmt")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("ScopeStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_311))))), hexa_str(" stmts])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("SelectStmt")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("SelectStmt([")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_312))))), hexa_str(" arms])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("AsyncFnDecl")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("AsyncFnDecl(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_313)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_314))))), hexa_str(" params])"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ExternFnDecl")))) {
        HexaVal sym_info = hexa_str("");
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_315), hexa_str("")))))) {
            sym_info = hexa_add(hexa_add(hexa_str(", @symbol(\""), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_316)), hexa_str("\")"));
        }
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("ExternFnDecl(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_317)), hexa_str(", [")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_318))))), hexa_str(" params]")), sym_info), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("TypeAlias")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("TypeAlias(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_319)), hexa_str(" = ")), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_320)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("AtomicLet")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("AtomicLet(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_321)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("DestructLetStmt")))) {
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_322), hexa_int(0));
        HexaVal rest = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_323);
        names = hexa_str_join(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_324), hexa_str(", "));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("MapDestructLetStmt")))) {
        v = ast_to_string(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_325), hexa_int(0));
        names = hexa_str_join(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_326), hexa_str(", "));
...
// dedup: static HexaIC __hexa_codegen_c2_ic_0 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_1 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_2 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_3 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_4 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_5 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_6 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_7 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_8 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_9 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_10 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_11 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_12 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_13 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_14 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_15 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_16 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_17 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_18 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_19 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_20 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_21 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_22 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_23 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_24 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_25 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_26 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_27 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_28 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_29 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_30 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_31 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_32 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_33 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_34 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_35 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_36 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_37 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_38 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_39 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_40 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_41 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_42 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_43 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_44 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_45 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_46 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_47 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_48 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_49 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_50 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_51 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_52 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_53 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_54 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_55 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_56 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_57 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_58 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_59 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_60 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_61 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_62 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_63 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_64 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_65 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_66 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_67 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_68 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_69 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_70 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_71 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_72 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_73 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_74 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_75 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_76 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_77 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_78 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_79 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_80 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_81 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_82 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_83 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_84 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_85 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_86 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_87 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_88 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_89 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_90 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_91 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_92 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_93 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_94 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_95 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_96 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_97 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_98 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_99 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_100 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_101 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_102 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_103 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_104 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_105 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_106 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_107 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_108 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_109 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_110 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_111 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_112 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_113 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_114 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_115 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_116 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_117 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_118 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_119 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_120 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_121 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_122 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_123 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_124 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_125 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_126 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_127 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_128 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_129 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_130 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_131 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_132 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_133 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_134 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_135 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_136 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_137 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_138 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_139 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_140 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_141 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_142 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_143 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_144 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_145 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_146 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_147 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_148 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_149 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_150 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_151 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_152 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_153 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_154 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_155 = {0};
...
HexaVal tc_register_generic_struct(HexaVal name, HexaVal tparams) {
    ...
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(count); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        generic_all_param_names = hexa_array_push(generic_all_param_names, hexa_map_get_ic(hexa_index_get(tparams, i), "name", &__hexa_codegen_c2_ic_0));
        HexaVal bound = hexa_map_get_ic(hexa_index_get(tparams, i), "value", &__hexa_codegen_c2_ic_1);
...
HexaVal tc_register_generic_fn(HexaVal name, HexaVal tparams) {
    ...
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(count); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        generic_fn_all_param_names = hexa_array_push(generic_fn_all_param_names, hexa_map_get_ic(hexa_index_get(tparams, i), "name", &__hexa_codegen_c2_ic_2));
        HexaVal bound = hexa_map_get_ic(hexa_index_get(tparams, i), "value", &__hexa_codegen_c2_ic_3);
        if (hexa_truthy(hexa_eq(bound, hexa_str("")))) {
...
HexaVal tc_push_type_params(HexaVal tparams) {
    ...
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(tparams))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        ...
        tparam_names = hexa_array_push(tparam_names, hexa_map_get_ic(tp, "name", &__hexa_codegen_c2_ic_4));
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(tp, "value", &__hexa_codegen_c2_ic_5), hexa_str("")))))) {
            tparam_bound = hexa_array_push(tparam_bound, hexa_map_get_ic(tp, "value", &__hexa_codegen_c2_ic_6));
        } else {
            tparam_bound = hexa_array_push(tparam_bound, hexa_str(""));
        }
        tc_define(hexa_map_get_ic(tp, "name", &__hexa_codegen_c2_ic_7), hexa_str("typeparam"));
        i = hexa_add(i, hexa_int(1));
    }
    return hexa_void();
}
...
HexaVal tc_validate_type_args(HexaVal struct_name, HexaVal type_args) {
    ...
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(actual); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        ...
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(bound, hexa_str("")))))) {
            HexaVal arg_name = hexa_map_get_ic(hexa_index_get(type_args, i), "name", &__hexa_codegen_c2_ic_8);
...
HexaVal tc_infer_expr(HexaVal node) {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_9);
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        return hexa_str("int");
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Range")))) {
        tc_infer_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_10));
        tc_infer_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_11));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        HexaVal typ = tc_lookup(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_12));
        if (hexa_truthy(hexa_eq(typ, hexa_str("")))) {
            tc_error(hexa_add(hexa_add(hexa_str("Undeclared variable '"), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_13)), hexa_str("'")));
            return hexa_str("unknown");
        }
        return typ;
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
        HexaVal lt = tc_infer_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_14));
        HexaVal rt = tc_infer_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_15));
        HexaVal op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_16);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        HexaVal ot = tc_infer_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_17));
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_18), hexa_str("!")))) {
        ...
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_19), hexa_str("-")))) {
            return ot;
        }
        return ot;
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Call")))) {
        HexaVal callee = hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_20);
        HexaVal arg_count = hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_21)));
        i = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(arg_count); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            tc_infer_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_22), i));
            i = hexa_add(i, hexa_int(1));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(callee, "kind", &__hexa_codegen_c2_ic_23), hexa_str("Ident")))) {
            HexaVal fn_arity = tc_lookup_fn_arity(hexa_map_get_ic(callee, "name", &__hexa_codegen_c2_ic_24));
            ...
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(fn_arity); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) >= (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i >= __r.i); }))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(fn_arity, arg_count))))))) {
                tc_error(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("Function '"), hexa_map_get_ic(callee, "name", &__hexa_codegen_c2_ic_25)), hexa_str("' expects ")), hexa_to_string(fn_arity)), hexa_str(" args, got ")), hexa_to_string(arg_count)));
            }
            return tc_lookup_fn_ret(hexa_map_get_ic(callee, "name", &__hexa_codegen_c2_ic_26));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(callee, "kind", &__hexa_codegen_c2_ic_27), hexa_str("Field")))) {
            tc_infer_expr(hexa_map_get_ic(callee, "left", &__hexa_codegen_c2_ic_28));
            return hexa_str("unknown");
        }
        return hexa_str("unknown");
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Field")))) {
        HexaVal obj_type = tc_infer_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_29));
        HexaVal field_name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_30);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Index")))) {
        tc_infer_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_31));
        HexaVal idx_type = tc_infer_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_32));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("IfExpr")))) {
        HexaVal cond_type = tc_infer_expr(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_33));
        ...
        tc_push_scope();
        tc_check_stmts(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_34));
        tc_pop_scope();
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_35), hexa_str(""))))) && hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_36)))); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))))) {
            tc_push_scope();
            tc_check_stmts(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_37));
            tc_pop_scope();
        }
        return hexa_str("unknown");
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("MatchExpr")))) {
        HexaVal match_type = tc_infer_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_38));
        HexaVal arm_count = hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_39)));
        ...
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(arm_count); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            HexaVal arm = hexa_index_get(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_40), i);
            HexaVal pat = hexa_map_get_ic(arm, "left", &__hexa_codegen_c2_ic_41);
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(pat, hexa_str(""))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(pat, "kind", &__hexa_codegen_c2_ic_42), hexa_str("Wildcard")))))) {
                has_wildcard = hexa_bool(1);
            }
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(pat, hexa_str(""))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(pat, "kind", &__hexa_codegen_c2_ic_43), hexa_str("EnumPath")))))) {
                covered_variants = hexa_array_push(covered_variants, hexa_map_get_ic(pat, "name", &__hexa_codegen_c2_ic_44));
            }
            tc_push_scope();
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(pat, hexa_str(""))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(pat, "kind", &__hexa_codegen_c2_ic_45), hexa_str("Ident")))))) {
                tc_define(hexa_map_get_ic(pat, "name", &__hexa_codegen_c2_ic_46), match_type);
            }
            tc_check_stmts(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_47));
            tc_pop_scope();
            i = hexa_add(i, hexa_int(1));
        }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("StructInit")))) {
        HexaVal sc = tc_lookup_struct(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_48));
        if (hexa_truthy(hexa_eq(sc, hexa_sub(hexa_int(0), hexa_int(1))))) {
            tc_error(hexa_add(hexa_add(hexa_str("Unknown struct '"), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_49)), hexa_str("'")));
        } else {
            HexaVal si_type_args = hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_50);
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(si_type_args, hexa_str(""))))) && hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(hexa_int(hexa_len(si_type_args))); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))))) {
                tc_validate_type_args(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_51), si_type_args);
            } else {
                HexaVal expected_tp = tc_lookup_generic_struct_param_count(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_52));
                if (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(expected_tp); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))) {
                    tc_warn(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("Generic struct '"), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_53)), hexa_str("' used without type arguments (expected ")), hexa_to_string(expected_tp)), hexa_str(")")));
                }
            }
            i = hexa_int(0);
            while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_54)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                HexaVal fld = hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_55), i);
                HexaVal init_type = tc_infer_expr(hexa_map_get_ic(fld, "left", &__hexa_codegen_c2_ic_56));
                HexaVal expected_type = tc_lookup_struct_field(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_57), hexa_map_get_ic(fld, "name", &__hexa_codegen_c2_ic_58));
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(expected_type, hexa_str(""))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(fld, "name", &__hexa_codegen_c2_ic_59), hexa_str("")))))))) {
                    tc_error(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("Struct '"), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_60)), hexa_str("' has no field '")), hexa_map_get_ic(fld, "name", &__hexa_codegen_c2_ic_61)), hexa_str("'")));
                } else {
                    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(expected_type, hexa_str(""))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(init_type, hexa_str("unknown")))))))) {
                        ...
                        if (hexa_truthy(hexa_bool(!hexa_truthy(types_compatible(et, init_type))))) {
                            tc_error_at(hexa_map_get_ic(fld, "name", &__hexa_codegen_c2_ic_62), hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("Field type mismatch: expected '"), et), hexa_str("', got '")), init_type), hexa_str("'")));
                        }
                    }
                }
                i = hexa_add(i, hexa_int(1));
            }
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_63))), sc))))) {
                tc_warn(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("Struct '"), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_64)), hexa_str("' has ")), hexa_to_string(sc)), hexa_str(" fields, but ")), hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_65))))), hexa_str(" provided")));
            }
        }
        return hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_66);
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumPath")))) {
        return hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_67);
    }
    return hexa_str("unknown");
    return hexa_void();
}
...
HexaVal tc_check_stmt(HexaVal node) {
    ...
    HexaVal i = hexa_void();
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_68);
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt")))))) {
        typ = tc_infer_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_69));
        ann = annotation_to_type(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_70));
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(ann, hexa_str("unknown"))))) && hexa_truthy(hexa_bool(!hexa_truthy(types_compatible(ann, typ))))))) {
            tc_error_at(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_71), hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("Type mismatch: declared '"), ann), hexa_str("' but assigned '")), typ), hexa_str("'")));
        }
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(ann, hexa_str("unknown")))))) {
            tc_define(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_72), ann);
        } else {
            tc_define(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_73), typ);
        }
        return hexa_void();
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("ConstStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("StaticStmt")))))) {
        typ = tc_infer_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_74));
        ann = annotation_to_type(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_75));
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(ann, hexa_str("unknown")))))) {
            tc_define(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_76), ann);
        } else {
            tc_define(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_77), typ);
        }
        return hexa_void();
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FnDecl")))) {
        HexaVal arity = hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_78)));
        HexaVal fn_tparams = hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_79);
        ...
        if (hexa_truthy(has_tparams)) {
            tc_register_generic_fn(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_80), fn_tparams);
        }
        HexaVal ret = annotation_to_type(hexa_map_get_ic(node, "ret_type", &__hexa_codegen_c2_ic_81));
        tc_register_fn(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_82), arity, ret);
        tc_define(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_83), hexa_str("fn"));
        HexaVal prev_fn_ret = current_fn_ret_type;
        HexaVal prev_fn_name = current_fn_name;
        current_fn_ret_type = ret;
        current_fn_name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_84);
        tc_push_scope();
        if (hexa_truthy(has_tparams)) {
        ...
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(arity); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            HexaVal p = hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_85), i);
            HexaVal ptype = annotation_to_type(hexa_map_get_ic(p, "value", &__hexa_codegen_c2_ic_86));
            tc_define(hexa_map_get_ic(p, "name", &__hexa_codegen_c2_ic_87), ptype);
            i = hexa_add(i, hexa_int(1));
        }
        tc_check_stmts(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_88));
        tc_pop_scope();
        if (hexa_truthy(has_tparams)) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("StructDecl")))) {
        HexaVal fc = hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_89)));
        tc_register_struct(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_90), fc);
        HexaVal st_tparams = hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_91);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(st_tparams, hexa_str(""))))) && hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(hexa_int(hexa_len(st_tparams))); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))))) {
            tc_register_generic_struct(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_92), st_tparams);
        }
        HexaVal fi = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(fi); HexaVal __r=(fc); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            HexaVal f = hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_93), fi);
            tc_register_struct_field(hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_94), hexa_map_get_ic(f, "value", &__hexa_codegen_c2_ic_95));
            fi = hexa_add(fi, hexa_int(1));
        }
        tc_define(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_96), hexa_str("type"));
        return hexa_void();
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumDecl")))) {
        HexaVal vc = hexa_int(hexa_len(hexa_map_get_ic(node, "variants", &__hexa_codegen_c2_ic_97)));
        tc_register_enum(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_98), vc);
        HexaVal vi = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(vi); HexaVal __r=(vc); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            tc_register_enum_variant(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "variants", &__hexa_codegen_c2_ic_99), vi), "name", &__hexa_codegen_c2_ic_100));
            vi = hexa_add(vi, hexa_int(1));
        }
        tc_define(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_101), hexa_str("type"));
        return hexa_void();
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("TraitDecl")))) {
        tc_define(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_102), hexa_str("type"));
        return hexa_void();
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ImplBlock")))) {
        tc_push_scope();
        i = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "methods", &__hexa_codegen_c2_ic_103)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            tc_check_stmt(hexa_index_get(hexa_map_get_ic(node, "methods", &__hexa_codegen_c2_ic_104), i));
            i = hexa_add(i, hexa_int(1));
        }
        tc_pop_scope();
        return hexa_void();
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ForStmt")))) {
        tc_infer_expr(hexa_map_get_ic(node, "iter_expr", &__hexa_codegen_c2_ic_105));
        tc_push_scope();
        tc_define(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_106), hexa_str("unknown"));
        tc_check_stmts(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_107));
        tc_pop_scope();
        return hexa_void();
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("WhileStmt")))) {
        HexaVal cond_type = tc_infer_expr(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_108));
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(cond_type, hexa_str("bool"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(cond_type, hexa_str("unknown")))))))) {
            tc_error(hexa_add(hexa_add(hexa_str("While condition must be bool, got '"), cond_type), hexa_str("'")));
        }
        tc_push_scope();
        tc_check_stmts(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_109));
        tc_pop_scope();
        return hexa_void();
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("LoopStmt")))) {
        tc_push_scope();
        tc_check_stmts(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_110));
        tc_pop_scope();
        return hexa_void();
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ReturnStmt")))) {
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_111), hexa_str("")))))) {
            HexaVal ret_val_type = tc_infer_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_112));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("AssignStmt")))) {
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_113), hexa_str(""))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_114), "kind", &__hexa_codegen_c2_ic_115), hexa_str("Ident")))))) {
            typ = tc_lookup(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_116), "name", &__hexa_codegen_c2_ic_117));
            if (hexa_truthy(hexa_eq(typ, hexa_str("")))) {
                tc_error(hexa_add(hexa_add(hexa_str("Assignment to undeclared variable '"), hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_118), "name", &__hexa_codegen_c2_ic_119)), hexa_str("'")));
            }
        }
        tc_infer_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_120));
        tc_infer_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_121));
        return hexa_void();
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ExprStmt")))) {
        tc_infer_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_122));
        return hexa_void();
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("AssertStmt")))) {
        HexaVal t = tc_infer_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_123));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ProofStmt")))) {
        tc_push_scope();
        tc_check_stmts(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_124));
        tc_pop_scope();
        return hexa_void();
    }
    return hexa_void();
...
HexaVal tc_first_pass(HexaVal stmts) {
    ...
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(stmts))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        ...
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(s, "kind", &__hexa_codegen_c2_ic_125), hexa_str("FnDecl")))) {
            tc_register_fn(hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_126), hexa_int(hexa_len(hexa_map_get_ic(s, "params", &__hexa_codegen_c2_ic_127))), annotation_to_type(hexa_map_get_ic(s, "ret_type", &__hexa_codegen_c2_ic_128)));
            tc_define(hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_129), hexa_str("fn"));
            HexaVal fp_tparams = hexa_map_get_ic(s, "items", &__hexa_codegen_c2_ic_130);
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(fp_tparams, hexa_str(""))))) && hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(hexa_int(hexa_len(fp_tparams))); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))))) {
                tc_register_generic_fn(hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_131), fp_tparams);
            }
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(s, "kind", &__hexa_codegen_c2_ic_132), hexa_str("StructDecl")))) {
            HexaVal fc = hexa_int(hexa_len(hexa_map_get_ic(s, "fields", &__hexa_codegen_c2_ic_133)));
            tc_register_struct(hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_134), fc);
            HexaVal fi = hexa_int(0);
            while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(fi); HexaVal __r=(fc); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                tc_register_struct_field(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(s, "fields", &__hexa_codegen_c2_ic_135), fi), "name", &__hexa_codegen_c2_ic_136), hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(s, "fields", &__hexa_codegen_c2_ic_137), fi), "value", &__hexa_codegen_c2_ic_138));
                fi = hexa_add(fi, hexa_int(1));
            }
            HexaVal sp_tparams = hexa_map_get_ic(s, "items", &__hexa_codegen_c2_ic_139);
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(sp_tparams, hexa_str(""))))) && hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(hexa_int(hexa_len(sp_tparams))); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))))) {
                tc_register_generic_struct(hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_140), sp_tparams);
            }
            tc_define(hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_141), hexa_str("type"));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(s, "kind", &__hexa_codegen_c2_ic_142), hexa_str("EnumDecl")))) {
            HexaVal vc = hexa_int(hexa_len(hexa_map_get_ic(s, "variants", &__hexa_codegen_c2_ic_143)));
            tc_register_enum(hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_144), vc);
            HexaVal vi = hexa_int(0);
            while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(vi); HexaVal __r=(vc); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                tc_register_enum_variant(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(s, "variants", &__hexa_codegen_c2_ic_145), vi), "name", &__hexa_codegen_c2_ic_146));
                vi = hexa_add(vi, hexa_int(1));
            }
            tc_define(hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_147), hexa_str("type"));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(s, "kind", &__hexa_codegen_c2_ic_148), hexa_str("TraitDecl")))) {
            tc_define(hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_149), hexa_str("type"));
        }
        i = hexa_add(i, hexa_int(1));
    }
    return hexa_void();
...
HexaVal print_type_errors(HexaVal errors) {
    ...
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(errors))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        ...
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(e, "name", &__hexa_codegen_c2_ic_150), hexa_str("")))))) {
            hexa_println(hexa_format_n(hexa_str("  TYPE ERROR [{}]: {}"), hexa_array_push(hexa_array_push(hexa_array_new(), hexa_map_get_ic(e, "name", &__hexa_codegen_c2_ic_151)), hexa_map_get_ic(e, "message", &__hexa_codegen_c2_ic_152))));
        } else {
            hexa_println(hexa_format_n(hexa_str("  TYPE ERROR: {}"), hexa_array_push(hexa_array_new(), hexa_map_get_ic(e, "message", &__hexa_codegen_c2_ic_153))));
        }
        i = hexa_add(i, hexa_int(1));
    }
    return hexa_void();
...
HexaVal type_errors_has(HexaVal errors, HexaVal substr) {
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(errors))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        HexaVal msg = hexa_map_get_ic(hexa_index_get(errors, i), "message", &__hexa_codegen_c2_ic_154);
...
HexaVal type_warnings_count(HexaVal errors) {
    ...
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(errors))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        if (hexa_truthy(hexa_bool(hexa_str_contains(hexa_map_get_ic(hexa_index_get(errors, i), "message", &__hexa_codegen_c2_ic_155), hexa_str("[warn]"))))) {
            count = hexa_add(count, hexa_int(1));
        }
        i = hexa_add(i, hexa_int(1));
    }
...
// dedup: static HexaIC __hexa_codegen_c2_ic_154 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_155 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_156 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_157 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_158 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_159 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_160 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_161 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_162 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_163 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_164 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_165 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_166 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_167 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_168 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_169 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_170 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_171 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_172 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_173 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_174 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_175 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_176 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_177 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_178 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_179 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_180 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_181 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_182 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_183 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_184 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_185 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_186 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_187 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_188 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_189 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_190 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_191 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_192 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_193 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_194 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_195 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_196 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_197 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_198 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_199 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_200 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_201 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_202 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_203 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_204 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_205 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_206 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_207 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_208 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_209 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_210 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_211 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_212 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_213 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_214 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_215 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_216 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_217 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_218 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_219 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_220 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_221 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_222 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_223 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_224 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_225 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_226 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_227 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_228 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_229 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_230 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_231 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_232 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_233 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_234 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_235 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_236 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_237 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_238 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_239 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_240 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_241 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_242 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_243 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_244 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_245 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_246 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_247 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_248 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_249 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_250 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_251 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_252 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_253 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_254 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_255 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_256 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_257 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_258 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_259 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_260 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_261 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_262 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_263 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_264 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_265 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_266 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_267 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_268 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_269 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_270 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_271 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_272 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_273 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_274 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_275 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_276 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_277 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_278 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_279 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_280 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_281 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_282 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_283 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_284 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_285 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_286 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_287 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_288 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_289 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_290 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_291 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_292 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_293 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_294 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_295 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_296 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_297 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_298 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_299 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_300 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_301 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_302 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_303 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_304 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_305 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_306 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_307 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_308 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_309 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_310 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_311 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_312 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_313 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_314 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_315 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_316 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_317 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_318 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_319 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_320 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_321 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_322 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_323 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_324 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_325 = {0};
// dedup: static HexaIC __hexa_codegen_c2_ic_326 = {0};
...
HexaVal codegen_c2(HexaVal ast) {
    ...
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(_gi); HexaVal __r=(hexa_int(hexa_len(ast))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(_gk, hexa_str("FnDecl"))) || hexa_truthy(hexa_eq(_gk, hexa_str("ExternFnDecl"))))) || hexa_truthy(hexa_eq(_gk, hexa_str("PureFnDecl"))))) || hexa_truthy(hexa_eq(_gk, hexa_str("OptimizeFnStmt")))))) {
            ...
            if (hexa_truthy(hexa_eq(_gk, hexa_str("StructDecl")))) {
                _known_fn_globals = hexa_array_push(_known_fn_globals, hexa_map_get_ic(hexa_index_get(ast, _gi), "name", &__hexa_codegen_c2_ic_3));
                _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, _gi), "name", &__hexa_codegen_c2_ic_4));
            } else {
                if (hexa_truthy(hexa_eq(_gk, hexa_str("EnumDecl")))) {
                    _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, _gi), "name", &__hexa_codegen_c2_ic_5));
                } else {
                    if (hexa_truthy(hexa_eq(_gk, hexa_str("ComptimeConst")))) {
                        ...
                        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(_gk, hexa_str("LetMutStmt"))) || hexa_truthy(hexa_eq(_gk, hexa_str("LetStmt")))))) {
                            _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, _gi), "name", &__hexa_codegen_c2_ic_7));
                        }
                    }
                }
            }
    ...
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(ast))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        ...
        if (hexa_truthy(hexa_eq(k, hexa_str("FnDecl")))) {
            ...
            if (hexa_truthy(hexa_eq(k, hexa_str("ExternFnDecl")))) {
                extern_fns = hexa_array_push(extern_fns, hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_9));
                HexaVal ew = gen2_extern_wrapper(hexa_index_get(ast, i));
                global_parts = hexa_array_push(global_parts, hexa_map_get_ic(ew, "global", &__hexa_codegen_c2_ic_10));
                fwd_parts = hexa_array_push(fwd_parts, hexa_add(hexa_map_get_ic(ew, "forward", &__hexa_codegen_c2_ic_11), hexa_str("\n")));
                fn_parts = hexa_array_push(fn_parts, hexa_add(hexa_map_get_ic(ew, "fn_code", &__hexa_codegen_c2_ic_12), hexa_str("\n\n")));
                main_parts = hexa_array_push(main_parts, hexa_map_get_ic(ew, "init", &__hexa_codegen_c2_ic_13));
            } else {
                if (hexa_truthy(hexa_eq(k, hexa_str("StructDecl")))) {
                    ...
                    if (hexa_truthy(hexa_eq(k, hexa_str("EnumDecl")))) {
                        ...
                        if (hexa_truthy(hexa_eq(k, hexa_str("ImplBlock")))) {
                            ...
                            fwd_parts = hexa_array_push(fwd_parts, hexa_map_get_ic(ib, "forward", &__hexa_codegen_c2_ic_14));
                            fn_parts = hexa_array_push(fn_parts, hexa_map_get_ic(ib, "fn_code", &__hexa_codegen_c2_ic_15));
                        } else {
                            if (hexa_truthy(hexa_eq(k, hexa_str("PureFnDecl")))) {
                                fwd_parts = hexa_array_push(fwd_parts, hexa_add(gen2_fn_forward(hexa_index_get(ast, i)), hexa_str("\n")));
                                fn_parts = hexa_array_push(fn_parts, hexa_add(gen2_fn_decl(hexa_index_get(ast, i)), hexa_str("\n\n")));
                                ...
                                if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeConst")))) {
                                    HexaVal _cc_folded = comptime_eval(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_16));
                                    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(_cc_folded), hexa_str("string")))))) {
                                        _register_comptime_const(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_17), _cc_folded);
                                    } else {
                                        global_parts = hexa_array_push(global_parts, hexa_add(hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_18)), hexa_str(";\n")));
                                        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_19)), hexa_str("string")))))) {
                                            main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_20)), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_21))), hexa_str(";\n")));
                                        } else {
                                            main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_str("    "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_22)), hexa_str(" = hexa_void();\n")));
                                        }
                                    }
                                } else {
                                    if (hexa_truthy(hexa_eq(k, hexa_str("OptimizeFnStmt")))) {
                                        ...
                                        if (hexa_truthy(hexa_eq(k, hexa_str("TraitDecl")))) {
                                            ...
                                            if (hexa_truthy(hexa_eq(k, hexa_str("InvariantDecl")))) {
                                                ...
                                                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("ImportStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("UseStmt")))))) {
                                                    (hexa_eprint_val(hexa_add(hexa_str("[codegen_c2] WARNING: import/use not fully resolved: "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_23))), fprintf(stderr, "\n"), hexa_void());
                                                    main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_str("    /* import: "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_24)), hexa_str(" */\n")));
                                                } else {
                                                    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("LetStmt")))))) {
                                                        HexaVal _user_name = _hexa_mangle_ident(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_25));
                                                        HexaVal _tls_val = hexa_map_get_ic(hexa_index_get(ast, i), "value", &__hexa_codegen_c2_ic_26);
                                                        ...
                                                        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_27)), hexa_str("string")))))) {
                                                            main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    "), _user_name), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_28))), hexa_str(";\n")));
                                                        } else {
...
HexaVal gen2_has_attr(HexaVal node, HexaVal target) {
    HexaVal v = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_29);
...
HexaVal gen2_has_inline_always(HexaVal node) {
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_30)), hexa_str("string")))))) {
        return hexa_bool(0);
    }
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_31), hexa_str("")))) {
        return hexa_bool(0);
    }
    HexaVal attrs = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_32);
...
HexaVal gen2_fn_forward(HexaVal node) {
    ...
    HexaVal params = hexa_array_new();
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_33)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        if (hexa_truthy(has_restrict)) {
            params = hexa_array_push(params, hexa_add(hexa_str("HexaVal __restrict "), hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_34), i), "name", &__hexa_codegen_c2_ic_35)));
        } else {
            params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_36), i), "name", &__hexa_codegen_c2_ic_37)));
        }
        i = hexa_add(i, hexa_int(1));
    }
    ...
    return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(prefix, hexa_str("HexaVal ")), _hexa_mangle_ident(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_38))), hexa_str("(")), p), hexa_str(");"));
    return hexa_void();
}


HexaVal gen2_has_specialize(HexaVal node) {
    HexaVal attrs = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_39);
...
HexaVal gen2_specialize_guard(HexaVal node) {
    if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_40))), hexa_int(0)))) {
        return hexa_str("");
    }
    HexaVal p0 = hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_41), hexa_int(0)), "name", &__hexa_codegen_c2_ic_42);
    HexaVal out = hexa_str("");
    out = hexa_add(out, hexa_str("    /* @specialize: inline cache type guard */\n"));
    out = hexa_add(hexa_add(hexa_add(out, hexa_str("    if (")), p0), hexa_str(".tag == TAG_INT) {\n"));
    out = hexa_add(out, hexa_str("        /* monomorphic int fast-path: skip tag checks */\n"));
    out = hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(out, hexa_str("        int64_t __spec_")), p0), hexa_str(" = ")), p0), hexa_str(".i;\n"));
...
HexaVal gen2_fn_decl(HexaVal node) {
    ...
    HexaVal params = hexa_array_new();
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_43)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        if (hexa_truthy(has_restrict)) {
            params = hexa_array_push(params, hexa_add(hexa_str("HexaVal __restrict "), hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_44), i), "name", &__hexa_codegen_c2_ic_45)));
        } else {
            params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_46), i), "name", &__hexa_codegen_c2_ic_47)));
        }
        i = hexa_add(i, hexa_int(1));
    }
    HexaVal p = hexa_str_join(params, hexa_str(", "));
    ...
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_48)), hexa_str("string"))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_49), hexa_str("")))))))) {
        HexaVal _sa_attrs = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_50);
    ...
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(_pi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_51)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        _gen2_declared_names = hexa_array_push(_gen2_declared_names, hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_52), _pi), "name", &__hexa_codegen_c2_ic_53));
        _pi = hexa_add(_pi, hexa_int(1));
    }
    HexaVal all_names = _gen2_collect_lets(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_54), hexa_array_new());
    ...
    HexaVal _fn_name = _hexa_mangle_ident(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_55));
    HexaVal prefix = hexa_str("");
    if (hexa_truthy(gen2_has_inline_always(node))) {
        prefix = hexa_str("static inline ");
    }
...
HexaVal gen2_stmt_stack_alloc(HexaVal node, HexaVal depth) {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_59);
    if (hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt")))) {
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_60)), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_61), "kind", &__hexa_codegen_c2_ic_62), hexa_str("ArrayLit")))))) {
            return hexa_add(hexa_add(hexa_add(pad, hexa_str("/* @stack_alloc */ HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_63)), hexa_str(" = hexa_stack_array(1024);\n"));
        }
    }
...
HexaVal gen2_extern_static_decl(HexaVal node) {
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_65);
    HexaVal ret_type = hexa_map_get_ic(node, "ret_type", &__hexa_codegen_c2_ic_66);
    HexaVal c_name = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_67);
    ...
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_68)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        HexaVal p = hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_69), i);
        HexaVal c_typ = gen2_static_c_type(hexa_map_get_ic(p, "value", &__hexa_codegen_c2_ic_70));
        if (hexa_truthy(hexa_eq(c_typ, hexa_str("void")))) {
            c_params = hexa_array_push(c_params, hexa_add(hexa_str("long long "), hexa_map_get_ic(p, "name", &__hexa_codegen_c2_ic_71)));
        } else {
            c_params = hexa_array_push(c_params, hexa_add(hexa_add(c_typ, hexa_str(" ")), hexa_map_get_ic(p, "name", &__hexa_codegen_c2_ic_72)));
        }
        i = hexa_add(i, hexa_int(1));
    }
    ...
    HexaVal parts = hexa_array_new();
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_73), hexa_str("")))))) {
        parts = hexa_array_push(parts, hexa_add(hexa_add(hexa_str("// link: -l"), hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_74)), hexa_str("\n")));
    }
...
HexaVal gen2_extern_includes(HexaVal ast) {
    ...
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(ast))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_index_get(ast, i), "kind", &__hexa_codegen_c2_ic_75), hexa_str("ExternFnDecl")))) {
            has_extern = hexa_int(1);
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_index_get(ast, i), "op", &__hexa_codegen_c2_ic_76), hexa_str("m"))) || hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_index_get(ast, i), "op", &__hexa_codegen_c2_ic_77), hexa_str("libm")))))) {
                needs_math = hexa_int(1);
            }
            HexaVal j = hexa_int(0);
            while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(j); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(hexa_index_get(ast, i), "params", &__hexa_codegen_c2_ic_78)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                HexaVal t = hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(hexa_index_get(ast, i), "params", &__hexa_codegen_c2_ic_79), j), "value", &__hexa_codegen_c2_ic_80);
            ...
            HexaVal rt = hexa_map_get_ic(hexa_index_get(ast, i), "ret_type", &__hexa_codegen_c2_ic_81);
...
HexaVal gen2_static_ffi_block(HexaVal ast) {
    ...
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(ast))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_index_get(ast, i), "kind", &__hexa_codegen_c2_ic_82), hexa_str("ExternFnDecl")))) {
...
HexaVal gen2_extern_wrapper(HexaVal node) {
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_83);
    HexaVal nargs = hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_84)));
    HexaVal ret_type = hexa_map_get_ic(node, "ret_type", &__hexa_codegen_c2_ic_85);
    HexaVal c_sym = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_86);
    ...
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(fi); HexaVal __r=(nargs); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        fwd_params = hexa_array_push(fwd_params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_87), fi), "name", &__hexa_codegen_c2_ic_88)));
        fi = hexa_add(fi, hexa_int(1));
    }
    ...
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(has_float, hexa_int(1))) || hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(nargs); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))))) {
        ...
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(ti); HexaVal __r=(nargs); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            typedef_params = hexa_array_push(typedef_params, gen2_ffi_c_type(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_90), ti), "value", &__hexa_codegen_c2_ic_91)));
        ...
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(ci); HexaVal __r=(nargs); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            call_args = hexa_array_push(call_args, gen2_ffi_marshal_arg(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_92), ci), "name", &__hexa_codegen_c2_ic_93), hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_94), ci), "value", &__hexa_codegen_c2_ic_95)));
            ci = hexa_add(ci, hexa_int(1));
        }
    ...
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_96), hexa_str("")))))) {
        lib_arg = hexa_add(hexa_add(hexa_str("\""), hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_97)), hexa_str("\""));
    }
...
HexaVal _gen2_collect_lets_stmt(HexaVal node, HexaVal names) {
    ...
    HexaVal sk = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_98);
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(sk, hexa_str("LetStmt"))) || hexa_truthy(hexa_eq(sk, hexa_str("LetMutStmt")))))) {
        names = hexa_array_push(names, hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_99));
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_100)), hexa_str("string")))))) {
        names = _gen2_collect_lets(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_101), names);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_102)), hexa_str("string")))))) {
        names = _gen2_collect_lets(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_103), names);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_104)), hexa_str("string")))))) {
        names = _gen2_collect_lets(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_105), names);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_106)), hexa_str("string")))))) {
        HexaVal ai = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(ai); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_107)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            HexaVal arm = hexa_index_get(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_108), ai);
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(arm), hexa_str("string"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_109)), hexa_str("string")))))))) {
                names = _gen2_collect_lets(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_110), names);
            }
            ai = hexa_add(ai, hexa_int(1));
        }
    }
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(sk, hexa_str("ExprStmt"))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_111)), hexa_str("string")))))))) {
        names = _gen2_collect_lets_stmt(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_112), names);
    }
    return names;
    return hexa_void();
}
...
HexaVal gen2_stmt(HexaVal node, HexaVal depth) {
    ...
    HexaVal pad = gen2_indent(depth);
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_113);
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt")))))) {
        HexaVal init = hexa_str("hexa_void()");
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_114)), hexa_str("string")))))) {
            init = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_115));
        }
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt"))) && hexa_truthy(hexa_eq(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_116), hexa_str("__reg_promote__")))))) {
            return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("register HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_117)), hexa_str(" = ")), init), hexa_str("; /* reg-promoted */\n"));
        }
        if (hexa_truthy(_gen2_has_decl(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_118)))) {
            return hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_119)), hexa_str(" = ")), init), hexa_str(";\n"));
        }
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_120)), hexa_str(" = ")), init), hexa_str(";\n"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ConstStmt")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_121)), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_122))), hexa_str(";\n"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("AssignStmt")))) {
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_123)), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_124), "kind", &__hexa_codegen_c2_ic_125), hexa_str("Index")))))) {
            HexaVal container = gen2_expr(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_126), "left", &__hexa_codegen_c2_ic_127));
            HexaVal idx = gen2_expr(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_128), "right", &__hexa_codegen_c2_ic_129));
            val = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_130));
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_131)), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_132), "kind", &__hexa_codegen_c2_ic_133), hexa_str("Field")))))) {
            HexaVal obj = gen2_expr(hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_134), "left", &__hexa_codegen_c2_ic_135));
            HexaVal field = hexa_map_get_ic(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_136), "name", &__hexa_codegen_c2_ic_137);
            val = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_138));
        ...
        return hexa_add(hexa_add(hexa_add(hexa_add(pad, gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_139))), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_140))), hexa_str(";\n"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("CompoundAssign")))) {
        HexaVal lhs = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_141));
        HexaVal rhs = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_142));
        HexaVal op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_143);
        if (hexa_truthy(hexa_eq(op, hexa_str("+=")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ReturnStmt")))) {
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_144)), hexa_str("string")))))) {
            return hexa_add(hexa_add(hexa_add(pad, hexa_str("return ")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_145))), hexa_str(";\n"));
        }
        return hexa_add(pad, hexa_str("return hexa_void();\n"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ExprStmt")))) {
        HexaVal expr = hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_146);
        if (hexa_truthy(hexa_eq(hexa_type_of(expr), hexa_str("string")))) {
            return hexa_str("");
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(expr, "kind", &__hexa_codegen_c2_ic_147), hexa_str("MatchExpr")))) {
            return gen2_match_stmt(expr, depth);
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(expr, "kind", &__hexa_codegen_c2_ic_148), hexa_str("IfExpr")))) {
            chunks = hexa_array_new();
            chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(pad, hexa_str("if (hexa_truthy(")), gen2_expr(hexa_map_get_ic(expr, "cond", &__hexa_codegen_c2_ic_149))), hexa_str(")) {\n")));
            ti = hexa_int(0);
            while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(ti); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(expr, "then_body", &__hexa_codegen_c2_ic_150)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(expr, "then_body", &__hexa_codegen_c2_ic_151), ti), hexa_add(depth, hexa_int(1))));
                ti = hexa_add(ti, hexa_int(1));
            }
            chunks = hexa_array_push(chunks, hexa_add(pad, hexa_str("}")));
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(expr, "else_body", &__hexa_codegen_c2_ic_152)), hexa_str("string"))))) && hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(hexa_int(hexa_len(hexa_map_get_ic(expr, "else_body", &__hexa_codegen_c2_ic_153)))); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))))) {
                chunks = hexa_array_push(chunks, hexa_str(" else {\n"));
                HexaVal ei = hexa_int(0);
                while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(ei); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(expr, "else_body", &__hexa_codegen_c2_ic_154)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                    chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(expr, "else_body", &__hexa_codegen_c2_ic_155), ei), hexa_add(depth, hexa_int(1))));
                    ei = hexa_add(ei, hexa_int(1));
                }
                chunks = hexa_array_push(chunks, hexa_add(pad, hexa_str("}")));
            }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("WhileStmt")))) {
        chunks = hexa_array_new();
        chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(pad, hexa_str("while (hexa_truthy(")), gen2_expr(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_156))), hexa_str(")) {\n")));
        HexaVal wi = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(wi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_157)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_158), wi), hexa_add(depth, hexa_int(1))));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ForStmt")))) {
        HexaVal iter = hexa_map_get_ic(node, "iter_expr", &__hexa_codegen_c2_ic_159);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(iter), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(iter, "kind", &__hexa_codegen_c2_ic_160), hexa_str("Range")))))) {
            HexaVal s = gen2_expr(hexa_map_get_ic(iter, "left", &__hexa_codegen_c2_ic_161));
            HexaVal e = gen2_expr(hexa_map_get_ic(iter, "right", &__hexa_codegen_c2_ic_162));
            chunks = hexa_array_new();
            chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("for (HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_163)), hexa_str(" = ")), s), hexa_str("; ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_164)), hexa_str(".i < (")), e), hexa_str(").i; ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_165)), hexa_str(".i++) {\n")));
            fi = hexa_int(0);
            while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(fi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_166)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_167), fi), hexa_add(depth, hexa_int(1))));
                fi = hexa_add(fi, hexa_int(1));
            }
            chunks = hexa_array_push(chunks, hexa_add(pad, hexa_str("}\n")));
            return hexa_str_join(chunks, hexa_str(""));
        ...
        chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(pad3, hexa_str("HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_168)), hexa_str(" = hexa_iter_get(__iter_arr, __fi);\n")));
        fi = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(fi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_169)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_170), fi), hexa_add(depth, hexa_int(2))));
            fi = hexa_add(fi, hexa_int(1));
        }
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("AssertStmt")))) {
        return hexa_add(hexa_add(hexa_add(pad, hexa_str("if (!hexa_truthy(")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_171))), hexa_str(")) { fprintf(stderr, \"assertion failed\\n\"); exit(1); }\n"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("ThrowStmt")))) {
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_172)), hexa_str("string")))))) {
            return hexa_add(hexa_add(hexa_add(pad, hexa_str("hexa_throw(")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_173))), hexa_str(");\n"));
        }
    ...
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("TryCatchStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("TryCatch")))))) {
        HexaVal try_body = hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_174);
        HexaVal catch_body = hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_175);
        HexaVal catch_var = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_176);
        chunks = hexa_array_new();
        chunks = hexa_array_push(chunks, hexa_add(pad, hexa_str("{\n")));
        pad2 = gen2_indent(hexa_add(depth, hexa_int(1)));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("LoopStmt")))) {
        ...
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(li); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_177)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_178), li), hexa_add(depth, hexa_int(1))));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("GuardStmt")))) {
        chunks = hexa_array_new();
        chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(pad, hexa_str("if (!hexa_truthy(")), gen2_expr(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_179))), hexa_str(")) {\n")));
        HexaVal gi = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(gi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_180)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_181), gi), hexa_add(depth, hexa_int(1))));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("GuardLetStmt")))) {
        chunks = hexa_array_new();
        chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_182)), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_183))), hexa_str(";\n")));
        chunks = hexa_array_push(chunks, hexa_add(hexa_add(hexa_add(pad, hexa_str("if (!hexa_truthy(")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_184)), hexa_str(")) {\n")));
        HexaVal gli = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(gli); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_185)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_186), gli), hexa_add(depth, hexa_int(1))));
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeConst")))) {
        HexaVal _cc_local = comptime_eval(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_187));
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(_cc_local), hexa_str("string")))))) {
            _register_comptime_const(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_188), _cc_local);
            return hexa_str("");
        }
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(pad, hexa_str("HexaVal ")), hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_189)), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_190))), hexa_str(";\n"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("OptimizeFnStmt")))) {
        return hexa_str("");
    }
...
HexaVal gen2_method_builtin(HexaVal obj_expr, HexaVal method, HexaVal args) {
    ...
    // T33-rebuild: manually injected method dispatches (mirrors codegen_c2.hexa).
...
HexaVal gen2_expr(HexaVal node) {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_191);
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        return hexa_add(hexa_add(hexa_str("hexa_int("), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_192)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
        return hexa_add(hexa_add(hexa_str("hexa_float("), hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_193)), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BoolLit")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_194), hexa_str("true")))) {
            return hexa_str("hexa_bool(1)");
        }
        return hexa_str("hexa_bool(0)");
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StringLit")))) {
        return hexa_add(hexa_add(hexa_str("hexa_str(\""), c_escape(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_195))), hexa_str("\")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("CharLit")))) {
        return hexa_add(hexa_add(hexa_str("hexa_str(\""), c_escape(hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_196))), hexa_str("\")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        HexaVal _cc_inline = _lookup_comptime_const(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_197));
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(_cc_inline), hexa_str("string")))))) {
            return gen2_expr(_cc_inline);
        }
        return _hexa_mangle_ident(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_198));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
        HexaVal l = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_199));
        HexaVal r = gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_200));
        HexaVal op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_201);
        if (hexa_truthy(hexa_eq(op, hexa_str("+")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_202), hexa_str("-")))) {
            return hexa_add(hexa_add(hexa_str("hexa_sub(hexa_int(0), "), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_203))), hexa_str(")"));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_204), hexa_str("!")))) {
            return hexa_add(hexa_add(hexa_str("hexa_bool(!hexa_truthy("), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_205))), hexa_str("))"));
        }
        (hexa_eprint_val(hexa_add(hexa_str("[codegen_c2] ERROR: unhandled unary operator: "), hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_206))), fprintf(stderr, "\n"), hexa_void());
        return hexa_add(hexa_add(hexa_str("(fprintf(stderr, \"CODEGEN ERROR: unhandled unary op: "), hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_207)), hexa_str("\\n\"), exit(1), hexa_void())"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Field")))) {
        obj = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_208));
        HexaVal field = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_209);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("StructInit")))) {
        name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_210);
        arg_strs = hexa_array_new();
        si = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(si); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_211)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            arg_strs = hexa_array_push(arg_strs, gen2_expr(hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_212), si), "left", &__hexa_codegen_c2_ic_213)));
            si = hexa_add(si, hexa_int(1));
        }
        return hexa_add(hexa_add(hexa_add(name, hexa_str("(")), hexa_str_join(arg_strs, hexa_str(", "))), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Call")))) {
        HexaVal callee = hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_214);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(callee), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(callee, "kind", &__hexa_codegen_c2_ic_215), hexa_str("Ident")))))) {
            name = hexa_map_get_ic(callee, "name", &__hexa_codegen_c2_ic_216);
            if (hexa_truthy(hexa_eq(name, hexa_str("println")))) {
                if (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_217)))); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))) {
                    return hexa_add(hexa_add(hexa_str("hexa_println("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_218), hexa_int(0)))), hexa_str(")"));
                }
                return hexa_str("(printf(\"\\n\"), hexa_void())");
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("print")))) {
                if (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_219)))); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))) {
                    return hexa_add(hexa_add(hexa_str("(hexa_print_val("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_220), hexa_int(0)))), hexa_str("), hexa_void())"));
                }
                return hexa_str("hexa_void()");
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("len")))) {
                return hexa_add(hexa_add(hexa_str("hexa_int(hexa_len("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_221), hexa_int(0)))), hexa_str("))"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("to_string")))) {
                return hexa_add(hexa_add(hexa_str("hexa_to_string("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_222), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("type_of")))) {
                return hexa_add(hexa_add(hexa_str("hexa_type_of("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_223), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("sqrt")))) {
                return hexa_add(hexa_add(hexa_str("hexa_sqrt("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_224), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("floor")))) {
                return hexa_add(hexa_add(hexa_str("hexa_floor("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_225), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ceil")))) {
                return hexa_add(hexa_add(hexa_str("hexa_ceil("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_226), hexa_int(0)))), hexa_str(")"));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("is_digit")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_238), hexa_int(0)));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("is_alphanumeric")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_239), hexa_int(0)));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("file_exists")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_240), hexa_int(0)));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("format")))) {
                ...
                while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(fi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_241)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                    fmt_args = hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_push("), fmt_args), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_242), fi))), hexa_str(")"));
                    fi = hexa_add(fi, hexa_int(1));
                }
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_format_n("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_243), hexa_int(0)))), hexa_str(", ")), fmt_args), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("eprintln")))) {
                if (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_244)))); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))) {
                    return hexa_add(hexa_add(hexa_str("(hexa_eprint_val("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_245), hexa_int(0)))), hexa_str("), fprintf(stderr, \"\\n\"), hexa_void())"));
                }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("min")))) {
                ...
                b = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_249), hexa_int(1)));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("max")))) {
                a = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_250), hexa_int(0)));
                b = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_251), hexa_int(1)));
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_int(("), a), hexa_str(").i > (")), b), hexa_str(").i ? (")), a), hexa_str(").i : (")), b), hexa_str(").i)"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("read_file")))) {
                return hexa_add(hexa_add(hexa_str("hexa_read_file("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_252), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_file")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_write_file("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_253), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_254), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("cstring")))) {
                return hexa_add(hexa_add(hexa_str("hexa_cstring("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_255), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("from_cstring")))) {
                return hexa_add(hexa_add(hexa_str("hexa_from_cstring("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_256), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_null")))) {
                return hexa_str("hexa_ptr_null()");
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_addr")))) {
                return hexa_add(hexa_add(hexa_str("hexa_ptr_addr("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_257), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("callback_create")))) {
                HexaVal arg = hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_258), hexa_int(0));
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(arg), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(arg, "kind", &__hexa_codegen_c2_ic_259), hexa_str("Ident")))))) {
                    HexaVal fn_name = hexa_map_get_ic(arg, "name", &__hexa_codegen_c2_ic_260);
                    return hexa_add(hexa_add(hexa_str("hexa_callback_create((HexaVal){.tag=TAG_FN, .fn={.fn_ptr=(void*)"), fn_name), hexa_str(", .arity=0}})"));
                }
                return hexa_add(hexa_add(hexa_str("hexa_callback_create("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_261), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("callback_free")))) {
                return hexa_add(hexa_add(hexa_str("hexa_callback_free("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_262), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("callback_slot_id")))) {
                return hexa_add(hexa_add(hexa_str("hexa_callback_slot_id("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_263), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_alloc")))) {
                return hexa_add(hexa_add(hexa_str("hexa_ptr_alloc("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_264), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_free")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_free("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_265), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_266), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_write")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_267), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_268), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_269), hexa_int(2)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_write_f32")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write_f32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_270), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_271), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_272), hexa_int(2)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_write_i32")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write_i32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_273), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_274), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_275), hexa_int(2)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_read")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_276), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_277), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_read_f64")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read_f64("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_278), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_279), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_read_f32")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read_f32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_280), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_281), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_read_i32")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read_i32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_282), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_283), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("ptr_offset")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_offset("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_284), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_285), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("deref")))) {
                return hexa_add(hexa_add(hexa_str("hexa_deref("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_286), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("__prefetch")))) {
                ...
                b = gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_288), hexa_int(1)));
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("(__builtin_prefetch(hexa_index("), a), hexa_str(", hexa_int((")), b), hexa_str(").i + 1)).s, 0, 3), hexa_void())"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_pack")))) {
                a_strs = hexa_array_new();
                si = hexa_int(0);
                while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(si); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_289)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                    a_strs = hexa_array_push(a_strs, gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_290), si)));
                    si = hexa_add(si, hexa_int(1));
                }
                n = hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_291))));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_pack_f32")))) {
                a_strs = hexa_array_new();
                si = hexa_int(0);
                while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(si); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_292)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                    a_strs = hexa_array_push(a_strs, gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_293), si)));
                    si = hexa_add(si, hexa_int(1));
                }
                n = hexa_to_string(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_294))));
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_unpack")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_unpack("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_295), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_296), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_unpack_f32")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_unpack_f32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_297), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_298), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_rect")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_rect("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_299), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_300), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_301), hexa_int(2)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_302), hexa_int(3)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_point")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_point("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_303), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_304), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_size")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_struct_size_pack("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_305), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_306), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("struct_free")))) {
                return hexa_add(hexa_add(hexa_str("hexa_struct_free("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_307), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("alloc_raw")))) {
                return hexa_add(hexa_add(hexa_str("hexa_ptr_alloc("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_308), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("free_raw")))) {
                return hexa_add(hexa_add(hexa_str("hexa_ptr_free("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_309), hexa_int(0)))), hexa_str(", hexa_int(0))"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_f32")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write_f32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_310), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_311), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_312), hexa_int(2)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_i32")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write_i32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_313), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_314), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_315), hexa_int(2)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("write_i64")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_write("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_316), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_317), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_318), hexa_int(2)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("deref_f32")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read_f32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_319), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_320), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("deref_i32")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_ptr_read_i32("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_321), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_322), hexa_int(1)))), hexa_str(")"));
            }
            ...
            if (hexa_truthy(hexa_eq(name, hexa_str("tensor")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_new("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_326), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_327), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("randn")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_randn("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_328), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_329), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("tensor_data_f32_ptr")))) {
                return hexa_add(hexa_add(hexa_str("hexa_tensor_data_ptr("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_330), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(name, hexa_str("tensor_from_f32_ptr")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_tensor_from_ptr("), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_331), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_332), hexa_int(1)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_333), hexa_int(2)))), hexa_str(")"));
            }
            arg_strs = hexa_array_new();
            ai = hexa_int(0);
            while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(ai); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_334)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                arg_strs = hexa_array_push(arg_strs, gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_335), ai)));
                ai = hexa_add(ai, hexa_int(1));
            }
            ...
            if (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_336)))); HexaVal __r=(hexa_int(2)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) >= (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i >= __r.i); })))) {
            ...
            if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_337))), hexa_int(0)))) {
            ...
            if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_338))), hexa_int(1)))) {
            ...
            if (hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_339))), hexa_int(2)))) {
            ...
            nargs = hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_340)));
        ...
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(callee), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(callee, "kind", &__hexa_codegen_c2_ic_341), hexa_str("Field")))))) {
            obj = gen2_expr(hexa_map_get_ic(callee, "left", &__hexa_codegen_c2_ic_342));
            HexaVal method = hexa_map_get_ic(callee, "name", &__hexa_codegen_c2_ic_343);
            ...
            if (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(hexa_int(hexa_len(user_types))); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))) {
                ...
                while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(uai); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_344)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                    u_args = hexa_array_push(u_args, gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_345), uai)));
                    uai = hexa_add(uai, hexa_int(1));
                }
                HexaVal u_arg_tail = hexa_str_join(u_args, hexa_str(", "));
                HexaVal __saved_obj = obj;
                HexaVal fb = gen2_method_builtin(hexa_str("__mr"), method, hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_346));
                HexaVal chain = fb;
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("push")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_push("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_347), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("len")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("contains")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_str_contains("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_348), hexa_int(0)))), hexa_str("))"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("join")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_join("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_349), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("to_upper")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("split")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_split("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_350), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("trim")))) {
                return hexa_add(hexa_add(hexa_str("hexa_str_trim("), obj), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("replace")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_replace("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_351), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_352), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("repeat")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_repeat("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_353), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("starts_with")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_str_starts_with("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_354), hexa_int(0)))), hexa_str("))"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("ends_with")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_str_ends_with("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_355), hexa_int(0)))), hexa_str("))"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("substring")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_str_substring("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_356), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_357), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("index_of")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_int(hexa_str_index_of("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_358), hexa_int(0)))), hexa_str("))"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("keys")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("contains_key")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_bool(hexa_map_contains_key("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_359), hexa_int(0)))), hexa_str(".s))"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("remove")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_map_remove("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_360), hexa_int(0)))), hexa_str(".s)"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("pop")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("truncate")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_truncate("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_361), hexa_int(0)))), hexa_str(")"));
            }
            // T33-rebuild: manually injected method dispatches (mirrors codegen_c2.hexa).
            if (hexa_truthy(hexa_eq(method, hexa_str("push_nostat")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_push_nostat("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_361), hexa_int(0)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("trim_start")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("slice")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_slice("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_361), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_361), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("slice_fast")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_slice_fast("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_361), hexa_int(0)))), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_361), hexa_int(1)))), hexa_str(")"));
            }
            if (hexa_truthy(hexa_eq(method, hexa_str("to_string")))) {
            ...
            if (hexa_truthy(hexa_eq(method, hexa_str("pad_left")))) {
                return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_pad_left("), obj), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_361), hexa_int(0)))), hexa_str(")"));
            }
        ...
        nargs = hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_362)));
        HexaVal cargs = hexa_array_new();
        HexaVal ci = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(ci); HexaVal __r=(nargs); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            cargs = hexa_array_push(cargs, gen2_expr(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_363), ci)));
            ci = hexa_add(ci, hexa_int(1));
        }
        if (hexa_truthy(hexa_eq(nargs, hexa_int(0)))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Array")))) {
        ...
        ai = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(ai); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_364)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            out = hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_array_push("), out), hexa_str(", ")), gen2_expr(hexa_index_get(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_365), ai))), hexa_str(")"));
            ai = hexa_add(ai, hexa_int(1));
        }
        return out;
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Index")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_index_get("), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_366))), hexa_str(", ")), gen2_expr(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_367))), hexa_str(")"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumPath")))) {
        HexaVal ename = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_368);
        HexaVal vname = hexa_map_get_ic(node, "value", &__hexa_codegen_c2_ic_369);
        return hexa_add(hexa_add(ename, hexa_str("_")), vname);
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("IfExpr")))) {
        HexaVal c = gen2_expr(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_370));
        HexaVal t_val = hexa_str("hexa_void()");
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_371)), hexa_str("string"))))) && hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(hexa_int(hexa_len(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_372)))); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))))) {
            HexaVal t_last = hexa_index_get(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_373), hexa_sub(hexa_int(hexa_len(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_374))), hexa_int(1)));
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(t_last), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(t_last, "kind", &__hexa_codegen_c2_ic_375), hexa_str("ExprStmt"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(t_last, "left", &__hexa_codegen_c2_ic_376)), hexa_str("string")))))))) {
                t_val = gen2_expr(hexa_map_get_ic(t_last, "left", &__hexa_codegen_c2_ic_377));
            }
        }
        HexaVal e_val = hexa_str("hexa_void()");
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_378)), hexa_str("string"))))) && hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_379)))); HexaVal __r=(hexa_int(0)); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) > (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i > __r.i); })))))) {
            HexaVal e_last = hexa_index_get(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_380), hexa_sub(hexa_int(hexa_len(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_381))), hexa_int(1)));
            if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(e_last), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(e_last, "kind", &__hexa_codegen_c2_ic_382), hexa_str("ExprStmt"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(e_last, "left", &__hexa_codegen_c2_ic_383)), hexa_str("string")))))))) {
                e_val = gen2_expr(hexa_map_get_ic(e_last, "left", &__hexa_codegen_c2_ic_384));
            }
        }
    ...
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("Tuple"))) || hexa_truthy(hexa_eq(k, hexa_str("TupleLit")))))) {
        out = hexa_str("hexa_array_new()");
        HexaVal items = hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_385);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("MapLit")))) {
        ...
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_386)), hexa_str("string")))))) {
            HexaVal mi = hexa_int(0);
            while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(mi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_387)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
                HexaVal entry = hexa_index_get(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_388), mi);
                HexaVal key_c = gen2_expr(hexa_map_get_ic(entry, "left", &__hexa_codegen_c2_ic_389));
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(entry, "left", &__hexa_codegen_c2_ic_390)), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(hexa_map_get_ic(entry, "left", &__hexa_codegen_c2_ic_391), "kind", &__hexa_codegen_c2_ic_392), hexa_str("StringLit")))))) {
                    key_c = hexa_add(hexa_add(hexa_str("\""), c_escape(hexa_map_get_ic(hexa_map_get_ic(entry, "left", &__hexa_codegen_c2_ic_393), "value", &__hexa_codegen_c2_ic_394))), hexa_str("\""));
                }
                out = hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_map_set("), out), hexa_str(", ")), key_c), hexa_str(", ")), gen2_expr(hexa_map_get_ic(entry, "right", &__hexa_codegen_c2_ic_395))), hexa_str(")"));
                mi = hexa_add(mi, hexa_int(1));
            }
        }
        return out;
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("NegFloat")))) {
        return hexa_add(hexa_add(hexa_str("hexa_float(-("), gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_396))), hexa_str(").f)"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("Wildcard")))) {
...
HexaVal gen2_simd_loop(HexaVal arr_name, HexaVal op, HexaVal scalar_expr, HexaVal width) {
    ...
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(lane); HexaVal __r=(width); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        ...
        parts = hexa_array_push(parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("        hexa_array_set("), arr_name), hexa_str(", ")), idx), hexa_str(", hexa_int(hexa_array_get(")), arr_name), hexa_str(", ")), idx), hexa_str(").i ")), op), hexa_str(" (")), scalar_expr), hexa_str(").i));\n")));
    ...
    parts = hexa_array_push(parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("        hexa_array_set("), arr_name), hexa_str(", __ri, hexa_int(hexa_array_get(")), arr_name), hexa_str(", __ri).i ")), op), hexa_str(" (")), scalar_expr), hexa_str(").i));\n")));
    parts = hexa_array_push(parts, hexa_str("    }\n"));
    return hexa_str_join(parts, hexa_str(""));
    return hexa_void();
}
...
HexaVal gen2_struct_decl(HexaVal node) {
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_397);
    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(name, hexa_str("Val"))) && hexa_truthy(hexa_eq(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_398))), hexa_int(12)))))) {
        HexaVal vs_params = hexa_array_new();
        HexaVal vs_args = hexa_array_new();
        HexaVal vi = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(vi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_399)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            HexaVal fname = hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_400), vi), "name", &__hexa_codegen_c2_ic_401);
    ...
    HexaVal nfields = hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_402)));
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(nfields); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        HexaVal f = hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_403), i);
        params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_404)));
        ...
        keys_parts = hexa_array_push(keys_parts, hexa_add(hexa_add(hexa_str("\""), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_405)), hexa_str("\"")));
        vals_parts = hexa_array_push(vals_parts, hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_406));
        i = hexa_add(i, hexa_int(1));
    }
    HexaVal p = hexa_str_join(params, hexa_str(", "));
    HexaVal p_sig = p;
...
HexaVal gen2_struct_decl_aligned(HexaVal node) {
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_407);
    HexaVal params = hexa_array_new();
    ...
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_408)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        HexaVal f = hexa_index_get(hexa_map_get_ic(node, "fields", &__hexa_codegen_c2_ic_409), i);
        params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_410)));
        body_parts = hexa_array_push(body_parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    __s = hexa_map_set(__s, \""), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_411)), hexa_str("\", ")), hexa_map_get_ic(f, "name", &__hexa_codegen_c2_ic_412)), hexa_str(");\n")));
        i = hexa_add(i, hexa_int(1));
    }
    HexaVal p = hexa_str_join(params, hexa_str(", "));
    if (hexa_truthy(hexa_eq(p, hexa_str("")))) {
...
HexaVal gen2_bitfield_accessor(HexaVal struct_name, HexaVal field_name, HexaVal bit_offset) {
    ...
    HexaVal getter = hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("#define "), struct_name), hexa_str("_get_")), field_name), hexa_str("(v) (((v).i >> ")), hexa_to_string(bit_offset)), hexa_str(") & ")), mask), hexa_str(")\n"));
    HexaVal setter = hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("#define "), struct_name), hexa_str("_set_")), field_name), hexa_str("(v, b) ((v).i = ((v).i & ~(")), mask), hexa_str(" << ")), hexa_to_string(bit_offset)), hexa_str(")) | (((b) & ")), mask), hexa_str(") << ")), hexa_to_string(bit_offset)), hexa_str("))\n"));
...
HexaVal gen2_enum_decl(HexaVal node) {
    HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_413);
    HexaVal vc = hexa_int(hexa_len(hexa_map_get_ic(node, "variants", &__hexa_codegen_c2_ic_414)));
    ...
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(vc); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        HexaVal v = hexa_index_get(hexa_map_get_ic(node, "variants", &__hexa_codegen_c2_ic_415), i);
        parts = hexa_array_push(parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("#define "), name), hexa_str("_")), hexa_map_get_ic(v, "name", &__hexa_codegen_c2_ic_416)), hexa_str(" hexa_int(")), hexa_to_string(i)), hexa_str(")\n")));
        i = hexa_add(i, hexa_int(1));
    }
    return hexa_str_join(parts, hexa_str(""));
    return hexa_void();
...
HexaVal gen2_match_stmt(HexaVal node, HexaVal depth) {
    HexaVal pad = gen2_indent(depth);
    HexaVal scrutinee = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_417));
    HexaVal chunks = hexa_array_new();
    chunks = hexa_array_push(chunks, hexa_add(pad, hexa_str("{\n")));
    ...
    HexaVal ai = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(ai); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_418)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        HexaVal arm = hexa_index_get(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_419), ai);
        HexaVal pat = hexa_map_get_ic(arm, "left", &__hexa_codegen_c2_ic_420);
        HexaVal is_wildcard = hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(pat), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(pat, "kind", &__hexa_codegen_c2_ic_421), hexa_str("Wildcard"))));
        ...
        HexaVal bi = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(bi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_422)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            chunks = hexa_array_push(chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_423), bi), hexa_add(depth, hexa_int(2))));
            bi = hexa_add(bi, hexa_int(1));
        }
        chunks = hexa_array_push(chunks, hexa_add(pad2, hexa_str("}")));
        ai = hexa_add(ai, hexa_int(1));
...
HexaVal gen2_match_cond(HexaVal pat, HexaVal scrutinee_var) {
    ...
    HexaVal k = hexa_map_get_ic(pat, "kind", &__hexa_codegen_c2_ic_424);
    if (hexa_truthy(hexa_eq(k, hexa_str("Wildcard")))) {
        return hexa_str("1");
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_truthy(hexa_eq("), scrutinee_var), hexa_str(", hexa_int(")), hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_425)), hexa_str(")))"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_truthy(hexa_eq("), scrutinee_var), hexa_str(", hexa_float(")), hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_426)), hexa_str(")))"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("StringLit")))) {
        return hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("hexa_truthy(hexa_eq("), scrutinee_var), hexa_str(", hexa_str(\"")), c_escape(hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_427))), hexa_str("\")))"));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BoolLit")))) {
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_428), hexa_str("true")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("EnumPath")))) {
        HexaVal enum_const = hexa_add(hexa_add(hexa_map_get_ic(pat, "name", &__hexa_codegen_c2_ic_429), hexa_str("_")), hexa_map_get_ic(pat, "value", &__hexa_codegen_c2_ic_430));
...
HexaVal gen2_match_expr(HexaVal node) {
    HexaVal scrutinee = gen2_expr(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_431));
    HexaVal arms = hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_432);
...
HexaVal gen2_match_ternary(HexaVal arms, HexaVal scrutinee_c, HexaVal idx) {
    ...
    HexaVal pat = hexa_map_get_ic(arm, "left", &__hexa_codegen_c2_ic_433);
    HexaVal is_wildcard = hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(pat), hexa_str("string"))))) && hexa_truthy(hexa_eq(hexa_map_get_ic(pat, "kind", &__hexa_codegen_c2_ic_434), hexa_str("Wildcard"))));
    HexaVal val = gen2_arm_value(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_435));
...
HexaVal gen2_arm_value(HexaVal body) {
    ...
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(last, "kind", &__hexa_codegen_c2_ic_436), hexa_str("ExprStmt")))) {
        return gen2_expr(hexa_map_get_ic(last, "left", &__hexa_codegen_c2_ic_437));
    }
    if (hexa_truthy(hexa_eq(hexa_map_get_ic(last, "kind", &__hexa_codegen_c2_ic_438), hexa_str("ReturnStmt")))) {
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(last, "left", &__hexa_codegen_c2_ic_439)), hexa_str("string")))))) {
            return gen2_expr(hexa_map_get_ic(last, "left", &__hexa_codegen_c2_ic_440));
        }
    }
    return hexa_str("hexa_void()");
    return hexa_void();
...
HexaVal gen2_impl_block(HexaVal node) {
    HexaVal type_n = hexa_map_get_ic(node, "target", &__hexa_codegen_c2_ic_441);
    HexaVal fwd_chunks = hexa_array_new();
    HexaVal fn_chunks = hexa_array_new();
    HexaVal methods = hexa_map_get_ic(node, "methods", &__hexa_codegen_c2_ic_442);
    HexaVal mi = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(mi); HexaVal __r=(hexa_int(hexa_len(methods))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        ...
        HexaVal mangled = hexa_add(hexa_add(type_n, hexa_str("__")), hexa_map_get_ic(m, "name", &__hexa_codegen_c2_ic_443));
        _method_registry = hexa_array_push(_method_registry, hexa_array_push(hexa_array_push(hexa_array_new(), hexa_map_get_ic(m, "name", &__hexa_codegen_c2_ic_444)), type_n));
        HexaVal params = hexa_array_new();
        HexaVal pi = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(pi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(m, "params", &__hexa_codegen_c2_ic_445)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(hexa_index_get(hexa_map_get_ic(m, "params", &__hexa_codegen_c2_ic_446), pi), "name", &__hexa_codegen_c2_ic_447)));
        ...
        HexaVal bi = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(bi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(m, "body", &__hexa_codegen_c2_ic_448)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            body_chunks = hexa_array_push(body_chunks, gen2_stmt(hexa_index_get(hexa_map_get_ic(m, "body", &__hexa_codegen_c2_ic_449), bi), hexa_int(1)));
            bi = hexa_add(bi, hexa_int(1));
        }
...
HexaVal comptime_eval(HexaVal node) {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_450);
    if (hexa_truthy(hexa_eq(k, hexa_str("IntLit")))) {
        return node;
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("FloatLit")))) {
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        return _lookup_comptime_const(hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_451));
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("UnaryOp")))) {
        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_452), hexa_str("-")))))) {
            return hexa_str("");
        }
        HexaVal v = comptime_eval(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_453));
        if (hexa_truthy(hexa_eq(hexa_type_of(v), hexa_str("string")))) {
            return hexa_str("");
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(v, "kind", &__hexa_codegen_c2_ic_454), hexa_str("IntLit")))) {
            HexaVal i = hexa_sub(hexa_int(0), hexa_int((hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_455).tag==TAG_FLOAT?(int64_t)hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_455).f:hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_455).tag==TAG_STR?atoll(hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_455).s):hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_455).i)));
            return _make_int_lit_node(hexa_to_string(i));
        }
        if (hexa_truthy(hexa_eq(hexa_map_get_ic(v, "kind", &__hexa_codegen_c2_ic_456), hexa_str("FloatLit")))) {
            HexaVal f = hexa_sub(hexa_int(0), hexa_float(hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_457).tag==TAG_FLOAT?hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_457).f:(double)hexa_map_get_ic(v, "value", &__hexa_codegen_c2_ic_457).i));
            return _make_float_lit_node(hexa_to_string(f));
        }
        return hexa_str("");
    }
    if (hexa_truthy(hexa_eq(k, hexa_str("BinOp")))) {
        HexaVal l = comptime_eval(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_458));
        if (hexa_truthy(hexa_eq(hexa_type_of(l), hexa_str("string")))) {
            return hexa_str("");
        }
        HexaVal r = comptime_eval(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_459));
        if (hexa_truthy(hexa_eq(hexa_type_of(r), hexa_str("string")))) {
            return hexa_str("");
        }
        HexaVal op = hexa_map_get_ic(node, "op", &__hexa_codegen_c2_ic_460);
        HexaVal lf_kind = hexa_map_get_ic(l, "kind", &__hexa_codegen_c2_ic_461);
        HexaVal rf_kind = hexa_map_get_ic(r, "kind", &__hexa_codegen_c2_ic_462);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(lf_kind, hexa_str("IntLit"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(lf_kind, hexa_str("FloatLit")))))))) {
            return hexa_str("");
        }
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(rf_kind, hexa_str("IntLit"))))) && hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(rf_kind, hexa_str("FloatLit")))))))) {
            return hexa_str("");
        }
        HexaVal is_float = hexa_bool(hexa_truthy(hexa_eq(lf_kind, hexa_str("FloatLit"))) || hexa_truthy(hexa_eq(rf_kind, hexa_str("FloatLit"))));
        if (hexa_truthy(is_float)) {
            HexaVal lf = hexa_float(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_463).tag==TAG_FLOAT?hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_463).f:(double)hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_463).i);
            HexaVal rf = hexa_float(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_464).tag==TAG_FLOAT?hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_464).f:(double)hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_464).i);
            if (hexa_truthy(hexa_eq(op, hexa_str("+")))) {
        ...
        HexaVal li = hexa_int((hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_465).tag==TAG_FLOAT?(int64_t)hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_465).f:hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_465).tag==TAG_STR?atoll(hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_465).s):hexa_map_get_ic(l, "value", &__hexa_codegen_c2_ic_465).i));
        HexaVal ri = hexa_int((hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_466).tag==TAG_FLOAT?(int64_t)hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_466).f:hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_466).tag==TAG_STR?atoll(hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_466).s):hexa_map_get_ic(r, "value", &__hexa_codegen_c2_ic_466).i));
        if (hexa_truthy(hexa_eq(op, hexa_str("+")))) {
...
HexaVal _is_known_fn_global(HexaVal name) {
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(_known_fn_globals))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
...
HexaVal _is_known_nonlocal(HexaVal name) {
    HexaVal i = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(_known_nonlocal_names))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
...
HexaVal gen2_collect_free(HexaVal node, HexaVal bound, HexaVal out) {
    ...
    if (hexa_truthy(hexa_eq(hexa_type_of(node), hexa_str("array")))) {
        ...
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(node))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            ...
            if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(s), hexa_str("string")))))) {
                HexaVal sk = hexa_map_get_ic(s, "kind", &__hexa_codegen_c2_ic_467);
                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(sk, hexa_str("LetStmt"))) || hexa_truthy(hexa_eq(sk, hexa_str("LetMutStmt")))))) {
                    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(s, "left", &__hexa_codegen_c2_ic_468)), hexa_str("string")))))) {
                        result = gen2_collect_free(hexa_map_get_ic(s, "left", &__hexa_codegen_c2_ic_469), local, result);
                    }
                    local = hexa_array_push(local, hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_470));
                } else {
                    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(sk, hexa_str("ForStmt"))) || hexa_truthy(hexa_eq(sk, hexa_str("ForInStmt")))))) {
                        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(s, "left", &__hexa_codegen_c2_ic_471)), hexa_str("string")))))) {
                            result = gen2_collect_free(hexa_map_get_ic(s, "left", &__hexa_codegen_c2_ic_472), local, result);
                        }
                        HexaVal body_local = hexa_array_push(local, hexa_map_get_ic(s, "name", &__hexa_codegen_c2_ic_473));
                        if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(s, "body", &__hexa_codegen_c2_ic_474)), hexa_str("array")))) {
                            result = gen2_collect_free(hexa_map_get_ic(s, "body", &__hexa_codegen_c2_ic_475), body_local, result);
                        }
                    } else {
    ...
    HexaVal k = hexa_map_get_ic(node, "kind", &__hexa_codegen_c2_ic_476);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Ident")))) {
        HexaVal name = hexa_map_get_ic(node, "name", &__hexa_codegen_c2_ic_477);
    ...
    if (hexa_truthy(hexa_eq(k, hexa_str("Lambda")))) {
        ...
        HexaVal pi = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(pi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_478)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            inner_bound = hexa_array_push(inner_bound, hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_479), pi));
            pi = hexa_add(pi, hexa_int(1));
        }
        return gen2_collect_free(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_480), inner_bound, out);
    }
    result = out;
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_481)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_482), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_483)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "right", &__hexa_codegen_c2_ic_484), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_485)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "cond", &__hexa_codegen_c2_ic_486), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_487)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "then_body", &__hexa_codegen_c2_ic_488), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_489)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "else_body", &__hexa_codegen_c2_ic_490), bound, result);
    }
    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_491)), hexa_str("string")))))) {
        result = gen2_collect_free(hexa_map_get_ic(node, "body", &__hexa_codegen_c2_ic_492), bound, result);
    }
    if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_493)), hexa_str("array")))) {
        HexaVal ai = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(ai); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_494)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            result = gen2_collect_free(hexa_index_get(hexa_map_get_ic(node, "args", &__hexa_codegen_c2_ic_495), ai), bound, result);
            ai = hexa_add(ai, hexa_int(1));
        }
    }
    if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_496)), hexa_str("array")))) {
        HexaVal ii = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(ii); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_497)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            result = gen2_collect_free(hexa_index_get(hexa_map_get_ic(node, "items", &__hexa_codegen_c2_ic_498), ii), bound, result);
            ii = hexa_add(ii, hexa_int(1));
        }
    }
    if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_499)), hexa_str("array")))) {
        HexaVal mi = hexa_int(0);
        while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(mi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_500)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
            HexaVal arm = hexa_index_get(hexa_map_get_ic(node, "arms", &__hexa_codegen_c2_ic_501), mi);
            if (hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_502)), hexa_str("array")))) {
                result = gen2_collect_free(hexa_map_get_ic(arm, "body", &__hexa_codegen_c2_ic_503), bound, result);
            }
            mi = hexa_add(mi, hexa_int(1));
        }
    }
...
HexaVal gen2_lambda_expr(HexaVal node) {
    ...
    HexaVal pi = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(pi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_504)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        bound = hexa_array_push(bound, hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_505), pi));
        pi = hexa_add(pi, hexa_int(1));
    }
    HexaVal free_vars = gen2_collect_free(hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_506), bound, hexa_array_new());
    HexaVal arity = hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_507)));
    HexaVal params = hexa_array_new();
    params = hexa_array_push(params, hexa_str("HexaVal __env"));
    pi = hexa_int(0);
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(pi); HexaVal __r=(hexa_int(hexa_len(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_508)))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        params = hexa_array_push(params, hexa_add(hexa_str("HexaVal "), hexa_index_get(hexa_map_get_ic(node, "params", &__hexa_codegen_c2_ic_509), pi)));
        pi = hexa_add(pi, hexa_int(1));
    }
    HexaVal p = hexa_str_join(params, hexa_str(", "));
    if (hexa_truthy(hexa_eq(p, hexa_str("")))) {
    ...
    HexaVal lbody = hexa_map_get_ic(node, "left", &__hexa_codegen_c2_ic_510);
...
HexaVal codegen_c2_full(HexaVal ast) {
    ...
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(gi); HexaVal __r=(hexa_int(hexa_len(ast))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        HexaVal gk = hexa_map_get_ic(hexa_index_get(ast, gi), "kind", &__hexa_codegen_c2_ic_511);
        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(gk, hexa_str("FnDecl"))) || hexa_truthy(hexa_eq(gk, hexa_str("ExternFnDecl"))))) || hexa_truthy(hexa_eq(gk, hexa_str("PureFnDecl"))))) || hexa_truthy(hexa_eq(gk, hexa_str("OptimizeFnStmt")))))) {
            _known_fn_globals = hexa_array_push(_known_fn_globals, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_512));
            _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_513));
        } else {
            if (hexa_truthy(hexa_eq(gk, hexa_str("StructDecl")))) {
                _known_fn_globals = hexa_array_push(_known_fn_globals, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_514));
                _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_515));
            } else {
                if (hexa_truthy(hexa_eq(gk, hexa_str("EnumDecl")))) {
                    _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_516));
                } else {
                    if (hexa_truthy(hexa_eq(gk, hexa_str("ComptimeConst")))) {
                        _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_517));
                    } else {
                        if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(gk, hexa_str("LetMutStmt"))) || hexa_truthy(hexa_eq(gk, hexa_str("LetStmt")))))) {
                            _known_nonlocal_names = hexa_array_push(_known_nonlocal_names, hexa_map_get_ic(hexa_index_get(ast, gi), "name", &__hexa_codegen_c2_ic_518));
                        }
                    }
                }
            }
    ...
    while (hexa_truthy(hexa_bool(__extension__ ({ HexaVal __l=(i); HexaVal __r=(hexa_int(hexa_len(ast))); (__l.tag==TAG_FLOAT||__r.tag==TAG_FLOAT) ? ((__l.tag==TAG_FLOAT?__l.f:(double)__l.i) < (__r.tag==TAG_FLOAT?__r.f:(double)__r.i)) : (__l.i < __r.i); })))) {
        ...
        if (hexa_truthy(hexa_eq(k, hexa_str("FnDecl")))) {
            ...
            if (hexa_truthy(hexa_eq(k, hexa_str("ExternFnDecl")))) {
                HexaVal ew = gen2_extern_wrapper(hexa_index_get(ast, i));
                global_parts = hexa_array_push(global_parts, hexa_map_get_ic(ew, "global", &__hexa_codegen_c2_ic_520));
                fwd_parts = hexa_array_push(fwd_parts, hexa_add(hexa_map_get_ic(ew, "forward", &__hexa_codegen_c2_ic_521), hexa_str("\n")));
                fn_parts = hexa_array_push(fn_parts, hexa_add(hexa_map_get_ic(ew, "fn_code", &__hexa_codegen_c2_ic_522), hexa_str("\n\n")));
                main_parts = hexa_array_push(main_parts, hexa_map_get_ic(ew, "init", &__hexa_codegen_c2_ic_523));
            } else {
                if (hexa_truthy(hexa_eq(k, hexa_str("StructDecl")))) {
                    fn_parts = hexa_array_push(fn_parts, hexa_add(gen2_struct_decl(hexa_index_get(ast, i)), hexa_str("\n\n")));
                } else {
                    if (hexa_truthy(hexa_eq(k, hexa_str("EnumDecl")))) {
                        ...
                        if (hexa_truthy(hexa_eq(k, hexa_str("ImplBlock")))) {
                            HexaVal ib = gen2_impl_block(hexa_index_get(ast, i));
                            fwd_parts = hexa_array_push(fwd_parts, hexa_map_get_ic(ib, "forward", &__hexa_codegen_c2_ic_524));
                            fn_parts = hexa_array_push(fn_parts, hexa_map_get_ic(ib, "fn_code", &__hexa_codegen_c2_ic_525));
                        } else {
                            if (hexa_truthy(hexa_eq(k, hexa_str("PureFnDecl")))) {
                                fwd_parts = hexa_array_push(fwd_parts, hexa_add(gen2_fn_forward(hexa_index_get(ast, i)), hexa_str("\n")));
                                fn_parts = hexa_array_push(fn_parts, hexa_add(gen2_fn_decl(hexa_index_get(ast, i)), hexa_str("\n\n")));
                                ...
                                if (hexa_truthy(hexa_eq(k, hexa_str("ComptimeConst")))) {
                                    HexaVal _cc_folded2 = comptime_eval(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_526));
                                    if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(_cc_folded2), hexa_str("string")))))) {
                                        _register_comptime_const(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_527), _cc_folded2);
                                    } else {
                                        global_parts = hexa_array_push(global_parts, hexa_add(hexa_add(hexa_str("HexaVal "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_528)), hexa_str(";\n")));
                                        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_529)), hexa_str("string")))))) {
                                            main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_530)), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_531))), hexa_str(";\n")));
                                        } else {
                                            main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_str("    "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_532)), hexa_str(" = hexa_void();\n")));
                                        }
                                    }
                                } else {
                                    if (hexa_truthy(hexa_eq(k, hexa_str("OptimizeFnStmt")))) {
                                        ...
                                        if (hexa_truthy(hexa_eq(k, hexa_str("TraitDecl")))) {
                                            ...
                                            if (hexa_truthy(hexa_eq(k, hexa_str("InvariantDecl")))) {
                                                ...
                                                if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("ImportStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("UseStmt")))))) {
                                                    (hexa_eprint_val(hexa_add(hexa_str("[codegen_c2] WARNING: import/use not fully resolved: "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_533))), fprintf(stderr, "\n"), hexa_void());
                                                    main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_str("    /* import: "), hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_534)), hexa_str(" */\n")));
                                                } else {
                                                    if (hexa_truthy(hexa_bool(hexa_truthy(hexa_eq(k, hexa_str("LetMutStmt"))) || hexa_truthy(hexa_eq(k, hexa_str("LetStmt")))))) {
                                                        HexaVal _user_name2 = _hexa_mangle_ident(hexa_map_get_ic(hexa_index_get(ast, i), "name", &__hexa_codegen_c2_ic_535));
                                                        HexaVal _tls_val2 = hexa_map_get_ic(hexa_index_get(ast, i), "value", &__hexa_codegen_c2_ic_536);
                                                        ...
                                                        if (hexa_truthy(hexa_bool(!hexa_truthy(hexa_eq(hexa_type_of(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_537)), hexa_str("string")))))) {
                                                            main_parts = hexa_array_push(main_parts, hexa_add(hexa_add(hexa_add(hexa_add(hexa_str("    "), _user_name2), hexa_str(" = ")), gen2_expr(hexa_map_get_ic(hexa_index_get(ast, i), "left", &__hexa_codegen_c2_ic_538))), hexa_str(";\n")));
                                                        } else {
