...
ext=외부 (self/·scripts/·shared/·examples/ 의 `.hexa/.c/.h/.json`) 참조 횟수 — `runtime.c` 제외.
...
각 Wave 끝마다 smoke test: `hexa scripts/rebuild_stage0.hexa` fixpoint 4/4 IDENTICAL + anima t1/t2 physical-ceiling 회귀 없음.
