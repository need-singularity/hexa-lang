...
| 항목 | 파일 | 내용 |
|------|------|------|
| 절대 규칙 | `shared/absolute_rules.json` | 공통 R1~R21 + HX1~HX6 |
| 보호 체계 | `shared/core-lockdown.json` | L0/L1/L2 잠금 (src/ L0) |
| 프로젝트 설정 | `shared/project_config.json` | CLI/빌드/DSE 수렴/문법 요약/실행 모델 |
