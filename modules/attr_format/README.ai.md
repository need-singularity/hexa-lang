---
schema: hexa-lang/modules/attr_format/ai-native/1
last_updated: 2026-05-02
ssot:
  interface:  hexa-lang/core/attr_format/source.hexa
  registry:   hexa-lang/core/attr_format/registry.hexa
  router:     hexa-lang/core/attr_format/router.hexa
  aggregator: hexa-lang/core/attr_format/attr_format_main.hexa
...
- To extract attrs from a source string: call `attr_format_route_parse(src)` from `hexa-lang/core/attr_format/router.hexa`.
...
caller
  └── hexa-lang/core/attr_format/router.hexa             (config-driven version + lower chain)
       └── hexa-lang/core/attr_format/registry.hexa      (version → module dispatch, 5 entries)
            ├── hexa-lang/modules/attr_format/attr_v1.hexa   v1  WRAPPED      ← PRIMARY (current land)
            │    ↳ wraps: hive/tool/attr_usage_lint.hexa regex / attrs.json catalog
            ├── hexa-lang/modules/attr_format/attr_v2.hexa   v2  SPEC-STUB    (Phase β L1 — AST first-class)
            ├── hexa-lang/modules/attr_format/attr_v3.hexa   v3  SPEC-STUB    (Phase β L10 — param typing)
            ├── hexa-lang/modules/attr_format/attr_v4.hexa   v4  SPEC-STUB    (Phase δ L12 — composition group)
            └── hexa-lang/modules/attr_format/attr_v5.hexa   v5  FUTURE-STUB  (no spec yet)
```
...
// Per-module: hexa-lang/modules/attr_format/attr_<v>.hexa exports
...
Caller-visible aggregator: `hexa-lang/core/attr_format/attr_format_main.hexa` runs interface contract checks + v1 catalog detection round-trip (6 categories, byte-identical 2-run).
...
```hexa
use "hexa-lang/modules/attr_format/attr_v1"
...
1. Create `hexa-lang/modules/attr_format/attr_v6.hexa` with the 5 exported fns (mirror `attr_v5.hexa` STUB shape).
...
4. Register in `hexa-lang/core/attr_format/registry.hexa` (add dispatch case + add to `attr_format_registry_names()`).
5. Add config block to `hexa-lang/config/attr_format_sources.json` with full meta.
6. Add module selftest (`_selftest_v6()`) and aggregator test in `hexa-lang/core/attr_format/attr_format_main.hexa`.
...
- core/attr_format_main.hexa aggregator: PASS (6 categories — interface 5/5, default chain, v1 catalog detection 24/24, composition support 1/5, status sentinel, phase coverage 4/4).
...
| Path | sha256 | LOC |
|------|--------|-----|
| `hexa-lang/core/attr_format/source.hexa` | `dafabd6e798a07cd5cef69f8848fe191c27d7a7614b0c217c43a1be3cbe151ac` | 266 |
| `hexa-lang/core/attr_format/registry.hexa` | `39d6072382b9f58e772119e60dfbb5354428486c851ec8ae71aa9c0e520ec802` | 341 |
| `hexa-lang/core/attr_format/router.hexa` | `6d852ace2052a830ef847c12971a777d38190f72b4796383c499a030338fe2e2` | 291 |
| `hexa-lang/core/attr_format/attr_format_main.hexa` | `947f81959ad67d95960dcfd4e63cfc9e44ff4fc50243390e1d63cfe2a5b033aa` | 272 |
| `hexa-lang/modules/attr_format/attr_v1.hexa` | `57a3fef32570c68823cf4462c6c7de6908ca79bd05096d65bbae46718f351d8a` | 348 |
| `hexa-lang/modules/attr_format/attr_v2.hexa` | `d2f995ff454489ad27ec447b5d235a4cdfbf662702af40f67138b95a8f1b4f10` | 207 |
| `hexa-lang/modules/attr_format/attr_v3.hexa` | `83691fe4860518e5a461eba993b0c38e2e4ca4fe8665ce56eba4d52e4b74b9ba` | 227 |
| `hexa-lang/modules/attr_format/attr_v4.hexa` | `ea2744974ca02e592113df495002f9f0ad560f0f24ee7a878619837336cc8110` | 243 |
| `hexa-lang/modules/attr_format/attr_v5.hexa` | `9bdf82a2b7ef31dd938d6d42c3260d856c4ce0ea4f3e74eec553adde87e57111` | 175 |
