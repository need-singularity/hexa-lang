...
1. `tool/flatten_imports.hexa` — invoked by `hexa build` to concat the `use`
...
* `/home/aiden/Dev/hexa-lang/tool/flatten_imports.hexa` — added
...
Per HX8 we did not run `tool/rebuild_stage0.hexa`. The fix targets the
